...
NotebookDataLength[     88581,       1749]
NotebookOptionsPosition[     60654,       1167]
NotebookOutlinePosition[     87059,       1726]
CellTagsIndexPosition[     86948,       1720]
...
Cell["Pressure Profile for Column of Multiple Fluids", "DemoTitle",
 CellChangeTimes->{
  3.7446508010241675`*^9, {3.7446508805616255`*^9, 3.74465088103907*^9}, 
   3.7470679091489806`*^9},ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-\
2c07ad00f1a9"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`h1$$ = 
    2.9000000000000004`, $CellContext`h2$$ = 4, $CellContext`h3$$ = 
    3.1, $CellContext`\[Rho]1$$ = 2.7, $CellContext`\[Rho]2$$ = 
    1.7000000000000002`, $CellContext`\[Rho]3$$ = 1., Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`h3$$], 4, 
       Style["top", 
        RGBColor[0, 0.6, 0]]}, 0.1, 5, 0.1}, {{
       Hold[$CellContext`h2$$], 4, 
       Style["middle", 
        RGBColor[1, 0.5, 0]]}, 0.1, 5, 0.1}, {{
       Hold[$CellContext`h1$$], 4, 
       Style["bottom", 
        RGBColor[0, 0, 1]]}, 0.1, 5, 0.1}, {{
       Hold[$CellContext`\[Rho]3$$], 0.7, 
       Style["top", 
        RGBColor[0, 0.6, 0]]}, 0.1, 1.1, 0.1}, {{
       Hold[$CellContext`\[Rho]2$$], 1.5, 
       Style["middle", 
        RGBColor[1, 0.5, 0]]}, 1.1, 2., 0.1}, {{
       Hold[$CellContext`\[Rho]1$$], 2.3, 
       Style["bottom", 
        RGBColor[0, 0, 1]]}, 2., 3, 0.1}, {
      Hold[
       Grid[{{"fluid height (m)", 
          Manipulate`Place[1], 
          Manipulate`Place[2], 
    ...
    Typeset`skipInitDone$$ = True, $CellContext`h3$2784$$ = 
    0, $CellContext`h2$2785$$ = 0, $CellContext`h1$2786$$ = 
    0, $CellContext`\[Rho]3$2787$$ = 0, $CellContext`\[Rho]2$2788$$ = 
    0, $CellContext`\[Rho]1$2789$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`h1$$ = 4, $CellContext`h2$$ = 
        4, $CellContext`h3$$ = 4, $CellContext`\[Rho]1$$ = 
        2.3, $CellContext`\[Rho]2$$ = 1.5, $CellContext`\[Rho]3$$ = 0.7}, 
      "ControllerVariables" :> {
        Hold[$CellContext`h3$$, $CellContext`h3$2784$$, 0], 
        Hold[$CellContext`h2$$, $CellContext`h2$2785$$, 0], 
        Hold[$CellContext`h1$$, $CellContext`h1$2786$$, 0], 
        Hold[$CellContext`\[Rho]3$$, $CellContext`\[Rho]3$2787$$, 0], 
        Hold[$CellContext`\[Rho]2$$, $CellContext`\[Rho]2$2788$$, 0], 
        Hold[$CellContext`\[Rho]1$$, $CellContext`\[Rho]1$2789$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`x2$, $CellContext`x3$}, PlotStyle -> {Thick, 
              ...
              Graphics[{{Blue, 
                ...
                If[$CellContext`h1$$ >= 0.6, {
                  Line[{{11, $CellContext`x1$}, {13, $CellContext`x1$}}], 
                  Text[
                   Style[
                    Row[{
                ...
                If[$CellContext`h2$$ >= 0.6, {
                  Line[{{11, $CellContext`x2$}, {13, $CellContext`x2$}}], 
                  Text[
                   Style[
                    Row[{
                ...
                If[$CellContext`h3$$ >= 0.6, {
                  Line[{{11, $CellContext`x3$}, {13, $CellContext`x3$}}], 
                  Text[
                   Style[
                    Row[{
                ...
                Line[{{12, 0}, {12, 15}}], 
                Line[{{11, 0}, {13, 0}}]}, 
               PlotRange -> {{-0.5, 18}, {-0.5, 16}}], {11.8, 230}]], 
           Plot[
...
$CellContext`x1$, $CellContext`x2$}, PlotStyle -> {Thick, Orange}], 
           ...
           PlotRange -> {{0, 15}, {0, 320}}, PlotRangePadding -> -0.5, Axes -> 
           False, Frame -> True, FrameTicks -> True, 
           FrameLabel -> {"fluid height (m)", "gage pressure (kPa)"}, 
           LabelStyle -> {17, Black}, 
           ImagePadding -> {{60, 10}, {55, 5}}]; $CellContext`p2$ = 
         Graphics[{{Blue, 
             Rectangle[{0, 0}, {10, $CellContext`x1$}]}, {Orange, 
             Rectangle[{0, $CellContext`x1$}, {10, $CellContext`x2$}]}, {
             RGBColor[0, 0.6, 0], 
      ...
      "Specifications" :> {{{$CellContext`h3$$, 4, 
          Style["top", 
           RGBColor[0, 0.6, 0]]}, 0.1, 5, 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 1}, {{$CellContext`h2$$, 4, 
          Style["middle", 
           RGBColor[1, 0.5, 0]]}, 0.1, 5, 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 2}, {{$CellContext`h1$$, 4, 
          Style["bottom", 
           RGBColor[0, 0, 1]]}, 0.1, 5, 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 
         3}, {{$CellContext`\[Rho]3$$, 0.7, 
          Style["top", 
           RGBColor[0, 0.6, 0]]}, 0.1, 1.1, 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 
         4}, {{$CellContext`\[Rho]2$$, 1.5, 
          Style["middle", 
           RGBColor[1, 0.5, 0]]}, 1.1, 2., 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 
         5}, {{$CellContext`\[Rho]1$$, 2.3, 
          Style["bottom", 
           RGBColor[0, 0, 1]]}, 2., 3, 0.1, Appearance -> "Labeled", 
         ImageSize -> Tiny, ControlPlacement -> 6}, 
        Grid[{{"fluid height (m)", 
           Manipulate`Place[1], 
           Manipulate`Place[2], 
           Manipulate`Place[3]}, {
           ...
           PaneSelector[{1 -> Manipulate`Place[5]}, 
            Dynamic[$CellContext`cs]], 
           PaneSelector[{1 -> Manipulate`Place[6]}, 
            Dynamic[$CellContext`cs]]}}, Alignment -> Left]}, "Options" :> {},
 ...
 CellChangeTimes->{{3.7468841225618477`*^9, 3.746884134022208*^9}, 
   3.7468842778932095`*^9, {3.746884312597191*^9, 3.7468843589913607`*^9}, {
   3.7468844263147607`*^9, 3.746884633398837*^9}, 3.7468847170555096`*^9, 
   3.7468847562940817`*^9, {3.7468848142275887`*^9, 3.7468848210928097`*^9}, {
   3.7468848740598264`*^9, 3.746884883552433*^9}, 3.74688493167504*^9, 
   3.747067924413797*^9},
 CellLabel->"Out[1]=",
 CellID->386520185,ExpressionUUID->"3796c33b-9e0f-4462-aeda-b5325efdf0df"],
...
Cell["Hydrostatic pressure is calculated by:", "DetailNotes",
 CellChangeTimes->{{3.593113582552314*^9, 3.593113582553001*^9}, 
   3.6071067979339333`*^9, {3.609785707970625*^9, 3.6097857154123697`*^9}, {
   3.609870818652978*^9, 3.6098709030875273`*^9}, {3.610215959206881*^9, 
   3.6102159689576263`*^9}, {3.6368125171710887`*^9, 
   3.6368125186931753`*^9}, {3.6828782096464496`*^9, 
   3.6828782162376785`*^9}, {3.6846915508330584`*^9, 
   3.6846915508330584`*^9}, {3.685289241182199*^9, 3.685289241967412*^9}},
 FontSize->14,
 CellID->2028144868,ExpressionUUID->"7f1d2a1e-62f9-4ccc-a3eb-669bfda0d127"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"22867e8b-af2d-4de2-b4a9-2d3bfe03eefe"],
 ","
}], "DetailNotes",
 CellChangeTimes->{{3.593113582552314*^9, 3.593113582553001*^9}, 
   3.6071067979339333`*^9, {3.609785707970625*^9, 3.6097857227341013`*^9}, {
   3.609870920728387*^9, 3.609870929870865*^9}, {3.6828782229946938`*^9, 
   3.682878223371094*^9}, {3.6846915597360744`*^9, 3.6846915601104755`*^9}},
 FontSize->14,
 CellID->136840064,ExpressionUUID->"0b5541e9-8e07-42a2-9411-223b55425a2b"],

Cell[TextData[{
 "where ",
 Cell[BoxData[
  FormBox["P", TraditionalForm]], "InlineMath",ExpressionUUID->
  "bf711559-04de-4854-bad1-e1100d8190c6"],
 " is hydrostatic gage pressure (kPa), ",
 Cell[BoxData[
  FormBox["\[Rho]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "f0ec9f64-6cbc-4db4-a4c4-4d0df0cef97b"],
 " is fluid density (",
 Cell[BoxData[
  FormBox[
   RowBox[{"kg", "/", 
  ...
  ExpressionUUID->"0aefeac7-5558-4375-a504-37ccb9af375a"],
 "), ",
 Cell[BoxData[
  FormBox["g", TraditionalForm]], "InlineMath",ExpressionUUID->
  "54447e8e-722d-4793-94a6-412a2667806b"],
 " is the gravitational constant and ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath",ExpressionUUID->
  "1258c2d8-e1ce-4bcc-bd2e-3ddc76632dc5"],
 " is fluid height (m). "
}], "DetailNotes",
 CellChangeTimes->{{3.593113589529297*^9, 3.593113589530096*^9}, {
   3.5933612172740183`*^9, 3.593361283162017*^9}, {3.6072594834141383`*^9, 
   3.6072594966064577`*^9}, {3.6072595314399405`*^9, 3.60725953233603*^9}, {
   3.6097857477065983`*^9, 3.6097857620460324`*^9}, 3.6097860168985147`*^9, {
   3.609870938219445*^9, 3.609870974308428*^9}, 3.6102159897054377`*^9, 
   3.610216038317165*^9, {3.6846915763079205`*^9, 3.684691604530573*^9}, 
   3.685289257111115*^9},
 FontSize->14,
 CellID->575668727,ExpressionUUID->"d3407ea4-505a-4da7-a867-48a7134f066f"],
...
\>", "DetailNotes",
 CellChangeTimes->{{3.59311387627711*^9, 3.5931138762784433`*^9}, 
   3.6072595528500814`*^9, {3.609785774181246*^9, 3.609785774184246*^9}, {
   3.68528926568265*^9, 3.685289267505082*^9}},
 FontSize->14,
 CellID->1018567915,ExpressionUUID->"bf8df1dc-6f74-48a2-9f4c-7206ce8c0a7b"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"6c68f746-c262-4cfd-82af-8ced4421058a"],
 ","
}], "DetailNotes",
 CellChangeTimes->{{3.59311387627711*^9, 3.5931138762784433`*^9}, 
   3.6072595528500814`*^9, {3.609785774181246*^9, 3.6097857849673243`*^9}, {
   3.609870985350821*^9, 3.6098709935963097`*^9}},
 FontSize->14,
 CellID->62746299,ExpressionUUID->"f3e6e84e-dddb-4bba-9ddb-1d79ce3e9bd9"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"f994c841-31b9-4420-b2e1-a6da3f57ce82"],
 ","
}], "DetailNotes",
 CellChangeTimes->{{3.59311387627711*^9, 3.5931138762784433`*^9}, 
   3.6072595528500814`*^9, {3.609785774181246*^9, 3.609785795388366*^9}, {
   3.609870996823243*^9, 3.609871004084482*^9}},
 FontSize->14,
 CellID->24518060,ExpressionUUID->"96a95487-6420-4aff-8a8c-b1a15796ceb0"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"b2c0bbdc-046b-4a81-b8d3-4fda0267b8c4"],
 ","
}], "DetailNotes",
 CellChangeTimes->{{3.59311387627711*^9, 3.5931138762784433`*^9}, 
   3.6072595528500814`*^9, {3.609785774181246*^9, 3.6097858056243896`*^9}, {
   3.609871007647251*^9, 3.609871013683536*^9}},
 FontSize->14,
 CellID->58246399,ExpressionUUID->"c8a21959-5240-4bcd-b9f4-2b7fa33202e7"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"72aa8d73-a740-4884-afe4-c4d8f64eaaba"],
 "."
}], "DetailNotes",
 CellChangeTimes->{{3.59311387627711*^9, 3.5931138762784433`*^9}, 
   3.6072595528500814`*^9, {3.609785774181246*^9, 3.6097858090927362`*^9}, 
   3.6098710185721073`*^9},
 FontSize->14,
 CellID->390787972,ExpressionUUID->"050131c6-f906-4dae-a7a3-fc19cc5403c1"],
...
Cell[TextData[{
 ...
 CellChangeTimes->{{3.593112471184245*^9, 3.593112473215433*^9}, {
  3.593201186789324*^9, 3.593201188813442*^9}, {3.6097858931301394`*^9, 
  3.609785914697296*^9}},
 CellID->355096894,ExpressionUUID->"3ce56463-f043-4b79-8b44-a2f8b9b42e9f"],
...
Baumann"], None},
 ...
 CellChangeTimes->{{3.5932011718926353`*^9, 3.593201184797143*^9}, {
   3.5933613701621237`*^9, 3.5933613704573193`*^9}, {3.6071069904131794`*^9, 
   3.6071069969728355`*^9}, {3.607259581705967*^9, 3.607259581708967*^9}, {
   3.6097859602188473`*^9, 3.6097859602318487`*^9}, {3.6097859919400196`*^9, 
   3.60978599194602*^9}, 3.610216025656198*^9, {3.74706814002072*^9, 
   3.747068150578266*^9}},
 CellID->606183324,ExpressionUUID->"dc182c62-1d21-452d-a3c4-f21f093ad763"],
...
\>", "Author",
 CellChangeTimes->{{3.5932011718926353`*^9, 3.593201184797143*^9}, {
  3.5933613701621237`*^9, 3.5933613704573193`*^9}, {3.6071069904131794`*^9, 
  3.6071069969728355`*^9}, {3.607259581705967*^9, 3.6072596096187572`*^9}},
 CellID->786091941,ExpressionUUID->"36764b83-0cd0-473e-a613-f0812b0d9029"],
...
CellGrouping->Manual,
WindowSize->{1210, 980},
WindowMargins->{{21, Automatic}, {Automatic, 132}},
WindowElements->{
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[47513, 843, 316, 8, 50, "ManipulateCaption",ExpressionUUID->"fb861cbd-50b7-4934-bbdd-a2ad4db0004d",
   CellTags->"ControlSuggestions"],
  Cell[47832, 853, 3829, 81, 16, "ManipulateCaption",ExpressionUUID->"57e8a647-4da0-4a88-b282-15d85093aa4c",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[59593, 1137, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 86496, 1709},
 {"Copyright", 86801, 1714}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[36185, 610, 10752, 220, 508, "Output",ExpressionUUID->"3796c33b-9e0f-4462-aeda-b5325efdf0df",
 CellID->386520185],
Cell[46940, 832, 570, 9, 55, "ManipulateCaption",ExpressionUUID->"abd28a3c-1615-46f9-88d1-0712bde5d8d9",
 CellID->957328473],
Cell[47513, 843, 316, 8, 50, "ManipulateCaption",ExpressionUUID->"fb861cbd-50b7-4934-bbdd-a2ad4db0004d",
 CellTags->"ControlSuggestions"],
Cell[47832, 853, 3829, 81, 16, "ManipulateCaption",ExpressionUUID->"57e8a647-4da0-4a88-b282-15d85093aa4c",
 CellTags->"ControlSuggestions"],
Cell[51664, 936, 88, 0, 58, "DetailsSection",ExpressionUUID->"cd92d376-b5a9-4e2f-afa7-e392be73c809"],
Cell[51755, 938, 606, 9, 27, "DetailNotes",ExpressionUUID->"7f1d2a1e-62f9-4ccc-a3eb-669bfda0d127",
 CellID->2028144868],
Cell[52364, 949, 609, 13, 28, "DetailNotes",ExpressionUUID->"0b5541e9-8e07-42a2-9411-223b55425a2b",
 CellID->136840064],
Cell[52976, 964, 1454, 35, 31, "DetailNotes",ExpressionUUID->"d3407ea4-505a-4da7-a867-48a7134f066f",
 CellID->575668727],
Cell[54433, 1001, 463, 8, 27, "DetailNotes",ExpressionUUID->"bf8df1dc-6f74-48a2-9f4c-7206ce8c0a7b",
 CellID->1018567915],
Cell[54899, 1011, 583, 15, 28, "DetailNotes",ExpressionUUID->"f3e6e84e-dddb-4bba-9ddb-1d79ce3e9bd9",
 CellID->62746299],
Cell[55485, 1028, 579, 15, 28, "DetailNotes",ExpressionUUID->"96a95487-6420-4aff-8a8c-b1a15796ceb0",
 CellID->24518060],
Cell[56067, 1045, 581, 15, 28, "DetailNotes",ExpressionUUID->"c8a21959-5240-4bcd-b9f4-2b7fa33202e7",
 CellID->58246399],
Cell[56651, 1062, 585, 16, 28, "DetailNotes",ExpressionUUID->"050131c6-f906-4dae-a7a3-fc19cc5403c1",
 CellID->390787972],
Cell[57239, 1080, 100, 0, 44, "CitationSection",ExpressionUUID->"6c8e8459-14f4-47ec-a506-661e64c7e8eb"],
Cell[57342, 1082, 205, 3, 22, "Author",ExpressionUUID->"e78c80fa-d5ee-4c48-8664-76092c8a4d22",
 CellID->872162387],
Cell[57550, 1087, 537, 13, 22, "Author",ExpressionUUID->"3ce56463-f043-4b79-8b44-a2f8b9b42e9f",
 CellID->355096894],
Cell[58090, 1102, 1089, 24, 22, "Author",ExpressionUUID->"dc182c62-1d21-452d-a3c4-f21f093ad763",
 CellID->606183324],
Cell[59182, 1128, 408, 7, 22, "Author",ExpressionUUID->"36764b83-0cd0-473e-a613-f0812b0d9029",
 CellID->786091941],
Cell[59593, 1137, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
 CellTags->"Copyright"],
Cell[60469, 1162, 181, 3, 25, "Input",ExpressionUUID->"9fa92ac2-225b-4c13-b460-8e5bbed2aedc"]
}
]
*)
...
(* NotebookSignature dvDuBKkhGyfD7DwVOb6@ce9Y *)
