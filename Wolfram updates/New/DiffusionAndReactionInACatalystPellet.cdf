...
NotebookDataLength[     94750,       2066]
NotebookOptionsPosition[     68418,       1510]
NotebookOutlinePosition[     94468,       2063]
CellTagsIndexPosition[     94395,       2058]
...
Cell["Diffusion and Reaction in a Catalyst Pellet", "DemoTitle",
 CellChangeTimes->{
  3.7446508010241675`*^9, {3.7446508805616255`*^9, 3.74465088103907*^9}, 
   3.8242286367253203`*^9},ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-\
2c07ad00f1a9"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`D0$$ = 10, $CellContext`k$$ = 
    ...
    Typeset`skipInitDone$$ = False, $CellContext`R$17567$$ = 
    0, $CellContext`D0$17568$$ = 0, $CellContext`k$17569$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`D0$$ = 10, $CellContext`k$$ = 
        15, $CellContext`R$$ = 1}, "ControllerVariables" :> {
        Hold[$CellContext`R$$, $CellContext`R$17567$$, 0], 
        Hold[$CellContext`D0$$, $CellContext`D0$17568$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$17569$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`particle$}, $CellContext`particle$ = Graphics[{Thick, {
             EdgeForm[Thick], 
             FaceForm[
              GrayLevel[0.9]], 
             Disk[{0, 0}, 0.1]}, 
           ...
           White]; $CellContext`\[Phi]$ = 0.4; $CellContext`\[Sigma]$ = 
         0.8; $CellContext`\[Tau]$ = 
         ...
         0.04; $CellContext`\[CapitalPhi]$ = $CellContext`R$$ 
          Sqrt[$CellContext`k$$/$CellContext`De$]; $CellContext`CA$[
           Pattern[$CellContext`r$, 
            ...
            Blank[]]] := $CellContext`CAs$ ($CellContext`R$$/$CellContext`r$) \
(Sinh[$CellContext`\[CapitalPhi]$ ($CellContext`r$/$CellContext`R$$)]/
           Sinh[$CellContext`\[CapitalPhi]$]); $CellContext`M$ = 
         4 Pi $CellContext`R$$ $CellContext`De$ $CellContext`CAs$ \
($CellContext`\[CapitalPhi]$ Coth[$CellContext`\[CapitalPhi]$] - 
          ...
          ImagePadding -> {{70, 25}, {60, 5}}, Epilog -> {{Thick, Dashed, 
...
$CellContext`CAs$}}]}, 
            ...
            Text[
             Style[
              Column[{
               ...
               "="], 17], {0.27 $CellContext`R$$, $CellContext`CAs$ + 0.006}], 
     ...
     ImageSizeCache->{651., {255., 261.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({$CellContext`particle = Graphics[{
          Thickness[Large], {
           EdgeForm[
            Thickness[Large]], 
           FaceForm[
         ...
         GrayLevel[1]], Attributes[Subscript] = {NHoldRest}, 
 ...
 CellChangeTimes->{
  3.713891803087978*^9, 3.8242281236196814`*^9, {3.824228315832446*^9, 
   3.8242283197107215`*^9}, 3.8242284119983115`*^9, 3.824228563444996*^9, 
   3.82422864157668*^9, {3.8242287378904877`*^9, 3.8242287595848107`*^9}, 
   3.824228833831029*^9},
 CellLabel->"Out[12]=",
 CellID->257355001,ExpressionUUID->"e0502c8b-be0a-418f-9647-09bb4daa054d"],
...
of reaction divided by the rate of reaction if the entire catalyst were at ",
 Cell[BoxData[
  ...
  ExpressionUUID->"ee87f963-00bf-455c-8602-d1504885cc11"],
 " (the external surface concentration). The diffusivity slider represents \
diffusivity ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["D", "AB"], TraditionalForm]], "InlineMath",
  FormatType->"TraditionalForm",ExpressionUUID->
  "f854a964-cd9f-4c65-aaa4-02bfa26b3f09"],
 ", not effective diffusivity ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["D", "e"], TraditionalForm]], "InlineMath",
  FormatType->"TraditionalForm",ExpressionUUID->
  "06c5048a-da0b-4266-a5de-f4caeaac1279"],
 ". The value used for pellet porosity (\[Phi]) is 0.4, constriction factor (\
\[Sigma]) is 0.8, and tortuosity (\[Tau]) is 3. "
}], "ManipulateCaption",
 CellChangeTimes->{{3.7439644645171447`*^9, 3.7439644936678715`*^9}, 
   3.744650805398138*^9, {3.744650938736251*^9, 3.7446509416639132`*^9}, 
   3.8242289486625414`*^9},
...
Cell[TextData[{
 StyleBox["For the first-order reaction ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
  ...
  "636e0859-0f81-4bd0-b401-9dfe4521902c"],
 StyleBox[" with rate law ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
  ...
  ExpressionUUID->"261e1e1f-25b0-4d40-b026-7b294fa40ab9"],
 StyleBox[", the differential equation that describes diffusion and reaction \
in the catalyst pellet is:\n\n",
 ...
 Cell[BoxData[
  ...
  ExpressionUUID->"d4b3fe6d-2b3c-4c67-aeb6-b18c82e9eea0"],
 StyleBox[",\n\nwhere ",
  FontSize->12],
 Cell[BoxData[
  FormBox["r", TraditionalForm]], "InlineMath",ExpressionUUID->
  "1a53f8d0-3316-463f-95fd-3ce93809842c"],
 StyleBox[" is the radius of the catalyst pellet (",
  FontSize->12],
 Cell[BoxData[
  FormBox["cm", TraditionalForm]], "InlineMath",ExpressionUUID->
  "424cc2da-f439-4c42-8dd8-c783773acc47"],
 StyleBox["); ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["C", 
    StyleBox["A",
     FontSlant->"Plain"]], TraditionalForm]], "InlineMath",ExpressionUUID->
  "b2a62832-68c9-4fda-9f54-6b9e15b77f0a"],
 StyleBox[" is the concentration in the catalyst (",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"mmol", "/", 
    SuperscriptBox["cm", "3"]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"b45f30ad-085a-401c-9f76-e23009d64c74"],
 StyleBox["); ",
  FontSize->12],
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath",ExpressionUUID->
  "246b0a1d-c028-4768-af7a-1da4b59dac38"],
 StyleBox[" is the first-order rate constant (",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"1", "/", 
    StyleBox["s",
     FontSlant->"Plain"]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "5b64fe69-0409-4cd2-8f0f-8dafd16aaa73"],
 StyleBox["); ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  "08b63271-d2b4-4857-a1ba-6869134c901f"],
 StyleBox[" is the effective diffusivity \n(",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    StyleBox["s",
     FontSlant->"Plain"]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "4040db74-68b6-4c71-a897-692c19fbeb87"],
 StyleBox["); ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Phi]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "2719e65d-b9cc-4997-9646-aaada34a2111"],
 StyleBox[" is the pellet porosity; ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Sigma]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "1b6c977c-37f3-4592-a259-328feed5d5d2"],
 StyleBox[" is the constriction factor; ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Tau]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "53059078-d6a7-466e-abe2-131078423a4b"],
 StyleBox[" is tortuosity; and ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Phi]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "b976da11-d4ae-4f24-8b5e-663abbbe5a42"],
 StyleBox[", ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Sigma]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "2517ada2-0f8b-4e77-badd-788dfe2cb8c1"],
 StyleBox[" and ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Tau]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "8dfeeb95-46ee-4237-bf2b-24e06ead9902"],
 StyleBox[" are set based on typical values for these variables and are \
unitless.\n\nThe boundary conditions for the differential equation in \
spherical coordinates are:\n\n",
 ...
 Cell[BoxData[
  ...
  ExpressionUUID->"821c5e5f-ff41-413f-a821-85e4732f8413"],
 StyleBox[" at ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"r", "=", "0"}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "d355e649-80c1-4832-ab2a-68ac0e24c571"],
 StyleBox[",\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    SubscriptBox["C", 
     RowBox[{
      ...
      StyleBox["s",
       FontSlant->"Plain"]}]]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"b3544d0c-70f7-4c85-8310-f523c93dea45"],
 StyleBox[" at ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"r", "=", "R"}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "17414def-d8a1-499b-b06a-dbfe72fc5fff"],
 StyleBox[",\n\nwhere ",
  FontSize->12],
 Cell[BoxData[
  FormBox["R", TraditionalForm]], "InlineMath",ExpressionUUID->
  "e21eabb7-0bca-446a-9afb-f3f116726af4"],
 StyleBox[" is the pellet radius (",
  FontSize->12],
 Cell[BoxData[
  FormBox["cm", TraditionalForm]], "InlineMath",ExpressionUUID->
  "e7b4e48a-291d-4a65-a96b-5d859a68078f"],
 StyleBox[") and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["C", 
    RowBox[{
     ...
     StyleBox["s",
      FontSlant->"Plain"]}]], TraditionalForm]], "InlineMath",ExpressionUUID->
  "4175e1b9-8838-4e57-b212-d2ac9e5a4811"],
 StyleBox[" is the concentration (",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"mmol", "/", 
    SuperscriptBox["cm", "3"]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"f3f0df7a-c710-4459-8df1-64ede610fc59"],
 StyleBox[") at ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"r", "=", "R"}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "6ed88917-4b4e-4455-87b6-b2ce551fad75"],
 ...
 Cell[BoxData[
  ...
  "f4fab59b-e439-4578-b1ff-b272af24a875"],
 StyleBox[",\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
     ...
     SqrtBox[
      RowBox[{"k", "/", 
       SubscriptBox["D", 
        StyleBox["e",
         FontSlant->"Plain"]]}]]}]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"0b167a3a-c331-4ce3-8955-ed0e77a25f77"],
 StyleBox[",\n\nwhere ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
    ...
    RowBox[{
     ...
     SubscriptBox["C", 
      RowBox[{
       ...
       StyleBox["s",
        FontSlant->"Plain"]}]]}]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"ac49625e-676a-4ba2-bb5c-5fb4b946f679"],
 StyleBox[" and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Lambda]", "=", 
    RowBox[{"r", "/", "R"}]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "127b474f-a674-4b64-bfb4-949425a6a652"],
 StyleBox[". The Thiele modulus ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[CapitalPhi]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "f83b2d17-f615-425e-a812-f8f38ce6e66b"],
 StyleBox[" is the dimensionless ratio of the surface reaction rate to the \
diffusion rate.\n\nThe boundary conditions in dimensionless form are:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"\[CapitalPsi]", "=", "finite"}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"b779db9c-951f-4a57-986b-b8ebd1e75564"],
 StyleBox[" at ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Lambda]", "=", "0"}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"3c7b79b4-377d-49ef-bacd-a4184c5475d3"],
 StyleBox[",\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"\[CapitalPsi]", "=", "1"}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"8ebfc573-d57e-4cb7-8c80-5b0d54e64bf0"],
 StyleBox[" at ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Lambda]", "=", "1"}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"2fe86dec-0a00-49af-80c0-51b94472ab34"],
 StyleBox[".\n\nThe solution to the differential equation in dimensionless \
form is:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
    ...
    RowBox[{
     ...
     RowBox[{
      ...
      RowBox[{"(", 
       RowBox[{"\[CapitalPhi]", " ", "\[Lambda]"}], ")"}]}]}]}], 
   TraditionalForm]], "InlineMath",ExpressionUUID->
  "06d272d5-ebd7-4cf9-b16c-9f43c159cfaf"],
 StyleBox[",\n\nwhere ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["c", "1"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "7fbd2db3-e73d-48da-8293-b32263609cae"],
 StyleBox[" and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["c", "2"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "7b0361d1-6983-4747-9a54-feedc93d4f8d"],
 StyleBox[" are constants that are obtained using the boundary conditions. \
The solution becomes:\n\n",
 ...
 Cell[BoxData[
  ...
  "InlineMath",ExpressionUUID->"db360b2d-eb00-42bd-bdfd-7cb02ae8dd29"],
 StyleBox[",\n\nand substituting the dimensionless variables into the \
solution yields:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
      ...
      RowBox[{"sinh", " ", 
       RowBox[{"(", 
        RowBox[{"\[CapitalPhi]", " ", 
         RowBox[{"r", "/", "R"}]}], ")"}]}], 
      RowBox[{"sinh", " ", "\[CapitalPhi]"}]]}]}], TraditionalForm]], 
  "InlineMath",ExpressionUUID->"ff40bc30-40bb-49f1-bfc1-c2a61759563b"],
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["M", 
    StyleBox["A",
     FontSlant->"Plain"]], TraditionalForm]], "InlineMath",ExpressionUUID->
  "054c5976-76fa-42f2-8ac6-7aa5f2569432"],
 StyleBox[" is:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox[
    RowBox[{
     ...
     "\[RightBracketingBar]"}], 
    RowBox[{"\[Lambda]", "=", "1"}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"423587c6-79b2-487b-9fa5-bd07bb7e7889"],
 StyleBox[",\n\nwhere\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  "a386b6f0-c0e4-4e40-9e9b-bf47d8c353d3"],
    ...
    RowBox[{"4", " ", "\[Pi]", " ", "R", " ", 
     ...
     RowBox[{"(", 
      RowBox[{
       RowBox[{"\[CapitalPhi]", " ", "coth", " ", "\[CapitalPhi]"}], "-", 
       "1"}], ")"}]}]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "73ba9110-714e-4916-a376-33809088336e"],
 StyleBox[",\n\nwhere ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["M", 
    StyleBox["A",
     FontSlant->"Plain"]], TraditionalForm]], "InlineMath",ExpressionUUID->
  "9fa4f83a-8695-45e8-8034-ce133d963436"],
 StyleBox[" has units of ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   FractionBox["mmol", "s"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "dbb0b1ff-f1c6-4637-97ab-0fe68b4141f0"],
 StyleBox[". The effectiveness factor ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Eta]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "90fbb26a-dd82-4219-a474-e06c501b23f2"],
 StyleBox[" is the reaction rate in the pellet divided by the reaction rate \
at the surface:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
    ...
    FractionBox[
     ...
     SubscriptBox["M", 
      RowBox[{
       ...
       StyleBox["s",
        FontSlant->"Plain"]}]]]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"7cc80c5f-eea2-4090-97e4-41b54579ea12"],
 StyleBox[",\n\nwhere\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  ExpressionUUID->"9504e17c-763a-4664-805b-fb0d9e172acb"],
 StyleBox[".\n\nThus, ",
  FontSize->12],
 Cell[BoxData[
  FormBox["\[Eta]", TraditionalForm]], "InlineMath",ExpressionUUID->
  "20e1b527-6a85-4a86-9c01-8377af1977be"],
 StyleBox[" is:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
    ...
    RowBox[{
     ...
     RowBox[{"(", 
      RowBox[{
       RowBox[{"\[CapitalPhi]", " ", "coth", " ", "\[CapitalPhi]"}], "-", 
       "1"}], ")"}]}]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "5dc8d987-0d28-450b-842e-7b082f2ac3e3"],
 StyleBox[",\n\nwhich reduces to:\n\n",
  FontSize->12],
 Cell[BoxData[
  FormBox[
    ...
    RowBox[{
     ...
     RowBox[{"(", 
      RowBox[{
       RowBox[{"\[CapitalPhi]", " ", "coth", " ", "\[CapitalPhi]"}], "-", 
       "1"}], ")"}]}]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "f0e78811-7523-4f32-849c-9d14139bca97"],
 StyleBox[".\n\nReference\n[1] H. S. Fogler, ",
  FontSize->12],
 StyleBox["Elements of Chemical Reaction Engineering",
  FontSize->12,
  FontSlant->"Italic"],
 StyleBox[", 4th ed., Upper Saddle River, NJ: Prentice Hall, 2006 pp. 813\
\[Dash]852.",
  FontSize->12]
}], "DetailNotes",
 CellChangeTimes->{{3.743964535761527*^9, 3.743964553882964*^9}, {
  ...
  3.7446509560169086`*^9, 3.7446509574912276`*^9}, {3.8242289944850616`*^9, 
  3.82422905032129*^9}, {3.8242291076585393`*^9, 3.8242291156415405`*^9}, {
  3.824229156542183*^9, 3.824229181712566*^9}, {3.824229252788529*^9, 
  3.824229252988557*^9}},
 FontSize->14,
...
Baumann"], None},
 ...
 FontSize->12,
 CellID->52184429,ExpressionUUID->"c32c799e-105c-4929-bf79-d5f0e45f5d89"],
...
Falconer"], None},
 ...
 Cell[BoxData[
  FormBox[
   ButtonBox[
    RowBox[{" ", 
     RowBox[{"and", " ", "Neil", " ", "Hendren"}]}],
    BaseStyle->"Hyperlink",
    ButtonData->{
      URL[
      "https://demonstrations.wolfram.com/search.html?query=Neil%20Hendren"], 
      None},
    ButtonNote->
     "https://demonstrations.wolfram.com/search.html?query=Neil%20Hendren"], 
   TraditionalForm]], "InlineMath",
  FormatType->"TraditionalForm",
  FontFamily->"Titillium Web",ExpressionUUID->
  "1eea1dd0-d399-41db-90bf-2445f4384004"]
}], "Author",
 CellChangeTimes->{{3.699712700400914*^9, 3.699712728131461*^9}, {
  3.6997128004249277`*^9, 3.6997128004249277`*^9}, {3.8242291837848983`*^9, 
  3.8242292057525744`*^9}, {3.8242292793558636`*^9, 3.8242292793588643`*^9}},
 FontSize->12,
 CellID->373235529,ExpressionUUID->"ebf9409a-d9c2-4fb0-afee-e1093f2f90b4"],
...
\>", "Author",
 ...
 FontSize->12,
 CellID->77347031,ExpressionUUID->"acc53570-6a6b-43df-9e8d-8b7833f191f1"],
...
CellGrouping->Manual,
WindowSize->{1226, 980},
WindowMargins->{{Automatic, 100}, {Automatic, 49}},
WindowElements->{
...
CellTagsIndex->{
 "Copyright"->{
  Cell[67357, 1480, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 94248, 2052}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1545, 34, 34385, 568, 70, "DemonstrationHeader",ExpressionUUID->"0f6c982c-728a-4e7c-b5bb-e38debd5c80d"],
Cell[35933, 604, 243, 4, 51, "DemoTitle",ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-2c07ad00f1a9"],
Cell[36179, 610, 8524, 183, 528, "Output",ExpressionUUID->"e0502c8b-be0a-418f-9647-09bb4daa054d",
 CellID->257355001],
Cell[44706, 795, 1891, 41, 104, "ManipulateCaption",ExpressionUUID->"abd28a3c-1615-46f9-88d1-0712bde5d8d9",
 CellID->957328473],
Cell[46600, 838, 88, 0, 58, "DetailsSection",ExpressionUUID->"cd92d376-b5a9-4e2f-afa7-e392be73c809"],
Cell[46691, 840, 18601, 581, 1335, "DetailNotes",ExpressionUUID->"bd335143-b24f-497b-9c57-915908f76af2",
 CellID->1902107128],
Cell[65295, 1423, 100, 0, 44, "CitationSection",ExpressionUUID->"6c8e8459-14f4-47ec-a506-661e64c7e8eb"],
Cell[65398, 1425, 540, 13, 24, "Author",ExpressionUUID->"c32c799e-105c-4929-bf79-d5f0e45f5d89",
 CellID->52184429],
Cell[65941, 1440, 1144, 30, 30, "Author",ExpressionUUID->"ebf9409a-d9c2-4fb0-afee-e1093f2f90b4",
 CellID->373235529],
Cell[67088, 1472, 266, 6, 24, "Author",ExpressionUUID->"acc53570-6a6b-43df-9e8d-8b7833f191f1",
 CellID->77347031],
Cell[67357, 1480, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
 CellTags->"Copyright"],
Cell[68233, 1505, 181, 3, 25, "Input",ExpressionUUID->"9fa92ac2-225b-4c13-b460-8e5bbed2aedc"]
}
]
*)
...
(* NotebookSignature JvpBDcqIxoQbdBwq4uruikQm *)
