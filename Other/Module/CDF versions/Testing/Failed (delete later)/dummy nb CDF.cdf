...
NotebookDataLength[      8977,        238]
NotebookOptionsPosition[      8075,        193]
NotebookOutlinePosition[      9468,        234]
CellTagsIndexPosition[      9425,        231]
WindowFrame->Normal*)
...
StyleDefinitions->Notebook[{
   ...
   Cell[
    StyleData[All], GroupOpenerInsideFrame -> True, 
    CellMargins -> {{50, 400}, {Inherited, Inherited}}, FontFamily -> 
    "Arial"], 
   Cell[
    StyleData["Section"], FontColor -> GrayLevel[0]], 
   Cell[
    StyleData["Subsection"], CellFrame -> True, GroupOpenerColor -> 
    RGBColor[0.905882, 0.0196078, 0.0862745], FontWeight -> "Obese", 
   ...
   Cell[
    ...
    "Bold", FontSlant -> "Italic"]}, Visible -> False, FrontEndVersion -> 
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 106, 1, 63, "Section"],
Cell[1595, 38, 1129, 16, 179, "Text"],
Cell[CellGroupData[{
Cell[2749, 58, 105, 1, 52, "Subsection"],
Cell[2857, 61, 116, 1, 34, "Subsubsection"],
Cell[CellGroupData[{
Cell[2998, 66, 87, 1, 26, "Item"],
Cell[3088, 69, 91, 1, 25, "Subitem"]
}, Closed]],
Cell[CellGroupData[{
Cell[3216, 75, 125, 1, 26, "Item"],
Cell[3344, 78, 94, 1, 25, "Subitem"]
}, Closed]],
Cell[CellGroupData[{
Cell[3475, 84, 2120, 52, 192, "Input"],
Cell[5598, 138, 2440, 50, 344, "Output"]
}, {2}]]
}, Open  ]]
}, Open  ]]
}
...
(* NotebookSignature tvTU55hlHjlHgAwaWSaIPGAW *)
