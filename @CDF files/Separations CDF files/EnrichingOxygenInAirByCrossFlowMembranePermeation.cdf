...
NotebookDataLength[     87804,       1776]
NotebookOptionsPosition[     60781,       1197]
NotebookOutlinePosition[     87066,       1758]
CellTagsIndexPosition[     86955,       1752]
WindowTitle->Enriching Oxygen in Air by Cross-Flow Membrane Permeation
WindowFrame->Normal*)
...
Cell["Enriching Oxygen in Air by Cross-Flow Membrane Permeation", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Theta]$$ = 0.2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Theta]$$], 0.2, "stage cut"}, 0.14, 0.25, 0.01}}, 
    Typeset`size$$ = {500., {148., 152.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Theta]$998029$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`\[Theta]$$ = 0.2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Theta]$$, $CellContext`\[Theta]$998029$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`x0$, $CellContext`yp$, $CellContext`Asol$, \
$CellContext`\[Alpha]$, $CellContext`p$, $CellContext`x$, $CellContext`f$, \
$CellContext`h$, $CellContext`l$, $CellContext`q$, $CellContext`t$, \
$CellContext`P$, $CellContext`B$, $CellContext`A$, $CellContext`qend$, \
$CellContext`myODEsoln$, $CellContext`m$, $CellContext`y$, $CellContext`plt$, \
$CellContext`\[CapitalOmega]$}, SuperStar[$CellContext`\[Alpha]$] = 10; 
        Subscript[$CellContext`p$, $CellContext`h$] = 190; 
        Subscript[$CellContext`p$, $CellContext`l$] = 19; 
        Subscript[$CellContext`x$, $CellContext`f$] = 0.209; 
        Subscript[$CellContext`y$, Pi] = 0.654834; 
        Subscript[$CellContext`q$, $CellContext`f$] = 1 10^6; $CellContext`t$ = 
         2.54 10^(-3); Subscript[
           Derivative[1][$CellContext`P$], $CellContext`B$] = 50 10^(-10); 
        Subscript[
           Derivative[1][$CellContext`P$], $CellContext`A$] = 
         500 10^(-10); $CellContext`myODEsoln$[
           Pattern[$CellContext`\[CapitalOmega]$, 
            Blank[]]] := Quiet[
           NDSolve[{$CellContext`y$[
                Subscript[$CellContext`A$, $CellContext`m$]] D[
                $CellContext`q$[
                 Subscript[$CellContext`A$, $CellContext`m$]], {
                 Subscript[$CellContext`A$, $CellContext`m$], 1}] == 
             D[$CellContext`q$[
                 Subscript[$CellContext`A$, $CellContext`m$]] $CellContext`x$[
                 Subscript[$CellContext`A$, $CellContext`m$]], {
                Subscript[$CellContext`A$, $CellContext`m$], 
                1}], (-$CellContext`y$[
                 Subscript[$CellContext`A$, $CellContext`m$]]) D[
               ...
               Subscript[$CellContext`p$, $CellContext`h$] $CellContext`x$[
                  Subscript[$CellContext`A$, $CellContext`m$]] - 
               Subscript[$CellContext`p$, $CellContext`l$] $CellContext`y$[
                 Subscript[$CellContext`A$, $CellContext`m$]]), (-(
                1 - $CellContext`y$[
                 Subscript[$CellContext`A$, $CellContext`m$]])) D[
                $CellContext`q$[
               ...
               Subscript[
                 Derivative[
                 1][$CellContext`P$], $CellContext`B$]/$CellContext`t$) (
               Subscript[$CellContext`p$, $CellContext`h$] (
                 1 - $CellContext`x$[
                  Subscript[$CellContext`A$, $CellContext`m$]]) - 
               Subscript[$CellContext`p$, $CellContext`l$] (
                1 - $CellContext`y$[
                 ...
                 Subscript[$CellContext`A$, $CellContext`m$]])), \
$CellContext`x$[0] == 
             Subscript[$CellContext`x$, $CellContext`f$], $CellContext`y$[0] == 
             Subscript[$CellContext`y$, Pi], $CellContext`q$[0] == 
             ...
             $CellContext`q$[
              Subscript[$CellContext`A$, $CellContext`m$]]}, {
             Subscript[$CellContext`A$, $CellContext`m$], 
             0, $CellContext`\[CapitalOmega]$}]]; $CellContext`qend$[
           PatternTest[
            Pattern[$CellContext`\[CapitalOmega]$, 
             Blank[]], NumericQ]] := Flatten[
           ReplaceAll[
            ReplaceAll[
             $CellContext`q$[
              Subscript[$CellContext`A$, $CellContext`m$]], 
             $CellContext`myODEsoln$[$CellContext`\[CapitalOmega]$]], 
            Subscript[$CellContext`A$, $CellContext`m$] -> $CellContext`\
\[CapitalOmega]$]]; $CellContext`Asol$ = Quiet[
           
           FindRoot[(
              Subscript[$CellContext`q$, $CellContext`f$] - \
$CellContext`qend$[$CellContext`\[CapitalOmega]$])/
             Subscript[$CellContext`q$, $CellContext`f$] == $CellContext`\
\[Theta]$$, {$CellContext`\[CapitalOmega]$, 2 10^8, 3 10^8}, MaxIterations -> 
            1000]]; $CellContext`x0$ = First[
           ReplaceAll[
            ReplaceAll[
             ReplaceAll[
              $CellContext`x$[
               Subscript[$CellContext`A$, $CellContext`m$]], 
              $CellContext`myODEsoln$[
               
               ReplaceAll[$CellContext`\[CapitalOmega]$, \
$CellContext`Asol$]]], 
             Subscript[$CellContext`A$, $CellContext`m$] -> $CellContext`\
\[CapitalOmega]$], $CellContext`Asol$]]; $CellContext`yp$ = First[
           ReplaceAll[$CellContext`y$, 
            
            Solve[$CellContext`\[Theta]$$ $CellContext`y$ + (
                1 - $CellContext`\[Theta]$$) $CellContext`x0$ == 
             Subscript[$CellContext`x$, $CellContext`f$], $CellContext`y$]]]; \
$CellContext`plt$ = Graphics[{
            EdgeForm[Thick], LightBlue, 
            Rectangle[{0, 0}, {2, 1}], 
            RGBColor[0.48, 0, 0], 
            Rectangle[{0, 0.45}, {2, 0.55}], 
            RGBColor[0, 0, 0.48], 
            Arrow[{{-0.75, 0.25}, {0, 0.25}}], 
            Arrow[{{1, 1}, {1, 1.5}}], 
            Arrow[{{2, 0.25}, {2.75, 0.25}}], {
             RGBColor[0.48, 0, 0], 
             Arrowheads[0.025], 
             Arrow[{{0.1, 0.55}, {0.1, 0.75}}], 
             Arrow[{{1, 0.55}, {1, 0.75}}], 
             Arrow[{{1.9, 0.55}, {1.9, 0.75}}]}, 
            Style[
             Text["feed in", {-0.75, 0.4}, {-1, 0}], Bold, 
             RGBColor[0, 0, 0.48], 14], 
            Style[
             Text["permeate out", {1., 1.58}, {0, 0}], Bold, 
             RGBColor[0, 0, 0.48], 14], 
            Style[
             Text["reject out", {2.1, 0.4}, {-1, 0}], Bold, 
             RGBColor[0, 0, 0.48], 14]}]; Show[$CellContext`plt$, 
          Graphics[{
            Style[
             Text[
              StringJoin["\!\(\*SubscriptBox[\(y\), \(p, avg\)]\) = ", 
               ToString[
                NumberForm[$CellContext`yp$, {4, 3}]]], {1.1, 1.4}, {-1, 0}], 
             Bold, Red, 14], 
            Style[
             Text[
              StringJoin["\[Theta] = ", 
               ToString[
                NumberForm[$CellContext`\[Theta]$$, {4, 3}]]], {-0.75, 
              1.4}, {-1, 0}], Bold, Blue, 14], 
            Style[
             Text[
              Row[{"area", " = ", 
                ToString[
                 NumberForm[
                  ReplaceAll[
                  10^(-8) $CellContext`\[CapitalOmega]$, $CellContext`Asol$], \
{5, 4}]], " \[Times] \!\(\*SuperscriptBox[\(10\), \(8\)]\)"}], {-0.75, 
              1.2}, {-1, 0}], Bold, Red, 14], 
            Style[
             Text[
              StringJoin["\!\(\*SubscriptBox[\(x\), \(f\)]\) = ", 
               ToString[
                NumberForm[
                 Subscript[$CellContext`x$, $CellContext`f$], {4, 
                 3}]]], {-0.75, 0.1}, {-1, 0}], Bold, Blue, 14], 
            Style[
             Text[
              StringJoin["\!\(\*SubscriptBox[\(x\), \(0\)]\)= ", 
               ToString[
                NumberForm[
                 First[
                  ReplaceAll[
...
$CellContext`Asol$]]], 
                    Subscript[$CellContext`A$, $CellContext`m$] -> \
$CellContext`\[CapitalOmega]$], $CellContext`Asol$]], {4, 3}]]], {2.1, 
              0.1}, {-1, 0}], Bold, Red, 14], 
            Style[
             Text[
              StringJoin["\!\(\*SubscriptBox[\(y\), \(p, i\)]\) = ", 
               ToString[
                NumberForm[
                 First[
                  ReplaceAll[
                   ReplaceAll[
                    ...
                    ReplaceAll[$CellContext`\[CapitalOmega]$, \
$CellContext`Asol$]]], Subscript[$CellContext`A$, $CellContext`m$] -> 
                    0], $CellContext`Asol$]], {4, 3}]]], {0.1, 0.85}, {-1, 
              0}], Bold, Red, 10], 
            Style[
             Text[
              StringJoin["\!\(\*SubscriptBox[\(y\), \(p, f\)]\) = ", 
               ToString[
                NumberForm[
                 First[
                  ReplaceAll[
...
$CellContext`Asol$]]], 
                    Subscript[$CellContext`A$, $CellContext`m$] -> \
$CellContext`\[CapitalOmega]$], $CellContext`Asol$]], {4, 3}]]], {1.95, 
              0.85}, {1, 0}], Bold, Red, 10]}], ImageSize -> {500, 300}]], 
      "Specifications" :> {{{$CellContext`\[Theta]$$, 0.2, "stage cut"}, 0.14,
          0.25, 0.01, Appearance -> "Labeled"}}, 
      "Options" :> {TrackedSymbols :> {$CellContext`\[Theta]$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {192., 197.}},
...
Cell[TextData[{
 "This Demonstration studies enriching the oxygen content of air with a \
single-stage membrane module. This problem was first treated in [1] and later \
in [2]. The binary mixture, ",
 Cell[BoxData[
  FormBox["A", TraditionalForm]], "InlineMath"],
 " (oxygen) and ",
 Cell[BoxData[
  FormBox["B", TraditionalForm]], "InlineMath"],
 " (nitrogen), has an ideal separation factor, the ratio of the \
permeabilities of the two species, ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SuperscriptBox["\[Alpha]", "*"], "=", "10"}], TraditionalForm]], 
  "InlineMath"],
 ". The permeability of oxygen is ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"500", "\[Times]", 
     ...
     RowBox[{"cm", "/", 
      RowBox[{"(", 
       RowBox[{"s", "  ", 
        SuperscriptBox["cm", "2"], " ", "cmHg"}]}]}]}]}], TraditionalForm]], 
  "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"t", "=", 
    RowBox[{"2.54", " ", 
     SuperscriptBox["10", 
      RowBox[{"-", "3"}]], " ", "cm"}]}], TraditionalForm]], "InlineMath"],
 ". The stage cut, ",
 Cell[BoxData[
  FormBox["\[Theta]", TraditionalForm]], "InlineMath"],
 ", is set by the user. The values of the pressures in the feed and permeate \
sides are chosen equal to ",
 Cell[BoxData[
  FormBox[
   RowBox[{"Ph", "=", "190"}], TraditionalForm]], "InlineMath"],
 " cmHg and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"Pl", "=", "19"}], TraditionalForm]], "InlineMath"],
  ...
  FormBox[
   RowBox[{
    ...
    RowBox[{
     ...
     RowBox[{
      RowBox[{
       SuperscriptBox["cm", "3"], "(", "STP", ")"}], "/", "s"}]}]}], 
   TraditionalForm]], "InlineMath"],
 ", ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["x", "nitorgen"], "=", "0.791"}], TraditionalForm]], 
  "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["x", "oxygen"], "=", "0.209"}], TraditionalForm]], 
  "InlineMath"],
 ". This Demonstration computes the reject and permeate compositions as well \
as the membrane area. In addition, values of the local permeate compositions, \
both at the entrance and exit of the module, are given."
}], "ManipulateCaption"],
...
Cell[TextData[{
 "[1] W. P. Walawender and S. A. Stern, \"Analysis of Membrane Separation \
Parameters. II. Counter-Current and Cocurrent Flow in a Single Permeation \
Stage,\" ",
 StyleBox["Separation Science and Technology, ",
  FontSlant->"Italic"],
 StyleBox["7",
  FontWeight->"Bold"],
 "(5), 1972 pp. 553\[Dash]584."
}], "DetailNotes",
 CellID->352513445],

Cell[TextData[{
 "[2] C. J. Geankoplis, ",
 StyleBox["Transport Processes and Unit Operation",
  FontSlant->"Italic"],
 ", 3rd ed., Englewood Cliffs: Prentice\[Dash]Hall, 1993.  "
}], "DetailNotes",
 CellID->517691029],
...
EnrichingOxygenInAirByCrossFlowMembranePermeation&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EnrichingOxygenInAirByCrossFlowMembranePermeation/\
EnrichingOxygenInAirByCrossFlowMembranePermeation-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Enriching Oxygen in Air by Cross-Flow Membrane Permeation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
EnrichingOxygenInAirByCrossFlowMembranePermeation/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EnrichingOxygenInAirByCrossFlowMembranePermeation/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[48783, 913, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[49044, 922, 3774, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[59959, 1172, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 86668, 1741},
 {"Copyright", 86863, 1746}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[621, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34952, 590, 78, 0, 70, "DemoTitle"],
Cell[35033, 592, 11116, 238, 70, "Output",
 CellID->309493356],
Cell[46152, 832, 2628, 79, 70, "ManipulateCaption"],
Cell[48783, 913, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49044, 922, 3774, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[52821, 1006, 33, 0, 70, "DetailsSection"],
Cell[52857, 1008, 361, 10, 70, "DetailNotes",
 CellID->352513445],
Cell[53221, 1020, 218, 6, 70, "DetailNotes",
 CellID->517691029],
Cell[53442, 1028, 4890, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[58335, 1121, 45, 0, 70, "CitationSection"],
Cell[58383, 1123, 983, 27, 70, "Citations"],
Cell[59369, 1152, 587, 18, 70, "Author"],
Cell[59959, 1172, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature qQaGWAepVlfWBv7JsbDc9GfK *)
