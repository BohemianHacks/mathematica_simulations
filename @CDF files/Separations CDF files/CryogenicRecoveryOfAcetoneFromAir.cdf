...
NotebookDataLength[     82650,       1634]
NotebookOptionsPosition[     55721,       1057]
NotebookOutlinePosition[     81987,       1618]
CellTagsIndexPosition[     81876,       1612]
WindowTitle->Cryogenic Recovery of Acetone from Air
WindowFrame->Normal*)
...
Cell["Cryogenic Recovery of Acetone from Air", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Theta]$$ = -50, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Theta]$$], -50, 
       "coolant temperature in \[Degree]C"}, -100, -20, 2}}, 
    Typeset`size$$ = {450., {223., 227.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Theta]$11002$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`\[Theta]$$ = -50}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Theta]$$, $CellContext`\[Theta]$11002$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`sol$, $CellContext`Psat1$, $CellContext`Psat2$, \
$CellContext`Gam1$, $CellContext`Gam2$, $CellContext`x$, $CellContext`y$, \
$CellContext`L$, $CellContext`V$, $CellContext`T$}, $CellContext`P = 
         101.325; $CellContext`R = 1.987; $CellContext`T$ = 
         273.15 + $CellContext`\[Theta]$$ + 10; $CellContext`A2 = 
         21.662; $CellContext`B2 = -692.39; $CellContext`C2 = 
         0; $CellContext`D2 = -0.39208; $CellContext`E2 = 
         4.7574 10^(-3); $CellContext`F2 = 1.; $CellContext`A1 = 
         71.13031; $CellContext`B1 = -5952.; $CellContext`C1 = 
         0.; $CellContext`D1 = -8.53128; $CellContext`E1 = 
         7.82393 10^(-6); $CellContext`F1 = 
         2.; $CellContext`l21 = -1.805; $CellContext`l12 = 
         906.5; $CellContext`b12 = -0.002; $CellContext`b21 = 
         1.916; $CellContext`V2 = 3.29136; $CellContext`V1 = 
         7.44767; $CellContext`Psat1$ = 
         Exp[$CellContext`A1 + $CellContext`B1/($CellContext`C1 + \
$CellContext`T$) + $CellContext`D1 
            
            Log[$CellContext`T$] + $CellContext`E1 \
$CellContext`T$^$CellContext`F1]; $CellContext`Psat2$ = 
         Exp[$CellContext`A2 + $CellContext`B2/($CellContext`C2 + \
$CellContext`T$) + $CellContext`D2 
            Log[$CellContext`T$] + $CellContext`E2 \
$CellContext`T$^$CellContext`F2]; $CellContext`A12 = \
($CellContext`V2/$CellContext`V1) 
          Exp[(-($CellContext`l12 + $CellContext`b12 \
$CellContext`T$))/($CellContext`R $CellContext`T$)]; $CellContext`A21 = \
($CellContext`V1/$CellContext`V2) 
          Exp[(-($CellContext`l21 + $CellContext`b21 \
$CellContext`T$))/($CellContext`R $CellContext`T$)]; $CellContext`Gam1$ = 
         ReplaceAll[
           ReplaceAll[
            
            Exp[-Log[$CellContext`x1 + $CellContext`x2 $CellContext`A12] + 
             1 - ($CellContext`x1/($CellContext`x1 + $CellContext`x2 \
$CellContext`A12) + $CellContext`x2 ($CellContext`A21/($CellContext`x1 \
$CellContext`A21 + $CellContext`x2)))], $CellContext`x1 -> $CellContext`x$], \
$CellContext`x2 -> 1 - $CellContext`x$]; $CellContext`Gam2$ = ReplaceAll[
           ReplaceAll[
            
            Exp[-Log[$CellContext`x1 $CellContext`A21 + $CellContext`x2] + 
             1 - ($CellContext`x1 ($CellContext`A12/($CellContext`x1 + \
$CellContext`x2 $CellContext`A12)) + $CellContext`x2/($CellContext`x1 \
$CellContext`A21 + $CellContext`x2))], $CellContext`x1 -> $CellContext`x$], \
$CellContext`x2 -> 1 - $CellContext`x$]; $CellContext`F = 
         1000; $CellContext`sol$ = 
         FindRoot[{$CellContext`F == $CellContext`L$ + $CellContext`V$, \
$CellContext`F 
             0.05 == $CellContext`L$ $CellContext`x$ + $CellContext`V$ \
$CellContext`y$, $CellContext`y$ == ($CellContext`Psat1$ $CellContext`Gam1$) \
($CellContext`x$/$CellContext`P), 
            1 - $CellContext`y$ == ($CellContext`Psat2$ $CellContext`Gam2$) ((
               1 - $CellContext`x$)/$CellContext`P)}, {$CellContext`x$, 
            0.9999}, {$CellContext`y$, 0.04}, {$CellContext`L$, 
            5}, {$CellContext`V$, 990}]; Show[
          Graphics[{
            RGBColor[0.49, 0, 0], 
            Opacity[0.3], 
            EdgeForm[{Thick, 
            ...
            Arrow[{{-3, 1}, {0, 1}}], Green, 
            Arrow[{{0.5, 2}, {0.5, 3.5}}], 
            Arrow[{{1.5, 3.5}, {1.5, 2}}], Blue, 
            Arrow[{{2, 1}, {5, 1}}], 
            RGBColor[0.49, 0, 0.3], 
            Arrow[{{6, 2}, {6, 3}, {9, 3}}], Red, 
            Arrow[{{6, 0}, {6, -1}, {9, -1}}], 
            Style[
             Text["condenser", {1, 1}, {0, 0}], Black, 12, Bold], 
            Style[
             Text["flash", {6, 1}, {0, 0}], Black, 12, Bold], 
            Style[
             Text[ToString[
                NumberForm[$CellContext`\[Theta]$$ + 10, {3, 1}]] 
              "\[Degree]C", {3.5, 1.25}, {0, 0}], 
             RGBColor[0.25, 0.13, 0.82], 14, Bold], 
            Style[
             Text["coolant", {1, 4.}, {0, 0}], Green, 16, Bold], 
            Style[
             Text["feed", {-2, 0.5}, {0, 0}], Black, 16, Bold], 
            Style[
             Text["50 kmol/hr acetone", {-3.2, -0.1}, {-1, 0}], Black, 12, 
             Bold], 
            Style[
             Text["950 kmol/hr air", {-3.2, -0.7}, {-1, 0}], Black, 12, Bold], 
            Style[
             Text["vapor", {7, 5.5}, {0, 0}], 
             RGBColor[0.49, 0, 0.3], 16, Bold], 
            Style[
             Text[ToString[
                NumberForm[
                 ReplaceAll[$CellContext`V$, $CellContext`sol$], {6, 3}]] 
              " kmol/hr", {6, 4.8}, {-1, 0}], 
             RGBColor[0.49, 0, 0.3], 12, Bold], 
            Style[
             Text[ToString[
                NumberForm[
                 ReplaceAll[1 - $CellContext`y$, $CellContext`sol$], {6, 3}]] 
              " air", {6, 4.2}, {-1, 0}], 
             RGBColor[0.49, 0, 0.3], 12, Bold], 
            Style[
             Text[ToString[
                NumberForm[
                 ReplaceAll[$CellContext`y$, $CellContext`sol$], {6, 3}]] 
              " acetone", {6, 3.6}, {-1, 0}], 
             RGBColor[0.49, 0, 0.3], 12, Bold], 
            Style[
             Text[ToString[
                NumberForm[
                 ReplaceAll[$CellContext`L$, $CellContext`sol$], {6, 3}]] 
              " kmol/hr", {6, -2.2}, {-1, 0}], Red, 12, Bold], 
            Style[
             Text[ToString[
                NumberForm[
                 ReplaceAll[$CellContext`x$, $CellContext`sol$], {6, 3}]] 
              " acetone", {6, -2.8}, {-1, 0}], Red, 12, Bold], 
            Style[
             Text["liquid", {7, -1.5}, {0, 0}], Red, 16, Bold]}], ImageSize -> 
          450 {1, 1}]], 
      "Specifications" :> {{{$CellContext`\[Theta]$$, -50, 
          "coolant temperature in \[Degree]C"}, -100, -20, 2, Appearance -> 
         "Labeled"}}, 
      "Options" :> {TrackedSymbols -> {$CellContext`\[Theta]$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{495., {267., 272.}},
...
Cell[TextData[{
 "Consider a stream composed of a mixture of air and acetone with a molar \
flow rate of 1000 kmol/hr. The acetone content in this stream is only 5 \
mole%. It is still possible to recover the acetone from air using a cryogenic \
process, using very low temperatures ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"-", "20"}], "\[Degree]C"}], TraditionalForm]], "InlineMath"],
 ". This separation can also be called partial condensation since only \
acetone will condense in this temperature range. Thus, the liquid phase that \
exits the process will be almost pure acetone. A ",
 Cell[BoxData[
  FormBox[
   RowBox[{"10", "\[Degree]C"}], TraditionalForm]], "InlineMath"],
 " approach temperature is chosen, which allows the determination of the \
isothermal flash temperature from the user-set value of the coolant \
temperature. The Demonstration displays the flow rates of the liquid and \
vapor stream that exits the flash drum as well as their compositions. One can \
see from the snapshots that the percent recovery of acetone can reach almost \
100% (i.e., the liquid flow rate approaches 50 kmol/hr) when the coolant \
temperature is very low. This process is an alternative to countercurrent \
absorption of acetone in a column using water as a solvent."
}], "ManipulateCaption"],
...
Cell[TextData[{
 "J. M. Douglas, ",
 StyleBox["Conceptual Design of Chemical Processes",
  FontSlant->"Italic"],
 ", International ed., New York: McGraw\[Dash]Hill, 1988. "
}], "DetailNotes",
 CellID->248272464],
...
CryogenicRecoveryOfAcetoneFromAir&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CryogenicRecoveryOfAcetoneFromAir/\
CryogenicRecoveryOfAcetoneFromAir-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Cryogenic Recovery of Acetone from Air",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CryogenicRecoveryOfAcetoneFromAir/\
"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CryogenicRecoveryOfAcetoneFromAir/"],
 "\"",
...
CryogenicRecoveryOfAcetoneFromAir/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CryogenicRecoveryOfAcetoneFromAir/\
"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44249, 789, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44510, 798, 3774, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54899, 1032, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81589, 1601},
 {"Copyright", 81784, 1606}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[602, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34933, 590, 59, 0, 70, "DemoTitle"],
Cell[34995, 592, 7731, 162, 70, "Output",
 CellID->9434160],
Cell[42729, 756, 1517, 31, 70, "ManipulateCaption"],
Cell[44249, 789, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44510, 798, 3774, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48287, 882, 33, 0, 70, "DetailsSection"],
Cell[48323, 884, 211, 6, 70, "DetailNotes",
 CellID->248272464],
Cell[48537, 892, 4838, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53378, 983, 45, 0, 70, "CitationSection"],
Cell[53426, 985, 880, 25, 70, "Citations"],
Cell[54309, 1012, 587, 18, 70, "Author"],
Cell[54899, 1032, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature gTqJWuq6s1MwDwmSKrW9ifdM *)
