...
NotebookDataLength[     83549,       1762]
NotebookOptionsPosition[     55903,       1165]
NotebookOutlinePosition[     82165,       1726]
CellTagsIndexPosition[     82054,       1720]
WindowTitle->Unsteady-State Interphase Diffusion
WindowFrame->Normal*)
...
Cell["Unsteady-State Interphase Diffusion", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`DI$$ = 2.*^-6, $CellContext`DII$$ = 
    7.*^-6, $CellContext`m$$ = 0.2, $CellContext`time$$ = 2, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`DI$$], 2.*^-6, "diffusion coefficient in solvent I"},
       5.*^-7, 
      Rational[1, 100000], 5.*^-7}, {{
       Hold[$CellContext`DII$$], 7.*^-6, 
       "diffusion coefficient in solvent II"}, 5.*^-7, 
      Rational[1, 100000], 5.*^-7}, {{
       Hold[$CellContext`m$$], 0.2, "Henry law constant"}, 0.05, 1.5, 0.05}, {{
       Hold[$CellContext`time$$], 2, "time"}, 0.5, 10, 0.5}}, 
    Typeset`size$$ = {500., {173., 177.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`DI$911978$$ = 0, $CellContext`DII$911979$$ = 
    0, $CellContext`m$911980$$ = 0, $CellContext`time$911981$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`DI$$ = 2.*^-6, $CellContext`DII$$ = 
        7.*^-6, $CellContext`m$$ = 0.2, $CellContext`time$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`DI$$, $CellContext`DI$911978$$, 0], 
        Hold[$CellContext`DII$$, $CellContext`DII$911979$$, 0], 
        Hold[$CellContext`m$$, $CellContext`m$911980$$, 0], 
        Hold[$CellContext`time$$, $CellContext`time$911981$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt1$, $CellContext`plt2$}, $CellContext`CI0 = 
         1; $CellContext`CII0 = 2; $CellContext`CI[
           Pattern[$CellContext`z$, 
            Blank[]], 
           Pattern[$CellContext`t$, 
            
            Blank[]]] := $CellContext`CI0 + ($CellContext`CII0 - \
$CellContext`m$$ $CellContext`CI0) ((1 + 
             Erf[$CellContext`z$/(4 $CellContext`DI$$ $CellContext`t$)^
               Rational[
                1, 2]])/($CellContext`m$$ + \
($CellContext`DI$$/$CellContext`DII$$)^Rational[1, 2])); $CellContext`CII[
           Pattern[$CellContext`z$, 
            Blank[]], 
           Pattern[$CellContext`t$, 
            
            Blank[]]] := $CellContext`CII0 + ($CellContext`CI0 - \
$CellContext`CII0/$CellContext`m$$) ((1 - 
             Erf[$CellContext`z$/(4 $CellContext`DII$$ $CellContext`t$)^
              Rational[1, 2]])/(
            1/$CellContext`m$$ + ($CellContext`DII$$/$CellContext`DI$$)^
             Rational[1, 2])); $CellContext`plt1$ = Plot[
           ReplaceAll[
            $CellContext`CI[$CellContext`z, $CellContext`t], $CellContext`t -> \
$CellContext`time$$], {$CellContext`z, -0.1, 0}, 
           PlotRange -> {{-0.05, 0.05}, {0, 4}}, PlotStyle -> {Thick, 
             RGBColor[0, 0, 1]}, Frame -> True, ImageSize -> {500, 400}, 
           AxesOrigin -> {-0.05, 0}, 
           FrameLabel -> {"position", "concentration"}]; $CellContext`plt2$ = 
         Plot[
           ReplaceAll[
            $CellContext`CII[$CellContext`z, $CellContext`t], $CellContext`t -> \
$CellContext`time$$], {$CellContext`z, 0, 0.1}, Frame -> True, 
           PlotStyle -> {Thick, 
             RGBColor[1, 0, 0]}, PlotRange -> {{-0.05, 0.05}, {0, 4}}, 
           ImageSize -> {500, 400}, AxesOrigin -> {-0.05, 0}, 
           FrameLabel -> {"position", "concentration"}]; 
        Show[$CellContext`plt1$, $CellContext`plt2$, 
          Graphics[{
            Opacity[0.5], LightRed, 
            Rectangle[{0, 0}, {0.05, 4}]}], 
          Graphics[{LightBlue, 
            Opacity[0.5], 
            Rectangle[{-0.05, 0}, {0, 4}]}], 
          Graphics[
           Text[
            Style["solvent I", 
             RGBColor[0, 0, 1], 14], {-0.025, 3.5}]], 
          Graphics[
           Text[
            Style["solvent II", 
             RGBColor[1, 0, 0], 14], {0.025, 3.5}]], 
          ImageSize -> {500, 350}]], 
      "Specifications" :> {{{$CellContext`DI$$, 2.*^-6, 
          "diffusion coefficient in solvent I"}, 5.*^-7, 
         Rational[1, 100000], 5.*^-7, Appearance -> 
         "Labeled"}, {{$CellContext`DII$$, 7.*^-6, 
          "diffusion coefficient in solvent II"}, 5.*^-7, 
         Rational[1, 100000], 5.*^-7, Appearance -> 
         "Labeled"}, {{$CellContext`m$$, 0.2, "Henry law constant"}, 0.05, 
         1.5, 0.05, Appearance -> 
         "Labeled"}, {{$CellContext`time$$, 2, "time"}, 0.5, 10, 0.5, 
         Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`DI$$, $CellContext`DII$$, \
$CellContext`m$$, $CellContext`time$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {258., 263.}},
...
Cell[TextData[{
 "This Demonstration considers the mass transfer of a substance A between two \
immiscible solvents I and II. The concentration in both phases is plotted \
versus position for various values of the diffusion coefficients (in ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["D", 
    RowBox[{"I", "\[InvisibleSpace]", "I"}]], TraditionalForm]], "InlineMath"],
 ", time (in seconds), and Henry law constant ",
 Cell[BoxData[
  FormBox["m", TraditionalForm]], "InlineMath"],
 " (a dimensionless constant). When ",
 Cell[BoxData[
  FormBox[
   RowBox[{"m", "=", "1"}], TraditionalForm]], "InlineMath"],
 " the concentration of A is continuous at the interface, which is not \
typical. The concentration profiles are solutions of the following diffusion \
  ...
  FormBox[
   RowBox[{
    ...
    RowBox[{
     ...
     FractionBox[
      RowBox[{
       SuperscriptBox["\[PartialD]", "2"], "\[InvisibleSpace]", 
       SubscriptBox["C", "I"]}], 
      RowBox[{"\[PartialD]", "\[InvisibleSpace]", 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"t", "=", "0"}], ",", 
    RowBox[{
     RowBox[{"-", "\[Infinity]"}], "<", "z", "<", "0"}]}], TraditionalForm]], 
  "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->1598338],
...
Cell[TextData[{
  ...
  FormBox[
   RowBox[{
    SubscriptBox["C", 
     RowBox[{"I", "\[InvisibleSpace]", "I"}]], "=", 
    SubscriptBox["C", 
     RowBox[{"I", "\[InvisibleSpace]", "I", "\[InvisibleSpace]", "0"}]]}], 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "<", "z", "<", "\[Infinity]"}], TraditionalForm]], 
  "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->42280962],
       ...
       RowBox[{",", 
        RowBox[{
         ...
         FractionBox[
          RowBox[{"\[PartialD]", "\[InvisibleSpace]", 
           SubscriptBox["C", "I"]}], 
          RowBox[{"\[PartialD]", "\[InvisibleSpace]", "z"}]]}]}],
       TraditionalForm]}], "=", 
     RowBox[{"-", 
      FormBox[
       RowBox[{
     ...
     FormBox[
      RowBox[{",", 
       RowBox[{
        ...
        SubscriptBox["C", 
         RowBox[{
         "I", "\[InvisibleSpace]", "I", "\[InvisibleSpace]", "0"}]]}]}],
      TraditionalForm]}]}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->787705259],
...
Cell["\<\
Using Laplace transforms, one can easily derive analytical expressions of the \
concentrations in phases I and II:\
\>", "ManipulateCaption",
 CellID->798160717],
    ...
    RowBox[{
     FractionBox[
      ...
      RowBox[{
       SubscriptBox["C", 
        RowBox[{
        "I", "\[InvisibleSpace]", "I", "\[InvisibleSpace]\[InvisibleSpace]\[InvisibleSpace]\[InvisibleSpace]",
          "0"}]], " ", "-", " ", 
       SubscriptBox["mC", 
        RowBox[{"I", "\[InvisibleSpace]", "0"}]]}]], "=", 
     FractionBox[
   ...
   StyleBox[
    RowBox[{
     FractionBox[
      ...
      RowBox[{
       SubscriptBox["C", 
        RowBox[{"I", "\[InvisibleSpace]\[InvisibleSpace]", "0"}]], " ", "-", 
       " ", 
       RowBox[{
        SubscriptBox["C", 
         RowBox[{"I", "\[InvisibleSpace]", "I", "\[InvisibleSpace]", "0"}]], 
...
UnsteadyStateInterphaseDiffusion&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/UnsteadyStateInterphaseDiffusion/\
UnsteadyStateInterphaseDiffusion-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Unsteady-State Interphase Diffusion",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/UnsteadyStateInterphaseDiffusion/"]\
, None},
  ButtonNote->
   "http://demonstrations.wolfram.com/UnsteadyStateInterphaseDiffusion/"],
 "\"",
...
UnsteadyStateInterphaseDiffusion/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/UnsteadyStateInterphaseDiffusion/"]\
, None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[47804, 972, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[48065, 981, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55081, 1140, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81768, 1709},
 {"Copyright", 81962, 1714}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[599, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34930, 590, 56, 0, 70, "DemoTitle"],
Cell[34989, 592, 5328, 111, 70, "Output",
 CellID->99800222],
Cell[40320, 705, 1106, 30, 70, "ManipulateCaption"],
Cell[41429, 737, 566, 18, 70, "ManipulateCaption",
 CellID->159738499],
Cell[41998, 757, 697, 21, 70, "ManipulateCaption",
 CellID->48984665],
Cell[42698, 780, 436, 18, 70, "ManipulateCaption",
 CellID->1598338],
Cell[43137, 800, 530, 20, 70, "ManipulateCaption",
 CellID->42280962],
Cell[43670, 822, 897, 30, 70, "ManipulateCaption",
 CellID->350409107],
Cell[44570, 854, 402, 16, 70, "ManipulateCaption",
 CellID->251655103],
Cell[44975, 872, 463, 17, 70, "ManipulateCaption",
 CellID->787705259],
Cell[45441, 891, 171, 4, 70, "ManipulateCaption",
 CellID->798160717],
Cell[45615, 897, 1018, 33, 70, "ManipulateCaption",
 CellID->760401701],
Cell[46636, 932, 1165, 38, 70, "ManipulateCaption",
 CellID->245135188],
Cell[47804, 972, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48065, 981, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48759, 998, 33, 0, 70, "DetailsSection"],
Cell[48795, 1000, 192, 6, 70, "DetailNotes",
 CellID->151481174],
Cell[48990, 1008, 4835, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53828, 1099, 45, 0, 70, "CitationSection"],
Cell[53876, 1101, 872, 25, 70, "Citations"],
Cell[54751, 1128, 327, 10, 70, "Author"],
Cell[55081, 1140, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature DSamecKXXuXiduAW0N6#9XzS *)
