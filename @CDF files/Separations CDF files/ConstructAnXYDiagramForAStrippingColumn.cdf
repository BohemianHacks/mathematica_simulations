...
NotebookDataLength[    126976,       2625]
NotebookOptionsPosition[     97884,       2024]
NotebookOutlinePosition[    124308,       2585]
CellTagsIndexPosition[    124195,       2579]
...
ressionUUID->"9d2ccbd5-c18b-4f69-bdeb-76379ae0d93d"],
...
}], "DemoTitle",ExpressionUUID->"36fb5c63-7a0b-43fc-a157-9116849a206c"],
...
$CellContext`h$/4}, {(-$CellContext`w$)/
              ...
              Text[
               Style[
                ...
                17, $CellContext`colL$, FontSize -> 
                15], {$CellContext`w$, $CellContext`h$ + $CellContext`h$/4}, {
               0.2, -1.2}], 
              Text[
               Style[
                Column[
                 ReplaceAll[{
                  ...
                  Nothing]], 17, $CellContext`colV$, FontSize -> 15], {
               0, (-$CellContext`h$)/4}, {
...
$CellContext`diagram$]]], 
 ...
 CellID->161724774,ExpressionUUID->"4965d954-285c-4359-9d97-0223026d082e"],
...
transfer. Construct an ",
 Cell[BoxData[
  ...
  "5c3f92fa-1b5a-41c1-90b7-dc91070371d0"],
 "-",
 Cell[BoxData[
  FormBox["y", TraditionalForm]], "InlineMath",ExpressionUUID->
  "eb4cf6fe-4acb-44c3-a832-8441809ff752"],
...
for help at any stage."
 ...
 CellID->68570872,ExpressionUUID->"1a739afd-0c4a-47d1-8da5-a994626d0dbb"],
...
Cell["THINGS TO TRY", "ManipulateCaption",
 ...
 CellTags->
  "ControlSuggestions",ExpressionUUID->"905da253-f003-4463-9870-637e896755af"],
 ...
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Drag Locators",
     ...
     "c8a6d38a-42ba-484d-8692-065d2a58d740"], True->Cell[TextData[StyleBox[
    "Drag Locators",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "24e1b3fd-f00b-48d3-86b0-ac922dfa3c22"]}, Dynamic[
  ...
  "05002178-9c42-4624-b61a-d1bf87cf3775"],
 ...
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Automatic Animation",
     FontFamily->"Verdana"]],ExpressionUUID->
     "c56ea99c-0049-4d1c-95c2-a4acd22dbad0"], True->Cell[TextData[StyleBox[
    "Automatic Animation",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "e4a35cd0-a93e-46ee-adca-99ada2b24631"]}, Dynamic[
     CurrentValue["MouseOver"]]],
...
UqiK6pPe4XdEdAz6563tx/gejuORGMxJaz8mdpJn7hc="], "Graphics", 
   ...
   TooltipStyle->{
    FontFamily -> "Verdana", FontSize -> 10, FontColor -> GrayLevel[0.35], 
     Background -> GrayLevel[0.98]}]],ExpressionUUID->
  "47c55aa9-4699-433e-9579-ae0bfee32c12"]
}], "ManipulateCaption",
 CellMargins->{{Inherited, Inherited}, {0, 0}},
 Deployed->True,
 FontFamily->"Verdana",
 CellTags->
  "ControlSuggestions",ExpressionUUID->"0f2e0c49-c374-41af-b70d-1bb234fcecaf"],

Cell["DETAILS", "DetailsSection",ExpressionUUID->"f4c6c691-4ed5-4ee3-9250-8663b70209ec"],

Cell["The equilibrium line is calculated using Henry's law:", "DetailNotes",
 CellID->247079330,ExpressionUUID->"8f7d5285-0c70-41f5-9e4c-304aef71e337"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"355fe17f-21fd-471e-a53b-af593a73984f"],
 ","
}], "DetailNotes",
 CellID->1243644,ExpressionUUID->"e4c4a284-2c3c-4d36-b817-4323255d6827"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  "InlineMath",ExpressionUUID->"b800860b-44f0-4740-a0d2-cf72a99f59f5"],
 ","
}], "DetailNotes",
 CellID->179478613,ExpressionUUID->"4eb6f24a-e678-4243-84f0-99d0bd91313e"],

Cell[TextData[{
 "where ",
 Cell[BoxData[
  FormBox["H", TraditionalForm]], "InlineMath",ExpressionUUID->
  "b86ac520-f1ce-41d5-8259-ab7f4a8d1783"],
 " is Henry's constant (atm), ",
 Cell[BoxData[
  FormBox["P", TraditionalForm]], "InlineMath",ExpressionUUID->
  "aba486c9-6abf-471b-807b-84acecad908d"],
 " is pressure (atm), ",
 Cell[BoxData[
  FormBox[
   SuperscriptBox["H", "0"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "b52b39c4-c94e-42d6-b6da-9e083e9a8361"],
 ...
 Cell[BoxData[
  ...
  "9523ed00-26c8-480a-a397-e48cf4339de1"],
 " (atm), ",
 Cell[BoxData[
  FormBox["R", TraditionalForm]], "InlineMath",ExpressionUUID->
  "1a7e6fae-6205-4357-9398-cab29fcd52c8"],
 " is the ideal gas constant (J/mol K), and ",
 Cell[BoxData[
  FormBox["T", TraditionalForm]], "InlineMath",ExpressionUUID->
  "7fac479d-98be-4cf7-b9f9-362e6ff6e3a1"],
 " is temperature (K)."
}], "DetailNotes",
 CellID->196123819,ExpressionUUID->"603f9f8a-a5fe-4489-bae7-5df88488169d"],

Cell["\<\
The operating line is calculated from a mass balance around the stripper:\
\>", "DetailNotes",
 CellID->427750987,ExpressionUUID->"d0fa5609-a7cc-422a-82c1-9fb51de9739e"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"e080fe3a-4807-42d0-8990-f12ef25b8b0b"],
 ","
}], "DetailNotes",
 CellID->31707568,ExpressionUUID->"912fd52a-01cb-4909-a7c6-58410c22d380"],

Cell["which rearranges to:", "DetailNotes",
 CellID->77502291,ExpressionUUID->"6f0e5657-fc29-4be5-aa52-3dcd0d18cd03"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"5f0ff9fc-6d72-43d9-8769-92c0b0ab3c36"],
 "."
}], "DetailNotes",
 CellID->418944240,ExpressionUUID->"3445de50-acba-408c-a730-eaff41f82f84"],

Cell["The operating line is:", "DetailNotes",
 CellID->169303183,ExpressionUUID->"a11d4e0b-71c2-4887-b338-ccc991311b37"],
...
(ppm), ",
 Cell[BoxData[
  ...
  "ea3aade6-30e5-4bf7-beb6-b81a719693f1"],
 ...
 Cell[BoxData[
  ...
  "2176cc3b-9806-4a19-aafc-e7b5d1d59ec9"],
...
(ppm) and ",
 Cell[BoxData[
  ...
  "c94e1f80-c0dc-46a3-8b06-6e425288a462"],
 " is the mole ratio of the impurity in the outlet vapor stream (ppm)."
}], "DetailNotes",
 CellID->10277057,ExpressionUUID->"31dfb2e5-ea01-45ab-919a-59d015103359"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", "0"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "d48a7e6b-78ae-4d51-a8ef-d5c85668d8e5"],
 " on the operating line (",
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", "0"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "d0011704-2e2e-4c7f-b316-15819e985162"],
 ", ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["y", "1"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "6699fefc-1332-496b-96a1-5e2fba2422b9"],
 ") and draw a horizontal line to the equilibrium line ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    SubscriptBox["x", "1"]}], TraditionalForm]], "InlineMath",ExpressionUUID->
  "366b6e77-eb71-4091-b12e-c1cf0597b8a4"],
 ", ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["y", "1"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "149639f5-e54e-4e96-bc7f-785f7e456376"],
 "). Then draw a vertical line down to the operating line. Repeat these steps \
until ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", "N"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "1f81229f-a01a-4320-91b3-1e56ad841076"],
 " is reached."
}], "DetailNotes",
 CellID->189183902,ExpressionUUID->"f2a9014b-7f44-4dc5-8bf6-a31b497be3dc"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", "N"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "9bf834a4-0786-496d-b666-5edcfba87b88"],
 " is calculated from the mass balance:"
}], "DetailNotes",
 CellID->118340805,ExpressionUUID->"93f8d40b-b75b-4234-9f5b-9a3c137ac30f"],
...
Cell[TextData[{
 Cell[BoxData[
  ...
  ExpressionUUID->"e258c5a3-1255-4ff0-92f1-339d4fc637fe"],
 "."
}], "DetailNotes",
 CellID->3072535,ExpressionUUID->"ddb513a3-b4bb-489b-a62a-313bb1e2caa6"],

Cell["Reference", "DetailNotes",
 CellID->359414663,ExpressionUUID->"00c38dca-8cfd-4c9b-b23a-33223b46e36c"],
...
Cell[TextData[{
 ...
 CellID->1027769137,ExpressionUUID->"1844ea4e-847b-40fd-9aeb-ad27a3d327cf"],

Cell["RELATED LINKS", "RelatedLinksSection",ExpressionUUID->"1dd28ce3-3335-4b4b-81a6-bfbf8be405aa"],
...
McCabeThieleMethodForMethanolWaterSeparation/"],
 ...
 CellID->42471128,ExpressionUUID->"84cdd4f8-b783-4f62-8285-079eaaac9148"],
...
Cell[TextData[{
 ...
 CellID->285083932,ExpressionUUID->"4a9c6ead-f8f0-43d4-894c-50be6f6d38cb"],
...
/Y/Zs7Ozly9fFovFw8PDP+MAf3R0lLSb4x0EZsAw2AbzYKG/AGc0UCI=
    ...
    "96c3a1b1-adce-47a2-b75b-05d1ae48ebba"], True->Cell[BoxData[
    GraphicsBox[RasterBox[CompressedData["
...
zfE/BGJAMMgG8SChPwC1foQX
     ...
     ImageSize->{194, 22},
     PlotRange->{{0, 194}, {0, 22}}]],ExpressionUUID->
    "87cc57ac-758f-4b26-881e-ea46a34629e2"]}, Dynamic[
    CurrentValue["MouseOver"]]],
  BaseStyle->"Hyperlink",
  ButtonData->{
...
"DemoSourceNotebookSection",
 ...
 CellFrameColor->RGBColor[
  0.87, 0.87, 0.87],ExpressionUUID->"4c47c05e-200a-4b74-abd0-a8e5eb3cb5ab"],

Cell["PERMANENT CITATION", "CitationSection",ExpressionUUID->"b1c756ac-a81e-4a80-a7c2-2bbffe6992a1"],
...
Baumann"], None},
 ...
 CellID->347156356,ExpressionUUID->"2a0da5cf-a314-4853-b321-9871bab71da6"],
...
"],
 ...
 "Published: ",
 "May 31, 2018"
}], "Citations",ExpressionUUID->"45c943b1-1647-43c7-b3fa-05070cfc1764"],
...
\[ThickSpace]",
 ...
 FontSize->9,
 FontColor->GrayLevel[0.6],
 CellTags->"Copyright",ExpressionUUID->"be5031e6-8b74-4960-8730-2f2dbe7880e5"]
},
Editable->False,
Saveable->False,
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[76045, 1442, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"905da253-f003-4463-9870-637e896755af",
   CellTags->"ControlSuggestions"],
  Cell[76364, 1452, 3010, 66, 70, "ManipulateCaption",ExpressionUUID->"0f2e0c49-c374-41af-b70d-1bb234fcecaf",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[97007, 1999, 873, 23, 70, "Text",ExpressionUUID->"be5031e6-8b74-4960-8730-2f2dbe7880e5",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 123741, 2568},
 {"Copyright", 124048, 2573}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1549, 34, 34446, 569, 70, "DemonstrationHeader",ExpressionUUID->"9d2ccbd5-c18b-4f69-bdeb-76379ae0d93d"],
Cell[35998, 605, 229, 9, 70, "DemoTitle",ExpressionUUID->"36fb5c63-7a0b-43fc-a157-9116849a206c"],
Cell[36230, 616, 38623, 801, 70, "Output",ExpressionUUID->"4965d954-285c-4359-9d97-0223026d082e",
 CellID->161724774],
Cell[74856, 1419, 1186, 21, 70, "ManipulateCaption",ExpressionUUID->"1a739afd-0c4a-47d1-8da5-a994626d0dbb",
 CellID->68570872],
Cell[76045, 1442, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"905da253-f003-4463-9870-637e896755af",
 CellTags->"ControlSuggestions"],
Cell[76364, 1452, 3010, 66, 70, "ManipulateCaption",ExpressionUUID->"0f2e0c49-c374-41af-b70d-1bb234fcecaf",
 CellTags->"ControlSuggestions"],
Cell[79377, 1520, 88, 0, 70, "DetailsSection",ExpressionUUID->"f4c6c691-4ed5-4ee3-9250-8663b70209ec"],
Cell[79468, 1522, 151, 1, 70, "DetailNotes",ExpressionUUID->"8f7d5285-0c70-41f5-9e4c-304aef71e337",
 CellID->247079330],
Cell[79622, 1525, 332, 10, 70, "DetailNotes",ExpressionUUID->"e4c4a284-2c3c-4d36-b817-4323255d6827",
 CellID->1243644],
Cell[79957, 1537, 559, 18, 70, "DetailNotes",ExpressionUUID->"4eb6f24a-e678-4243-84f0-99d0bd91313e",
 CellID->179478613],
Cell[80519, 1557, 1165, 33, 70, "DetailNotes",ExpressionUUID->"603f9f8a-a5fe-4489-bae7-5df88488169d",
 CellID->196123819],
Cell[81687, 1592, 179, 3, 70, "DetailNotes",ExpressionUUID->"d0fa5609-a7cc-422a-82c1-9fb51de9739e",
 CellID->427750987],
Cell[81869, 1597, 545, 18, 70, "DetailNotes",ExpressionUUID->"912fd52a-01cb-4909-a7c6-58410c22d380",
 CellID->31707568],
Cell[82417, 1617, 117, 1, 70, "DetailNotes",ExpressionUUID->"6f0e5657-fc29-4be5-aa52-3dcd0d18cd03",
 CellID->77502291],
Cell[82537, 1620, 522, 17, 70, "DetailNotes",ExpressionUUID->"3445de50-acba-408c-a730-eaff41f82f84",
 CellID->418944240],
Cell[83062, 1639, 120, 1, 70, "DetailNotes",ExpressionUUID->"a11d4e0b-71c2-4887-b338-ccc991311b37",
 CellID->169303183],
Cell[83185, 1642, 543, 18, 70, "DetailNotes",ExpressionUUID->"12dc80cd-62a4-47bc-8a2e-ddfc6e33978a",
 CellID->116936178],
Cell[83731, 1662, 1384, 34, 70, "DetailNotes",ExpressionUUID->"31dfb2e5-ea01-45ab-919a-59d015103359",
 CellID->10277057],
Cell[85118, 1698, 1240, 35, 70, "DetailNotes",ExpressionUUID->"f2a9014b-7f44-4dc5-8bf6-a31b497be3dc",
 CellID->189183902],
Cell[86361, 1735, 329, 8, 70, "DetailNotes",ExpressionUUID->"93f8d40b-b75b-4234-9f5b-9a3c137ac30f",
 CellID->118340805],
Cell[86693, 1745, 493, 16, 70, "DetailNotes",ExpressionUUID->"ddb513a3-b4bb-489b-a62a-313bb1e2caa6",
 CellID->3072535],
Cell[87189, 1763, 107, 1, 70, "DetailNotes",ExpressionUUID->"00c38dca-8cfd-4c9b-b23a-33223b46e36c",
 CellID->359414663],
Cell[87299, 1766, 293, 6, 70, "DetailNotes",ExpressionUUID->"1844ea4e-847b-40fd-9aeb-ad27a3d327cf",
 CellID->1027769137],
Cell[87595, 1774, 99, 0, 70, "RelatedLinksSection",ExpressionUUID->"1dd28ce3-3335-4b4b-81a6-bfbf8be405aa"],
Cell[87697, 1776, 626, 17, 70, "RelatedLinks",ExpressionUUID->"84cdd4f8-b783-4f62-8285-079eaaac9148",
 CellID->42471128],
Cell[88326, 1795, 581, 16, 70, "RelatedLinks",ExpressionUUID->"4a9c6ead-f8f0-43d4-894c-50be6f6d38cb",
 CellID->285083932],
Cell[88910, 1813, 5161, 95, 70, "DemoSourceNotebookSection",ExpressionUUID->"4c47c05e-200a-4b74-abd0-a8e5eb3cb5ab",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[94074, 1910, 100, 0, 70, "CitationSection",ExpressionUUID->"b1c756ac-a81e-4a80-a7c2-2bbffe6992a1"],
Cell[94177, 1912, 417, 11, 70, "Author",ExpressionUUID->"2a0da5cf-a314-4853-b321-9871bab71da6",
 CellID->347156356],
Cell[94597, 1925, 2407, 72, 70, "Citations",ExpressionUUID->"45c943b1-1647-43c7-b3fa-05070cfc1764"],
Cell[97007, 1999, 873, 23, 70, "Text",ExpressionUUID->"be5031e6-8b74-4960-8730-2f2dbe7880e5",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature kSqHL7BnRVDa#x70vg@XYSUB *)
