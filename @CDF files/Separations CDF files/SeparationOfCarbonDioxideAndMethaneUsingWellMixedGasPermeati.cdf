...
NotebookDataLength[     81342,       1635]
NotebookOptionsPosition[     53944,       1044]
NotebookOutlinePosition[     80246,       1606]
CellTagsIndexPosition[     80135,       1600]
WindowTitle->Separation of Carbon Dioxide and Methane Using Well-Mixed Gas \
Permeation
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`yin$$ = 0.4, $CellContext`\[Theta]$$ = 0.4, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Theta]$$], 0.4, "stage cut"}, 0.05, 0.95, 0.01}, {{
       Hold[$CellContext`yin$$], 0.4, "feed composition"}, 0.1, 0.9, 0.05}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Theta]$29839$$ = 0, $CellContext`yin$29840$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`yin$$ = 0.4, $CellContext`\[Theta]$$ = 
        0.4}, "ControllerVariables" :> {
        Hold[$CellContext`\[Theta]$$, $CellContext`\[Theta]$29839$$, 0], 
        Hold[$CellContext`yin$$, $CellContext`yin$29840$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt$, $CellContext`plt2$, $CellContext`sol$, \
$CellContext`yp$, $CellContext`yr$, $CellContext`pp$, $CellContext`pr$, \
$CellContext`\[Alpha]$}, $CellContext`pp$ = 1.1; $CellContext`pr$ = 
         20; $CellContext`\[Alpha]$ = 
         15 (10^(-10)/(0.48 10^(-10))); $CellContext`sol$ = Quiet[
           
           FindRoot[{$CellContext`yp$ ((($CellContext`\[Alpha]$ - 
                  1) ($CellContext`pp$/$CellContext`pr$) (
                  1 - $CellContext`yp$) + 
                1)/($CellContext`\[Alpha]$ - ($CellContext`\[Alpha]$ - 
                1) $CellContext`yp$)) == $CellContext`yr$, ((-(
                  1 - $CellContext`\[Theta]$$))/$CellContext`\[Theta]$$) \
$CellContext`yr$ + $CellContext`yin$$/$CellContext`\[Theta]$$ == \
$CellContext`yp$}, {$CellContext`yp$, 0.01, 0.99}, {$CellContext`yr$, 0.01, 
             0.99}]]; $CellContext`plt$ = 
         Plot[$CellContext`yp$ ((($CellContext`\[Alpha]$ - 
               1) ($CellContext`pp$/$CellContext`pr$) (1 - $CellContext`yp$) + 
             1)/($CellContext`\[Alpha]$ - ($CellContext`\[Alpha]$ - 
             1) $CellContext`yp$)), {$CellContext`yp$, 0, 1}, GridLines -> 
           Automatic, Frame -> True, 
           FrameLabel -> {
            "retentate mole fraction", "permeate mole fraction"}, AspectRatio -> 
           1, PlotStyle -> {Thick, 
             RGBColor[0.48, 0, 0]}, PlotRange -> All, ImageSize -> {400, 400},
            Epilog -> {Green, Thick, 
             Line[{{0, 0}, {1, 1}}]}]; $CellContext`plt2$ = 
         Plot[((-(
               1 - $CellContext`\[Theta]$$))/$CellContext`\[Theta]$$) \
$CellContext`yr$ + $CellContext`yin$$/$CellContext`\[Theta]$$, \
{$CellContext`yr$, 0, $CellContext`yin$$}, PlotStyle -> {Thick, 
             RGBColor[0, 0, 0.48]}, PlotRange -> {0, 1}]; Show[
          ReplaceAll[$CellContext`plt$, Pattern[$CellContext`x, 
             Blank[Line]] :> 
           Map[Reverse, $CellContext`x, {2}]], $CellContext`plt2$, 
          Graphics[{Cyan, 
            PointSize[0.025], 
            ReplaceAll[
             Point[{$CellContext`yr$, $CellContext`yp$}], $CellContext`sol$], 
            Black, 
            Style[
             Text[
              StringJoin["permeate mole fraction : ", 
               ToString[
                NumberForm[
                 ReplaceAll[$CellContext`yp$, $CellContext`sol$], {4, 3}]]], {
              0.5, 0.25}, {-1, 0}], Bold, Blue, 12], 
            Style[
             Text[
              StringJoin["retentate mole fraction : ", 
               ToString[
                NumberForm[
                 ReplaceAll[$CellContext`yr$, $CellContext`sol$], {4, 3}]]], {
              0.5, 0.15}, {-1, 0}], Bold, Blue, 12]}], 
          PlotRange -> {{0, 1}, {0, 1}}]], 
      "Specifications" :> {{{$CellContext`\[Theta]$$, 0.4, "stage cut"}, 0.05,
          0.95, 0.01, Appearance -> 
         "Labeled"}, {{$CellContext`yin$$, 0.4, "feed composition"}, 0.1, 0.9,
          0.05, Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`\[Theta]$$, $CellContext`yin$$}, 
...
Cell["\<\
A mixture of carbon dioxide and methane are to be separated by a cellulose \
acetate membrane at 35 \[Degree]C. \
\>", "ManipulateCaption",
 CellID->169861064],

Cell[TextData[{
 "The permeability of carbon dioxide and methane are ",
 Cell[BoxData[
  FormBox[
   RowBox[{"15.0", "\[Times]", " ", 
    SuperscriptBox["10", 
  ...
  FormBox[
   RowBox[{"0.48", "\[Times]", " ", 
    SuperscriptBox["10", 
     RowBox[{"-", "10"}]], "  ", 
    RowBox[{
     SuperscriptBox["cm", "3"], "(", "STP", ")"}], " ", 
    RowBox[{"cm", "/", 
     SuperscriptBox["cm", "2"]}], " ", 
    StyleBox["s",
     FontSlant->"Plain"], " ", "cm", " ", "Hg"}], TraditionalForm]], 
  "InlineMath"],
 ", respectively. Thus, the selectivity, ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["\[Alpha]", 
     RowBox[{"CO2", "-", "CH4"}]], "=", "31.25"}], TraditionalForm]], 
  "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->354166147],
...
Cell["\<\
The high (retentate side) and low (permeate side) pressures are 20.0 and 1.1 \
atm, respectively. \
\>", "ManipulateCaption",
 CellID->577075093],

Cell[TextData[{
 "The Demonstration plots (1) the RT curve, which relates ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["CO", "2"], TraditionalForm]], "InlineMath"],
 " mole fractions on both sides of the membrane, and (2) the operating line, \
whose slope depends on the stage cut, ",
 Cell[BoxData[
...
Cell[TextData[{
 "Assuming that both retentate and permeate sides are well mixed, the \
graphical solution of this gas permeation problem is given by the \
intersection point shown in cyan in the figure. You can set the value of the \
feed composition (i.e. mole fraction of ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["CO", "2"], TraditionalForm]], "InlineMath"],
 ") as well as the stage cut."
}], "ManipulateCaption",
 CellID->1013807761],
...
Cell[TextData[{
 "[1] P. C. Wankat, ",
 StyleBox["Separation Process Engineering",
  FontSlant->"Italic"],
...
SeparationOfCarbonDioxideAndMethaneUsingWellMixedGasPermeati&version=0009"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
SeparationOfCarbonDioxideAndMethaneUsingWellMixedGasPermeati/\
SeparationOfCarbonDioxideAndMethaneUsingWellMixedGasPermeati-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Separation of Carbon Dioxide and Methane Using Well-Mixed Gas \
Permeation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SeparationOfCarbonDioxideAndMethaneUsingWellMixedGasPermeati/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
SeparationOfCarbonDioxideAndMethaneUsingWellMixedGasPermeati/"],
 "\"",
...
Cell["\<\
King Fahd University of Petroleum & Minerals and \[CapitalEAcute]cole \
nationale d'ing\[EAcute]nieurs de Monastir\
\>", "Author",
 FontColor->GrayLevel[0.6],
 CellID->125340587],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41968, 760, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42229, 769, 3774, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[53122, 1019, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79848, 1589},
 {"Copyright", 80043, 1594}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[638, 22, 34328, 567, 70, "DemonstrationHeader"],
Cell[34969, 591, 101, 2, 70, "DemoTitle"],
Cell[35073, 595, 4861, 95, 70, "Output",
 CellID->215200236],
Cell[39937, 692, 169, 4, 70, "ManipulateCaption",
 CellID->169861064],
Cell[40109, 698, 845, 29, 70, "ManipulateCaption",
 CellID->354166147],
Cell[40957, 729, 155, 4, 70, "ManipulateCaption",
 CellID->577075093],
Cell[41115, 735, 405, 11, 70, "ManipulateCaption",
 CellID->360689834],
Cell[41523, 748, 442, 10, 70, "ManipulateCaption",
 CellID->1013807761],
Cell[41968, 760, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42229, 769, 3774, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46006, 853, 33, 0, 70, "DetailsSection"],
Cell[46042, 855, 51, 1, 70, "DetailNotes",
 CellID->73574573],
Cell[46096, 858, 205, 6, 70, "DetailNotes",
 CellID->1904847904],
Cell[46304, 866, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51235, 960, 45, 0, 70, "CitationSection"],
Cell[51283, 962, 1055, 28, 70, "Citations"],
Cell[52341, 992, 587, 18, 70, "Author"],
Cell[52931, 1012, 188, 5, 70, "Author",
 CellID->125340587],
Cell[53122, 1019, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature aTUskXpy9B4dWvmmbEpOO6Pb *)
