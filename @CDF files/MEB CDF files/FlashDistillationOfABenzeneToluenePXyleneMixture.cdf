...
NotebookDataLength[     90853,       1830]
NotebookOptionsPosition[     64900,       1268]
NotebookOutlinePosition[     91188,       1829]
CellTagsIndexPosition[     91077,       1823]
WindowTitle->Flash Distillation of a Benzene, Toluene, p-Xylene Mixture
WindowFrame->Normal*)
...
Cell[TextData[{
 "Flash Distillation of a Benzene, Toluene, ",
 Cell[BoxData[
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`ctrl$$ = 1, $CellContext`p$$ = {
    0.17500000000000002`, 0.245}, $CellContext`P$$ = 760, $CellContext`T$$ = 
    120, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`ctrl$$], 1, ""}, {
      1 -> "choose feed composition", 2 -> "flash calculation"}}, {{
       Hold[$CellContext`p$$], {0.17500000000000002`, 0.245}}, {0.1, 0.1}, {
      0.5, 0.5}}, {{
       Hold[$CellContext`P$$], 760, "pressure in mmHg"}, 600, 800, 10}, {{
       Hold[$CellContext`T$$], 120, "temperature in \[Degree]C"}, 70, 140, 
      5}}, Typeset`size$$ = Automatic, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`ctrl$157789$$ = False, $CellContext`p$157790$$ = {0, 
    0}, $CellContext`P$157791$$ = 0, $CellContext`T$157792$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`ctrl$$ = 
        1, $CellContext`p$$ = {0.17500000000000002`, 0.245}, $CellContext`P$$ = 
        760, $CellContext`T$$ = 120}, "ControllerVariables" :> {
        Hold[$CellContext`ctrl$$, $CellContext`ctrl$157789$$, False], 
        Hold[$CellContext`p$$, $CellContext`p$157790$$, {0, 0}], 
        Hold[$CellContext`P$$, $CellContext`P$157791$$, 0], 
        Hold[$CellContext`T$$, $CellContext`T$157792$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      DynamicModule[{$CellContext`sol, $CellContext`K1, $CellContext`K2, \
$CellContext`K3, $CellContext`PS1, $CellContext`PS2, $CellContext`PS3, \
$CellContext`z1, $CellContext`z2, $CellContext`z3, $CellContext`Tdew, \
$CellContext`Tbubble, $CellContext`\[Upsilon], $CellContext`nu}, 
        LocatorPane[
         Dynamic[$CellContext`p$$, ($CellContext`p$$ = {
            Part[#, 1], 
            Min[1 - Part[#, 1], 
             Part[#, 2]]})& ], 
         Dynamic[($CellContext`PS1[
              Pattern[$CellContext`T, 
               Blank[]]] := 
            10^($CellContext`A1 - $CellContext`B1/($CellContext`C1 + \
$CellContext`T)); $CellContext`PS2[
              Pattern[$CellContext`T, 
               Blank[]]] := 
            10^($CellContext`A2 - $CellContext`B2/($CellContext`C2 + \
$CellContext`T)); $CellContext`PS3[
              Pattern[$CellContext`T, 
               Blank[]]] := 
            10^($CellContext`A3 - $CellContext`B3/($CellContext`C3 + \
$CellContext`T)); $CellContext`z1 = 
            Part[$CellContext`p$$, 1]; $CellContext`z2 = 
            Part[$CellContext`p$$, 2]; $CellContext`z3 = 
            1 - $CellContext`z1 - $CellContext`z2; $CellContext`Tbubble = 
            ReplaceAll[$CellContext`Ta, 
              
              FindRoot[$CellContext`z1 $CellContext`PS1[$CellContext`Ta] + \
$CellContext`z2 $CellContext`PS2[$CellContext`Ta] + $CellContext`z3 \
$CellContext`PS3[$CellContext`Ta] == $CellContext`P$$, {$CellContext`Ta, 50, 
                150}]]; $CellContext`Tdew = ReplaceAll[$CellContext`Ta, 
              FindRoot[
              1/($CellContext`z1/$CellContext`PS1[$CellContext`Ta] + \
$CellContext`z2/$CellContext`PS2[$CellContext`Ta] + \
$CellContext`z3/$CellContext`PS3[$CellContext`Ta]) == $CellContext`P$$, \
{$CellContext`Ta, 50, 150}]]; 
           Null); $CellContext`K1 = \
$CellContext`PS1[$CellContext`T$$]/$CellContext`P$$; $CellContext`K2 = \
$CellContext`PS2[$CellContext`T$$]/$CellContext`P$$; $CellContext`K3 = \
$CellContext`PS3[$CellContext`T$$]/$CellContext`P$$; $CellContext`sol = Quiet[
             
             Solve[($CellContext`K1 - 1) (Part[$CellContext`p$$, 1]/(
                 1 + $CellContext`\[Upsilon] ($CellContext`K1 - 
                   1))) + ($CellContext`K2 - 1) (Part[$CellContext`p$$, 2]/(
                 1 + $CellContext`\[Upsilon] ($CellContext`K2 - 
                   1))) + ($CellContext`K3 - 
                 1) ((1 - Part[$CellContext`p$$, 1] - 
                  Part[$CellContext`p$$, 2])/(
                 1 + $CellContext`\[Upsilon] ($CellContext`K3 - 1))) == 
              0, $CellContext`\[Upsilon]]]; $CellContext`nu = 
           If[$CellContext`Tdew > $CellContext`T$$ > $CellContext`Tbubble, 
             If[0 < ReplaceAll[$CellContext`\[Upsilon], 
                Part[$CellContext`sol, 1]] < 1, 
              ReplaceAll[$CellContext`\[Upsilon], 
               Part[$CellContext`sol, 1]], 
              ReplaceAll[$CellContext`\[Upsilon], 
               Part[$CellContext`sol, 2]]], 
             If[$CellContext`T$$ > $CellContext`Tdew, 1, 0]]; 
          Switch[$CellContext`ctrl$$, 1, 
            Show[
             Plot[
             1 - $CellContext`x, {$CellContext`x, 0, 1}, AspectRatio -> 1, 
              Frame -> True, Filling -> Axis, PlotStyle -> {Thick, Black}, 
              GridLines -> {
                Table[$CellContext`i, {$CellContext`i, 0, 1, 0.1}], 
                Table[$CellContext`i, {$CellContext`i, 0, 1, 0.1}]}], 
             Graphics[{
               Style[
                Text[
                 ToString[
                  NumberForm[
                   Part[$CellContext`p$$, 1], {5, 4}]], {
                 Part[$CellContext`p$$, 1] + 0.05, Part[$CellContext`p$$, 2] + 
                  0.05}, {-1, 0}], Red, Bold, 14, Background -> White], 
               Style[
                Text[
                 ToString[
                  NumberForm[
                   Part[$CellContext`p$$, 2], {5, 4}]], {
                 Part[$CellContext`p$$, 1] + 0.05, Part[$CellContext`p$$, 2] - 
                  0.025}, {-1, 0}], Red, Bold, 14, Background -> White], 
               Style[
                Text[
                 ToString[
                  NumberForm[
                  1 - Part[$CellContext`p$$, 1] - Part[$CellContext`p$$, 2], {
                   5, 4}]], {
                 Part[$CellContext`p$$, 1] + 0.05, Part[$CellContext`p$$, 2] - 
                  0.1}, {-1, 0}], Red, Bold, 14, Background -> White], 
               Style[
                Text[
                 Row[{
                   Style["p", Italic], 
                   "\[Hyphen]Xylene"}], {-0.1, -0.105}, {-1, 0}], 
                RGBColor[0.25, 0.43, 0.82], 14], 
               Style[
                Text["Toluene", {-0.1, 1.099}, {-1, 0}], 
                RGBColor[0.25, 0.43, 0.82], 14], 
               Style[
                Text["Benzene", {1.05, -0.065}, {-1, 0}], 
                RGBColor[0.25, 0.43, 0.82], 14]}], ImageSize -> {450, 400}, 
             ImagePadding -> {{80, 80}, {35, 35}}, PlotRangeClipping -> 
             False], 2, 
            Graphics[{
              Text[
               Style["vapor mole fraction:", 
                ColorData["HTML", "SlateBlue"], 14], {2.2, 3.75}, {-1, 0}], 
              Text[
               Style[
                Row[{"Benzene = ", 
                  ToString[
                   
                   NumberForm[$CellContext`K1 (Part[$CellContext`p$$, 1]/(
                    1 + $CellContext`nu ($CellContext`K1 - 1))), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                ColorData["HTML", "SlateBlue"], 12], {2.2, 3.35}, {-1, 0}], 
              Text[
               Style[
                Row[{"Toluene = ", 
                  ToString[
                   
                   NumberForm[$CellContext`K2 (Part[$CellContext`p$$, 2]/(
                    1 + $CellContext`nu ($CellContext`K2 - 1))), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                ColorData["HTML", "SlateBlue"], 12], {2.2, 2.95}, {-1, 0}], 
              Text[
               Style[
                Row[{
                  Style["p", Italic], "\[Hyphen]Xylene = ", 
                  ToString[
                   
                   NumberForm[$CellContext`K3 ((1 - Part[$CellContext`p$$, 1] - 
                    Part[$CellContext`p$$, 2])/(
                    1 + $CellContext`nu ($CellContext`K3 - 1))), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                ColorData["HTML", "SlateBlue"], 12], {2.2, 2.55}, {-1, 0}], 
              Null, 
              Text[
               Style[
                Row[{"V = ", 
                  ToString[
                   ...
                   NumberForm[$CellContext`nu, {4, 3}, 
                    ExponentFunction -> (Null& )]], " kmol/hr"}], 
                ColorData["HTML", "SlateBlue"], 12], {2.2, 2.15}, {-1, 0}], 
              Text[
               Style["liquid mole fraction:", 
                RGBColor[1, 0.47, 0], 14], {2.2, -2.25}, {-1, 0}], 
              Text[
               Style[
                Row[{"Benzene = ", 
                  ToString[
                   ...
                   Part[$CellContext`p$$, 1]/(
                    1 + $CellContext`nu ($CellContext`K1 - 1)), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                RGBColor[1, 0.47, 0], 12], {2.2, -2.65}, {-1, 0}], 
              Text[
               Style[
                Row[{"Toluene = ", 
                  ToString[
                   ...
                   Part[$CellContext`p$$, 2]/(
                    1 + $CellContext`nu ($CellContext`K2 - 1)), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                RGBColor[1, 0.47, 0], 12], {2.2, -3.05}, {-1, 0}], 
              Text[
               Style[
                Row[{
                  Style["p", Italic], "\[Hyphen]Xylene =", 
                  ToString[
                   ...
                   NumberForm[(1 - Part[$CellContext`p$$, 1] - 
                    Part[$CellContext`p$$, 2])/(
                    1 + $CellContext`nu ($CellContext`K3 - 1)), {4, 3}, 
                    ExponentFunction -> (Null& )]]}], 
                RGBColor[1, 0.47, 0], 12], {2.2, -3.45}, {-1, 0}], 
              Text[
               Style[
                Row[{"L = ", 
                  ToString[
                   NumberForm[
                   1 - $CellContext`nu, {4, 3}, 
                    ExponentFunction -> (Null& )]], " kmol/hr"}], 
                RGBColor[1, 0.47, 0], 12], {2.2, -3.85}, {-1, 0}], 
              Text[
               Style[
                Row[{"vapor fraction = ", 
                  ToString[
               ...
               Style[
                Row[{
                  ...
                  ToString[
                   ...
                   NumberForm[$CellContext`Tdew, {4, 3}, 
                    ExponentFunction -> (Null& )]]}], Purple, 
                14], {-2.9, -0.8}, {-1, 0}], 
              Text[
               Style[
                Row[{
                  ...
                  ToString[
                   ...
                   NumberForm[$CellContext`Tbubble, {4, 3}, 
                    ExponentFunction -> (Null& )]]}], Purple, 
                14], {-2.9, -1.2}, {-1, 0}], 
              Text[
               Style["feed", 
                RGBColor[0.67, 0.75, 0.15], 16], {-2.9, 0.75}, {-1, 0}], 
              EdgeForm[Thick], Purple, 
              Rectangle[{0, 0}, {2, 2}], 
              Text[
               Style["F = 1 kmole/hr", 
                RGBColor[0.67, 0.75, 0.15], 16], {-2.9, 0.25}, {-1, 0}], 
              EdgeForm[Thick], Purple, 
              Rectangle[{0, 0}, {2, 2}], Thick, 
              ColorData["HTML", "SlateBlue"], 
              Arrow[{{1, 2}, {1, 4}, {5, 4}}], {Thick, 
               RGBColor[1, 0.47, 0], 
               Arrow[{{1, 0}, {1, -2}, {5, -2}}]}, {Thick, 
               RGBColor[0.67, 0.75, 0.15], 
               Arrow[{{-3, 1}, {-0.001, 1}}]}, 
              Text[
               Style["Flash", White, 22], {1, 1}]}, 
             PlotRange -> {{-4, 6}, {-4, 4.1}}, ImageSize -> {450, 400}]]], {{
          0., 0.}, {1, 1}}, Enabled -> 
         If[$CellContext`ctrl$$ == 1, True, False]]], 
      "Specifications" :> {{{$CellContext`ctrl$$, 1, ""}, {
         1 -> "choose feed composition", 2 -> 
          "flash calculation"}}, {{$CellContext`p$$, {0.17500000000000002`, 
          0.245}}, {0.1, 0.1}, {0.5, 0.5}, ControlType -> 
         None}, {{$CellContext`P$$, 760, "pressure in mmHg"}, 600, 800, 10, 
         Appearance -> 
         "Labeled"}, {{$CellContext`T$$, 120, "temperature in \[Degree]C"}, 
         70, 140, 5, Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols -> {$CellContext`T$$, $CellContext`P$$, \
$CellContext`ctrl$$}, SynchronousInitialization -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{364., {76., 81.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>({$CellContext`A1 = 6.87987; $CellContext`B1 = 
        1196.76; $CellContext`C1 = 219.161; $CellContext`A2 = 
        6.95087; $CellContext`B2 = 1342.31; $CellContext`C2 = 
        219.187; $CellContext`A3 = 6.99053; $CellContext`B3 = 
        1453.43; $CellContext`C3 = 215.31; Null}; Typeset`initDone$$ = True),
...
Cell[TextData[{
 "Consider a ternary mixture of benzene, toluene, and ",
 Cell[BoxData[
  FormBox["p", TraditionalForm]], "InlineMath"],
 "-xylene (BTX). For this ideal system, vapor-liquid equilibrium data can be \
computed using Raoult's law, ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"P", " ", 
 ...
 " are the liquid and vapor phase mole fraction of component ",
 Cell[BoxData[
  FormBox["i", TraditionalForm]], "InlineMath"],
 ". You can select a feed composition by dragging the locator in the ternary \
triangular diagram (i.e. inside the light blue region) and you can vary the \
values of ",
 Cell[BoxData[
  FormBox["P", TraditionalForm]], "InlineMath"],
 " (expressed in mmHg) and ",
 Cell[BoxData[
  FormBox["T", TraditionalForm]], "InlineMath"],
 " (expressed in \[Degree]C). This Demonstration computes the vapor fraction ",
 Cell[BoxData[
  FormBox["\[Phi]", TraditionalForm]], "InlineMath"],
 " of the feed and the composition of the liquid and vapor streams leaving \
the isothermal flash drum. Only when ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["T", "bubble"], "<", "T", "<", 
    SubscriptBox["T", "dew"]}], TraditionalForm]], "InlineMath"],
 " will the feed be a two-phase mixture such that ",
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "<", "\[Phi]", "<", "1"}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->33083325],
...
FlashDistillationOfABenzeneToluenePXyleneMixture&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FlashDistillationOfABenzeneToluenePXyleneMixture/\
FlashDistillationOfABenzeneToluenePXyleneMixture-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Flash Distillation of a Benzene, Toluene, ",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
FlashDistillationOfABenzeneToluenePXyleneMixture/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FlashDistillationOfABenzeneToluenePXyleneMixture/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[51879, 964, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[52140, 973, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[64078, 1243, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 90790, 1812},
 {"Copyright", 90985, 1817}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1535, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35866, 603, 162, 5, 70, "DemoTitle"],
Cell[36031, 610, 13751, 291, 70, "Output",
 CellID->43959251],
Cell[49785, 903, 2091, 59, 70, "ManipulateCaption",
 CellID->33083325],
Cell[51879, 964, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[52140, 973, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[56583, 1071, 4887, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[61473, 1164, 45, 0, 70, "CitationSection"],
Cell[61521, 1166, 863, 26, 70, "Author"],
Cell[62387, 1194, 1688, 47, 70, "Citations"],
Cell[64078, 1243, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature jRazAWB8mveVgxAMX8xvrIn# *)
