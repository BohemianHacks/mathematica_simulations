...
NotebookDataLength[     83816,       1739]
NotebookOptionsPosition[     56160,       1140]
NotebookOutlinePosition[     82427,       1701]
CellTagsIndexPosition[     82316,       1695]
WindowTitle->Heat Diffusion in a Semi-Infinite Region
WindowFrame->Normal*)
...
Cell["Heat Diffusion in a Semi-Infinite Region", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`bc$$ = 3, $CellContext`t$$ = 0.5, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`t$$], 0.5, "time"}, 0, 1}, {{
       Hold[$CellContext`bc$$], 3, "boundary condition"}, {
      1 -> "constant temperature", 2 -> "constant heat flux", 3 -> 
       "convection"}}}, Typeset`size$$ = {453., {138., 142.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`t$591$$ = 0, $CellContext`bc$592$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`bc$$ = 3, $CellContext`t$$ = 0.5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`t$$, $CellContext`t$591$$, 0], 
        Hold[$CellContext`bc$$, $CellContext`bc$592$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Evaluate[
         $CellContext`\[Theta][$CellContext`bc$$][$CellContext`x, \
$CellContext`t$$]], {$CellContext`x, 0, 4}, AxesLabel -> {$CellContext`x, 
          
          Switch[$CellContext`bc$$, 
           1, ($CellContext`T - Subscript[$CellContext`T, 0])/(
           Subscript[$CellContext`T, $CellContext`s] - 
           Subscript[$CellContext`T, 0]), 
           2, ($CellContext`T - Subscript[$CellContext`T, 0])/(
           Subscript[$CellContext`T, $CellContext`max] - 
           Subscript[$CellContext`T, 0]), 
           3, ($CellContext`T - Subscript[$CellContext`T, 0])/(
           Subscript[$CellContext`T, Infinity] - 
           Subscript[$CellContext`T, 0])]}, PlotRange -> {-0.02, 1}, 
        PlotStyle -> {{
           Thickness[0.006], 
           RGBColor[1, 0.3, 0]}, {
           Thickness[0.006], 
           RGBColor[0, 0.5, 0]}, {
           Thickness[0.006], 
           RGBColor[0, 0.5, 1]}}, ImageSize -> 280 {GoldenRatio, 1}, 
        ImagePadding -> {{15, 10}, {10, 40}}], 
      "Specifications" :> {{{$CellContext`t$$, 0.5, "time"}, 0, 1, Appearance -> 
         "Labeled"}, {{$CellContext`bc$$, 3, "boundary condition"}, {
         1 -> "constant temperature", 2 -> "constant heat flux", 3 -> 
          "convection"}}}, "Options" :> {AutorunSequencing -> {1}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{498., {194., 199.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`\[Theta][
          Pattern[$CellContext`bc, 
           Blank[]]][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
           Blank[]]] := 
        Condition[0, $CellContext`t <= 0], $CellContext`\[Theta][1][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
           Blank[]]] := 
        Erfc[$CellContext`x/(2 
          Sqrt[$CellContext`\[Alpha] $CellContext`t])], $CellContext`\[Theta][
         2][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
           Blank[]]] := ((2 Sqrt[($CellContext`\[Alpha] $CellContext`t)/Pi]) 
           Exp[-($CellContext`x^2/((
               4 $CellContext`\[Alpha]) $CellContext`t))] - $CellContext`x 
          Erfc[$CellContext`x/(2 
            Sqrt[$CellContext`\[Alpha] $CellContext`t])])/(2 
         Sqrt[($CellContext`\[Alpha] $CellContext`tMax)/
           Pi]), $CellContext`\[Theta][3][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
           Blank[]]] := 
        Erfc[$CellContext`x/(2 Sqrt[$CellContext`\[Alpha] $CellContext`t])] - 
         Exp[($CellContext`h $CellContext`x)/$CellContext`k + \
(($CellContext`h^2 $CellContext`\[Alpha]) $CellContext`t)/$CellContext`k^2] 
         Erfc[$CellContext`x/(2 
            Sqrt[$CellContext`\[Alpha] $CellContext`t]) + ($CellContext`h 
             Sqrt[$CellContext`\[Alpha] $CellContext`t])/$CellContext`k], \
$CellContext`\[Theta][3][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
          ...
          Pattern[$CellContext`h, 
           Blank[]]] := 
        Condition[0, $CellContext`t <= 0], $CellContext`\[Theta][3][
          Pattern[$CellContext`x, 
           Blank[]], 
          Pattern[$CellContext`t, 
           Blank[]], 
...
(($CellContext`h^2 $CellContext`\[Alpha]) $CellContext`t)/$CellContext`k^2] 
         Erfc[$CellContext`x/(2 
            Sqrt[$CellContext`\[Alpha] $CellContext`t]) + ($CellContext`h 
             Sqrt[$CellContext`\[Alpha] $CellContext`t])/$CellContext`k], \
$CellContext`\[Alpha] = 1, $CellContext`tMax = 
        1, $CellContext`h = {10, 1, 0.1}, $CellContext`k = 1, 
     ...
     ReleaseHold[
       HoldComplete[{($CellContext`\[Theta][
             ...
             Pattern[$CellContext`x, 
              Blank[]], 
             Pattern[$CellContext`t, 
              Blank[]]] := Condition[0, $CellContext`t <= 0]; 
          Null) ($CellContext`\[Theta][1][
             Pattern[$CellContext`x, 
              Blank[]], 
             Pattern[$CellContext`t, 
              Blank[]]] := 
           Erfc[$CellContext`x/(
             2 ($CellContext`\[Alpha] $CellContext`t)^Rational[1, 2])]; 
          Null) ($CellContext`\[Theta][2][
             Pattern[$CellContext`x, 
              Blank[]], 
             Pattern[$CellContext`t, 
              Blank[]]] := (
             2 ($CellContext`\[Alpha] $CellContext`t/Pi)^Rational[1, 2] 
              Exp[-($CellContext`x^2/(
                 4 $CellContext`\[Alpha] $CellContext`t))] - $CellContext`x 
             Erfc[$CellContext`x/(
               2 ($CellContext`\[Alpha] $CellContext`t)^Rational[1, 2])])/(
            2 ($CellContext`\[Alpha] $CellContext`tMax/Pi)^Rational[1, 2]); 
          Null) ($CellContext`\[Theta][3][
             Pattern[$CellContext`x, 
              Blank[]], 
             Pattern[$CellContext`t, 
              Blank[]]] := 
...
$CellContext`h^2 $CellContext`\[Alpha] $CellContext`t/$CellContext`k^2] 
            Erfc[$CellContext`x/(
               2 ($CellContext`\[Alpha] $CellContext`t)^
                Rational[
                 1, 2]) + $CellContext`h ($CellContext`\[Alpha] \
$CellContext`t)^Rational[1, 2]/$CellContext`k]; Null), {
          HoldComplete[$CellContext`k = 1; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`\[Alpha] = 1; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`h = {10, 1, 0.1}; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`tMax = 1; Null]}}]]; 
...
Cell[TextData[{
 "This Demonstration shows solutions for the one-dimensional heat diffusion \
equation ",
 Cell[BoxData[
  FormBox[
   RowBox[{"(", 
    RowBox[{
     RowBox[{
      SubscriptBox["\[PartialD]", "t"], "\[VeryThinSpace]", "T"}], "=", 
     RowBox[{"\[Alpha]", " ", 
      RowBox[{
       SubscriptBox["\[PartialD]", 
        RowBox[{"x", ",", "x"}]], "\[VeryThinSpace]", "T"}]}]}], ")"}], 
 ...
 ", the dimensionless temperature distribution is animated in time for the \
three classical boundary conditions at ",
 Cell[BoxData[
  FormBox[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    SubscriptBox["q", "s"]}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"h", "(", 
     RowBox[{
      SubscriptBox["T", "\[Infinity]"], "-", "T"}], ")"}]}], 
   TraditionalForm]], "InlineMath"],
 ". For the convection case, temperature distributions for a relatively high, \
medium, and low value of the heat transfer coefficient ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
 " are displayed. A high ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
 " (red curve) gives results close to the constant surface temperature case, \
while a low ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
 " value (blue curve) gives results similar to the constant heat flux case. \
In all cases the thermal affected zone is of the order of ",
 Cell[BoxData[
  FormBox[
   RowBox[{"4", 
    SqrtBox[
     RowBox[{"\[Alpha]", " ", "t"}]]}], TraditionalForm]], "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->43255317],
...
Cell["\<\
These animations were generated from the analytical solutions, which can be \
found in the source code. The following nomenclature is used.\
\>", "DetailNotes",
 CellID->300725344],
...
Cell[TextData[{
 ...
 " = thermal conductivity (W/m\[VeryThinSpace]",
 Cell[BoxData[
  FormBox[
...
Cell[TextData[{
 ButtonBox["Heat Conduction in Some Standard Solids",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HeatConductionInSomeStandardSolids/\
"], None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Penetration of Potential in a Semi-Infinite Region",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
PenetrationOfPotentialInASemiInfiniteRegion/"], None}],
 " (",
 ButtonBox["Wolfram Demonstrations Project",
  BaseStyle->"SiteLink",
  ButtonData->{
...
HeatDiffusionInASemiInfiniteRegion&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/HeatDiffusionInASemiInfiniteRegion/\
HeatDiffusionInASemiInfiniteRegion-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Heat Diffusion in a Semi-Infinite Region",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HeatDiffusionInASemiInfiniteRegion/\
"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/HeatDiffusionInASemiInfiniteRegion/"],
 "\"",
...
HeatDiffusionInASemiInfiniteRegion/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HeatDiffusionInASemiInfiniteRegion/\
"], None},
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Brian Vick",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Brian+Vick"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Brian+Vick"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45528, 845, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[45789, 854, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55338, 1115, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82030, 1684},
 {"Copyright", 82224, 1689}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[604, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34935, 590, 61, 0, 70, "DemoTitle"],
Cell[34999, 592, 7773, 168, 70, "Output",
 CellID->528441714],
Cell[42775, 762, 2750, 81, 70, "ManipulateCaption",
 CellID->43255317],
Cell[45528, 845, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45789, 854, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46483, 871, 33, 0, 70, "DetailsSection"],
Cell[46519, 873, 190, 4, 70, "DetailNotes",
 CellID->300725344],
Cell[46712, 879, 139, 5, 70, "DetailNotes",
 CellID->89034867],
Cell[46854, 886, 137, 5, 70, "DetailNotes",
 CellID->185811007],
Cell[46994, 893, 133, 5, 70, "DetailNotes",
 CellID->460944129],
Cell[47130, 900, 153, 5, 70, "DetailNotes",
 CellID->297018379],
Cell[47286, 907, 267, 9, 70, "DetailNotes",
 CellID->309636191],
Cell[47556, 918, 264, 10, 70, "DetailNotes",
 CellID->199173459],
Cell[47823, 930, 250, 9, 70, "DetailNotes",
 CellID->16965950],
Cell[48076, 941, 187, 6, 70, "DetailNotes",
 CellID->91656744],
Cell[48266, 949, 44, 0, 70, "RelatedLinksSection"],
Cell[48313, 951, 448, 14, 70, "RelatedLinks",
 CellID->651746067],
Cell[48764, 967, 468, 14, 70, "RelatedLinks",
 CellID->856544393],
Cell[49235, 983, 4841, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54079, 1074, 45, 0, 70, "CitationSection"],
Cell[54127, 1076, 887, 25, 70, "Citations"],
Cell[55017, 1103, 318, 10, 70, "Author"],
Cell[55338, 1115, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature VTEzdck6ZoD8IwQIsJpg8KXC *)
