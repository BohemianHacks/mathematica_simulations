...
NotebookDataLength[     93876,       2052]
NotebookOptionsPosition[     66667,       1453]
NotebookOutlinePosition[     92921,       2014]
CellTagsIndexPosition[     92810,       2008]
WindowTitle->Heat Conduction in a Rod
WindowFrame->Normal*)
...
Cell["Heat Conduction in a Rod", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`Npp$$ = 20, $CellContext`ta$$ = 0.05, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`Npp$$], 20, "collocation points"}, 15, 35, 1}, {{
       Hold[$CellContext`ta$$], 0.05, 
       Style["t", Italic]}, 0.001, 0.2, 0.001}}, Typeset`size$$ = {
    400., {198., 202.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`Npp$15075$$ = 
    0, $CellContext`ta$15076$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`Npp$$ = 20, $CellContext`ta$$ = 0.05}, 
      "ControllerVariables" :> {
        Hold[$CellContext`Npp$$, $CellContext`Npp$15075$$, 0], 
        Hold[$CellContext`ta$$, $CellContext`ta$15076$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`cp$, $CellContext`cpp$, $CellContext`eq$, \
$CellContext`t$, $CellContext`d$, $CellContext`Add$, $CellContext`Bdd$, \
$CellContext`y$, $CellContext`sol1$, $CellContext`sys1$, $CellContext`init$, \
$CellContext`al$, $CellContext`c$, $CellContext`Np$, $CellContext`tbl$}, \
$CellContext`Np$ = $CellContext`Npp$$ - 1; $CellContext`L = 
         1; $CellContext`Tanal[
           Pattern[$CellContext`x, 
            Blank[]], 
           Pattern[$CellContext`t, 
            Blank[]]] := (8/Pi^2) 
          Sum[(((1/$CellContext`n^2) Sin[$CellContext`n (Pi/2)]) 
             Sin[($CellContext`n Pi) $CellContext`x]) 
            Exp[((-$CellContext`n^2) Pi^2) $CellContext`t], {$CellContext`n, 
             1, 100}]; $CellContext`eq$[
           Pattern[$CellContext`i$, 
            Blank[]]] := $CellContext`Tpp[$CellContext`i$][$CellContext`t$] == 
          Derivative[1][
            $CellContext`T[$CellContext`i$]][$CellContext`t$]; $CellContext`Tp[
           Pattern[$CellContext`i$, 
            Blank[]]][
           Pattern[$CellContext`t$, 
            Blank[]]] := (2/$CellContext`L) 
          Sum[Part[$CellContext`Add$, $CellContext`i$, $CellContext`j] \
$CellContext`T[$CellContext`j][$CellContext`t$], {$CellContext`j, 
             1, $CellContext`Np$ + 1}]; $CellContext`Tpp[
           Pattern[$CellContext`i$, 
            Blank[]]][
           Pattern[$CellContext`t$, 
            Blank[]]] := (4/$CellContext`L^2) 
          Sum[Part[$CellContext`Bdd$, $CellContext`i$, $CellContext`j] \
$CellContext`T[$CellContext`j][$CellContext`t$], {$CellContext`j, 
             1, $CellContext`Np$ + 1}]; $CellContext`d$[0, 0] = 
         N[(2 $CellContext`Np$^2 + 1)/
           6]; $CellContext`d$[$CellContext`Np$, $CellContext`Np$] = 
         N[(-(2 $CellContext`Np$^2 + 1))/6]; $CellContext`y$[
           Pattern[$CellContext`i$, 
            Blank[]]] := N[
           Cos[$CellContext`i$ (Pi/$CellContext`Np$)]]; $CellContext`d$[
           Pattern[$CellContext`i$, 
            Blank[]], 
           Pattern[$CellContext`i$, 
            Blank[]]] := 
         N[(-$CellContext`y$[$CellContext`i$])/(
           2 (1 - $CellContext`y$[$CellContext`i$]^2))]; $CellContext`d$[
           ...
           If[
            ...
            And[$CellContext`j$ != $CellContext`k$, $CellContext`k$ != 
             0, $CellContext`k$ != $CellContext`Np$, $CellContext`j$ != 
             0, $CellContext`j$ != $CellContext`Np$], (-1)^($CellContext`j$ + \
$CellContext`k$)/($CellContext`y$[$CellContext`j$] - \
$CellContext`y$[$CellContext`k$])]]; $CellContext`d$[$CellContext`Np$, 
           0] = ((-1)/2) (-1)^$CellContext`Np$; $CellContext`d$[
          0, $CellContext`Np$] = (1/2) (-1)^$CellContext`Np$; $CellContext`d$[
           Pattern[$CellContext`j$, 
            Blank[]], 0] := If[
           
           And[$CellContext`j$ != $CellContext`Np$, $CellContext`j$ != 
            0], ((-1)/2) ((-1)^$CellContext`j$/(
            1 - $CellContext`y$[$CellContext`j$]))]; $CellContext`d$[
           Pattern[$CellContext`j$, 
            Blank[]], $CellContext`Np$] := If[
           
           And[$CellContext`j$ != $CellContext`Np$, $CellContext`j$ != 0], (1/
            2) ((-1)^($CellContext`j$ + $CellContext`Np$)/(
            1 + $CellContext`y$[$CellContext`j$]))]; $CellContext`d$[0, 
           Pattern[$CellContext`j$, 
            Blank[]]] := If[
           And[$CellContext`j$ != $CellContext`Np$, $CellContext`j$ != 0], 
           2 ((-1)^$CellContext`j$/(
            1 - $CellContext`y$[$CellContext`j$]))]; \
$CellContext`d$[$CellContext`Np$, 
           Pattern[$CellContext`j$, 
            Blank[]]] := If[
           
           And[$CellContext`j$ != $CellContext`Np$, $CellContext`j$ != 
            0], (-2) ((-1)^($CellContext`j$ + $CellContext`Np$)/(
            1 + $CellContext`y$[$CellContext`j$]))]; $CellContext`Add$ = Table[
           N[
            $CellContext`d$[$CellContext`i, $CellContext`j]], {$CellContext`i,
             0, $CellContext`Np$}, {$CellContext`j, 
            0, $CellContext`Np$}]; $CellContext`Bdd$ = 
         Dot[$CellContext`Add$, $CellContext`Add$]; $CellContext`sol1$ = 
         Solve[{$CellContext`T[1][$CellContext`t$] == 
            0, $CellContext`T[$CellContext`Np$ + 1][$CellContext`t$] == 0}, {
            $CellContext`T[1][$CellContext`t$], 
            $CellContext`T[$CellContext`Np$ + 
             1][$CellContext`t$]}]; $CellContext`sys1$ = Table[
           $CellContext`eq$[$CellContext`i], {$CellContext`i, 
            2, $CellContext`Np$}]; $CellContext`init$ = Join[
           
           Table[{$CellContext`T[$CellContext`i][0] == 
             If[($CellContext`L/2) ($CellContext`y$[$CellContext`i - 1] + 1) <= 
               1/2, (2 ($CellContext`L/
                 2)) ($CellContext`y$[$CellContext`i - 1] + 1), 
               2 (
                1 - ($CellContext`L/2) ($CellContext`y$[$CellContext`i - 1] + 
                 1))]}, {$CellContext`i, 
             2, $CellContext`Np$}]]; $CellContext`al$ = Flatten[
           NDSolve[
            Flatten[{
              
              ReplaceAll[$CellContext`sys1$, $CellContext`sol1$], \
$CellContext`init$}], 
            Table[
             $CellContext`T[$CellContext`i], {$CellContext`i, 
              2, $CellContext`Np$}], {$CellContext`t$, 0, 
             4}]]; $CellContext`tbl$ = 
         Table[{($CellContext`L/2) ($CellContext`y$[$CellContext`i - 1] + 1), 
            First[
             ReplaceAll[
              ReplaceAll[
               ReplaceAll[
                $CellContext`T[$CellContext`i][$CellContext`t$], \
$CellContext`sol1$], $CellContext`al$], $CellContext`t$ -> \
$CellContext`ta$$]]}, {$CellContext`i, $CellContext`Np$ + 1, 1, -1}]; Show[
          Plot[
           $CellContext`Tanal[$CellContext`x, $CellContext`ta$$], \
{$CellContext`x, 0, 1}, Frame -> True, GridLines -> Automatic, 
           PlotStyle -> {Blue, Thick}, AspectRatio -> 1, ImageSize -> 
           400 {1, 1}, PlotRange -> {{0, $CellContext`L}, {-0.1, 1.1}}, 
           FrameLabel -> {
             Style["x", Italic, 16], 
             Style["T", 16, Italic]}], 
          
          ListPlot[$CellContext`tbl$, PlotMarkers -> 
           Style["\[FilledCircle]", 14, Red], PlotStyle -> Thick, Frame -> 
           True, FrameLabel -> {
             Style["x", Italic, 16], 
             Style["c", 16, Italic]}, GridLines -> Automatic, ImageSize -> 
           400 {1, 1}, AspectRatio -> 1, 
           PlotRange -> {{0, $CellContext`L}, {-0.1, 1.1}}]]], 
      "Specifications" :> {{{$CellContext`Npp$$, 20, "collocation points"}, 
         15, 35, 1, Appearance -> "Labeled"}, {{$CellContext`ta$$, 0.05, 
          Style["t", Italic]}, 0.001, 0.2, 0.001, Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`Npp$$, $CellContext`ta$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{447., {256., 261.}},
...
Cell["\<\
Consider the problem of unsteady-state heat conduction in a rod, as governed \
...
Cell["The initial and boundary conditions are:", "ManipulateCaption",
 CellID->289339435],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"1", "/", "2"}], "\[LessEqual]", "x", "\[LessEqual]", "1"}], 
...
Cell["\<\
This problem has an analytical solution in the form of a Fourier series after \
      ...
      RowBox[{
       ...
       SuperscriptBox["e", 
        RowBox[{
         RowBox[{"-", 
          SuperscriptBox["n", "2"]}], 
         SuperscriptBox["\[Pi]", "2"], "t"}]]}]}]}]}], TraditionalForm]], 
  "InlineMath"],
 ". "
}], "ManipulateCaption",
 CellID->176778633],
...
Cell[TextData[{
 ...
 ". The numerical solution obtained using Chebyshev orthogonal collocation is \
given by the red dots. The analytical solution is given by the blue curve. \
Excellent agreement between the two solutions is observed. You can vary the \
value of ",
 Cell[BoxData[
  FormBox["t", TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 "In the discrete Chebyshev\[Dash]Gauss\[Dash]Lobatto case, the interior \
points are given by ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"cos", "(", 
     RowBox[{"j", " ", 
      RowBox[{"\[Pi]", "/", "N"}]}], ")"}]}], TraditionalForm]], "InlineMath"],
 ". These points are the extrema of the Chebyshev polynomials of the first \
kind, ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["T", "N"], "(", "x", ")"}], TraditionalForm]], "InlineMath"],
 ". "
}], "DetailNotes",
 CellID->332833849],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{"(", 
     RowBox[{"N", "+", "1"}], ")"}]}], TraditionalForm]], "InlineMath"],
 " Chebyshev derivative matrix at ",
 "the quadrature points is an ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"(", 
  ...
  FormBox[
   RowBox[{"D", "=", 
    SubscriptBox[
     ...
     RowBox[{
      RowBox[{"0", "\[LessEqual]", "j"}], ",", 
      RowBox[{"k", "\[LessSlantEqual]", "N"}]}]]}], TraditionalForm]], 
  "InlineMath"],
 " given",
 " by"
}], "DetailNotes",
...
Cell[TextData[{
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["d", 
     RowBox[{"0", "\[InvisibleComma]", "\[InvisibleComma]", "0"}]], "=", 
    FractionBox[
     RowBox[{
      RowBox[{"2", " ", 
       SuperscriptBox["N", "2"]}], "+", "1"}], "6"]}], TraditionalForm]], 
  "InlineMath"],
 ", ",
 Cell[BoxData[
  FormBox[
   ...
   RowBox[{
    ...
    FractionBox[
     ...
     RowBox[{"2", " ", 
      RowBox[{"(", 
       RowBox[{"1", "-", 
        SubsuperscriptBox["y", "j", "2"]}], ")"}]}]]}], TraditionalForm]], 
  "InlineMath"],
 " for ",
 Cell[BoxData[
  FormBox[
   ...
   RowBox[{
    ...
    FractionBox[
     ...
     RowBox[{
      ...
      RowBox[{
       SubscriptBox["y", "j"], "-", 
       SubscriptBox["y", "k"]}], ")"}]]}], TraditionalForm]], "InlineMath"],
 " for ",
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "\[LessEqual]", "j"}], TraditionalForm]], "InlineMath"],
 ", ",
 Cell[BoxData[
  FormBox[
   RowBox[{"k", "\[LessSlantEqual]", "N"}], TraditionalForm]], "InlineMath"],
 ", and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"j", "\[NotEqual]", "k"}], TraditionalForm]], "InlineMath"],
 ","
}], "DetailNotes",
 Deletable->True,
 CellID->279341973],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["c", "0"], "=", 
    RowBox[{
     SubscriptBox["c", "N"], "=", "2"}]}], TraditionalForm]], "InlineMath"],
 "."
}], "DetailNotes",
 CellID->118265597],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"v", "'"}], "=", 
    RowBox[{"D", " ", "v"}]}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"v", "''"}], "=", 
    RowBox[{
     SuperscriptBox["D", "2"], " ", "v"}]}], TraditionalForm]], "InlineMath"],
 ", where ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"u", "'"}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"u", "''"}], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 "[1] P. Moin, ",
 StyleBox["Fundamentals of Engineering Numerical Analysis",
  FontSlant->"Italic"],
...
Cell[TextData[{
 "[2] L. N. Trefethen, ",
 StyleBox["Spectral Methods in MATLAB",
  FontSlant->"Italic"],
...
Cell[TextData[{
 "[3] J. Crank, ",
 StyleBox["The Mathematics of Diffusion",
  FontSlant->"Italic"],
 ", 2nd ed., New York: Oxford University Press, 1975."
}], "DetailNotes",
 CellID->712310815],
...
HeatConductionInARod&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/HeatConductionInARod/\
HeatConductionInARod-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Heat Conduction in a Rod",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HeatConductionInARod/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/HeatConductionInARod/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/HeatConductionInARod/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HeatConductionInARod/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/HeatConductionInARod/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[48784, 943, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[49045, 952, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[65845, 1428, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 92523, 1997},
 {"Copyright", 92718, 2002}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1501, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35832, 603, 45, 0, 70, "DemoTitle"],
Cell[35880, 605, 8674, 175, 70, "Output",
 CellID->661100010],
Cell[44557, 782, 157, 4, 70, "ManipulateCaption",
 CellID->339110301],
Cell[44717, 788, 447, 14, 70, "ManipulateCaption",
 CellID->113026716],
Cell[45167, 804, 89, 1, 70, "ManipulateCaption",
 CellID->289339435],
Cell[45259, 807, 870, 33, 70, "ManipulateCaption",
 CellID->627033892],
Cell[46132, 842, 307, 13, 70, "ManipulateCaption",
 CellID->469773461],
Cell[46442, 857, 329, 14, 70, "ManipulateCaption",
 CellID->610925473],
Cell[46774, 873, 329, 12, 70, "ManipulateCaption",
 CellID->226192673],
Cell[47106, 887, 161, 4, 70, "ManipulateCaption",
 CellID->723761385],
Cell[47270, 893, 822, 28, 70, "ManipulateCaption",
 CellID->176778633],
Cell[48095, 923, 686, 18, 70, "ManipulateCaption",
 CellID->626555126],
Cell[48784, 943, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49045, 952, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[53488, 1050, 33, 0, 70, "DetailsSection"],
Cell[53524, 1052, 562, 18, 70, "DetailNotes",
 CellID->332833849],
Cell[54089, 1072, 876, 33, 70, "DetailNotes",
 CellID->323751966],
Cell[54968, 1107, 1976, 75, 70, "DetailNotes",
 CellID->279341973],
Cell[56947, 1184, 509, 20, 70, "DetailNotes",
 CellID->118265597],
Cell[57459, 1206, 1391, 55, 70, "DetailNotes",
 CellID->153198705],
Cell[58853, 1263, 53, 1, 70, "DetailNotes",
 CellID->146024351],
Cell[58909, 1266, 210, 6, 70, "DetailNotes",
 CellID->208501972],
Cell[59122, 1274, 175, 6, 70, "DetailNotes",
 CellID->242731759],
Cell[59300, 1282, 194, 6, 70, "DetailNotes",
 CellID->712310815],
Cell[59497, 1290, 4799, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[64299, 1381, 45, 0, 70, "CitationSection"],
Cell[64347, 1383, 596, 18, 70, "Author"],
Cell[64946, 1403, 896, 23, 70, "Citations"],
Cell[65845, 1428, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature 1TEMPwhBz05LEv7H0Rb3IWeX *)
