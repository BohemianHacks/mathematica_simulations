...
NotebookDataLength[     84606,       1677]
NotebookOptionsPosition[     58074,       1119]
NotebookOutlinePosition[     84119,       1672]
CellTagsIndexPosition[     84046,       1667]
...
Cell["\<\
A pitot tube determines the velocity of a fluid by measuring the fluid\
\[CloseCurlyQuote]s stagnation pressure. In this demonstration, stagnation \
pressure is measured with a manometer. The height differential in the \
manometer is a function of the manometer fluid density, and the flowing fluid\
\[CloseCurlyQuote]s kinetic energy. Bernoulli\[CloseCurlyQuote]s equation \
relates these terms, and is used to solve for velocity. Vary the manometer \
fluid (green) height or the velocity of the fluid in the pipe (blue) to see \
how each variable is related. Also, use a slider to vary the density of the \
...
CellGrouping->Manual,
WindowSize->{1210, 980},
WindowMargins->{{173, Automatic}, {60, Automatic}},
WindowElements->{
...
CellTagsIndex->{
 "Copyright"->{
  Cell[57013, 1089, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 83899, 1661}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[36199, 611, 10315, 210, 534, "Input",ExpressionUUID->"6f2916ec-4147-44b1-b0ce-81232036e730",
 CellID->377157575],
Cell[46517, 823, 916, 14, 85, "ManipulateCaption",ExpressionUUID->"abd28a3c-1615-46f9-88d1-0712bde5d8d9",
 CellID->957328473],
Cell[47436, 839, 88, 0, 58, "DetailsSection",ExpressionUUID->"cd92d376-b5a9-4e2f-afa7-e392be73c809"],
Cell[47527, 841, 7258, 191, 494, "DetailNotes",ExpressionUUID->"bd335143-b24f-497b-9c57-915908f76af2",
 CellID->1902107128],
Cell[54788, 1034, 99, 0, 58, "RelatedLinksSection",ExpressionUUID->"7ed26fdc-4f36-45a8-85c5-2377935f7490"],
Cell[54890, 1036, 428, 9, 24, "RelatedLinks",ExpressionUUID->"7671614a-b279-4277-b8d0-64e18f7b7dea"],
Cell[55321, 1047, 100, 0, 44, "CitationSection",ExpressionUUID->"6c8e8459-14f4-47ec-a506-661e64c7e8eb"],
Cell[55424, 1049, 912, 22, 22, "Author",ExpressionUUID->"b63006c3-5184-4e90-8f6d-2840e861b681",
 CellID->65537507],
Cell[56339, 1073, 236, 4, 22, "Author",ExpressionUUID->"947e33b8-71ff-4239-a6c5-0f9b6b2edfd2",
 CellID->369809184],
Cell[56578, 1079, 432, 8, 22, "Author",ExpressionUUID->"f18ae0d2-5efe-4d32-a2f2-ab2a498493d2",
 CellID->140468302],
Cell[57013, 1089, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
 CellTags->"Copyright"],
Cell[57889, 1114, 181, 3, 25, "Input",ExpressionUUID->"9fa92ac2-225b-4c13-b460-8e5bbed2aedc"]
}
]
*)
...
(* NotebookSignature 5wTTVQ@vZA55yB1vH24hhg@N *)
