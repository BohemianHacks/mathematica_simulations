...
NotebookDataLength[     83192,       1724]
NotebookOptionsPosition[     56286,       1137]
NotebookOutlinePosition[     82542,       1698]
CellTagsIndexPosition[     82431,       1692]
WindowTitle->Double-Sided Couette Flow 
WindowFrame->Normal*)
...
Cell["Double-Sided Couette Flow ", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`c$$ = 
    0.05, $CellContext`u1$$ = -1, $CellContext`u2$$ = 1, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`u2$$], 1, 
       Row[{"upper plate velocity ", 
         Text[
          Style[
           Subscript["u", 2], Italic]]}]}, -1, 1, 0.1}, {{
       Hold[$CellContext`u1$$], -1, 
       Row[{"lower plate velocity ", 
         Text[
          Style[
           Subscript["u", 1], Italic]]}]}, -1, 1, 0.1}, {{
       Hold[$CellContext`c$$], 0.05, 
       Row[{"pressure gradient ", 
         Text[
          Row[{
            Style["d\[InvisibleSpace]", Italic], 
            Style["p", Italic], "/", 
            Style["d\[InvisibleSpace]", Italic], 
            Style["x", Italic]}]]}]}, -0.3, 0.3, 0.01}}, Typeset`size$$ = {
    500., {198., 202.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`u2$48087$$ = 
    0, $CellContext`u1$48088$$ = 0, $CellContext`c$48089$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`c$$ = 
        0.05, $CellContext`u1$$ = -1, $CellContext`u2$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`u2$$, $CellContext`u2$48087$$, 0], 
        Hold[$CellContext`u1$$, $CellContext`u1$48088$$, 0], 
        Hold[$CellContext`c$$, $CellContext`c$48089$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`Ux$, $CellContext`plt$, $CellContext`\[Mu]$, \
$CellContext`h$}, $CellContext`\[Mu]$ = 1 10^(-3); $CellContext`h$ = 
         0.1; $CellContext`Ux$[
           Pattern[$CellContext`y$, 
            Blank[]]] := (($CellContext`y$^2 - $CellContext`h$^2)/(
            2 $CellContext`\[Mu]$)) $CellContext`c$$ + (($CellContext`u2$$ - \
$CellContext`u1$$)/2) ($CellContext`y$/$CellContext`h$ + 
            1) + $CellContext`u1$$; $CellContext`plt$ = ListPlot[
           Table[{
             $CellContext`Ux$[$CellContext`y], $CellContext`y}, \
{$CellContext`y, -$CellContext`h$, $CellContext`h$, 0.001}], 
           AxesOrigin -> {0, 0}, 
           PlotRange -> {{-2.6, 
             2.6}, {-$CellContext`h$ - 0.02, $CellContext`h$ + 0.02}}, Joined -> 
           True, PlotStyle -> {Thick, 
             RGBColor[0.25, 0.43, 0.82]}, ImageSize -> {500, 400}, AxesLabel -> {
             Style["x", Italic], 
             Style["y", Italic]}]; Show[{$CellContext`plt$, 
           Graphics[
            Table[{
              ...
              Arrow[{{0, (
                   2 ($CellContext`h$/12)) $CellContext`y - $CellContext`h$}, {
                 $CellContext`Ux$[(
                    2 ($CellContext`h$/
                    12)) $CellContext`y - $CellContext`h$], (
                   2 ($CellContext`h$/
                    12)) $CellContext`y - $CellContext`h$}}]}, \
{$CellContext`y, 0, 12}]], 
           Graphics[{
             ...
             Text[
              Style[
               Row[{
                 ...
                 Subscript[
                  Style["U", Italic], 2]}], 
               RGBColor[0.25, 0.43, 0.82], 18], {
              1.8, $CellContext`h$ + 0.015}]}], 
           Graphics[{
             Thickness[0.025], 
             RGBColor[0, 0, 1], 
             Text[
           ...
           Graphics[{
             Thickness[0.001], 
             RGBColor[0.5, 0.5, 0.5]}]}]], 
      "Specifications" :> {{{$CellContext`u2$$, 1, 
          Row[{"upper plate velocity ", 
            Text[
             Style[
              Subscript["u", 2], Italic]]}]}, -1, 1, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`u1$$, -1, 
          Row[{"lower plate velocity ", 
            Text[
             Style[
              Subscript["u", 1], Italic]]}]}, -1, 1, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`c$$, 0.05, 
          Row[{"pressure gradient ", 
            Text[
             Row[{
               Style["d\[InvisibleSpace]", Italic], 
               Style["p", Italic], "/", 
               Style["d\[InvisibleSpace]", Italic], 
               Style["x", Italic]}]]}]}, -0.3, 0.3, 0.01, Appearance -> 
         "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {269., 274.}},
...
Cell[TextData[{
 "The permanent laminar flow of an incompressible viscous fluid in the space \
between two parallel plates can be described by a linear ODE for ",
 Cell[BoxData[
  FormBox[
   RowBox[{"u", "(", "y", ")"}], TraditionalForm]], "InlineMath"],
 ": ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    FractionBox[
     RowBox[{
      SuperscriptBox[
       RowBox[{"d", "\[InvisibleSpace]"}], "2"], "\[InvisibleSpace]", "u"}], 
...
Cell["The boundary conditions are:", "ManipulateCaption",
 CellID->103754593],
...
Cell["This problem has an analytic solution:", "ManipulateCaption",
 CellID->787855823],
...
Cell["\<\
that varies as a function of the pressure gradient and the upper and lower \
plate velocity.\
\>", "ManipulateCaption",
 CellID->157243768],
...
Cell[TextData[{
 ButtonBox["Couette Flow ",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CouetteFlow/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CouetteFlow/"],
 " (",
...
Cell[TextData[{
 ButtonBox["Couette Flow",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/CouetteFlow.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/CouetteFlow.html"],
 " (",
...
Cell[TextData[{
 ButtonBox["Laminar Flow",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/LaminarFlow.html"], None},
  ButtonNote->"http://scienceworld.wolfram.com/physics/LaminarFlow.html"],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
DoubleSidedCouetteFlow&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/\
DoubleSidedCouetteFlow-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Double-Sided Couette Flow ",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/DoubleSidedCouetteFlow/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["David Gerhardinger",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=David+\
Gerhardinger"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=David+Gerhardinger"]
}], "Author",
 FontColor->GrayLevel[0.6],
 CellID->191363511],

Cell[TextData[{
 StyleBox["Based on a program by:", "Item"],
 " ",
 ButtonBox["William C. Guttner",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=William+C.+\
Guttner"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=William+C.+Guttner"]
}], "Author",
 FontColor->GrayLevel[0.6],
 CellID->168197926],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44068, 838, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44329, 847, 3221, 69, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55464, 1112, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82144, 1681},
 {"Copyright", 82339, 1686}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1275, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35606, 600, 47, 0, 70, "DemoTitle"],
Cell[35656, 602, 5697, 136, 70, "Output",
 CellID->353936584],
Cell[41356, 740, 1115, 34, 70, "ManipulateCaption",
 CellID->748653765],
Cell[42474, 776, 77, 1, 70, "ManipulateCaption",
 CellID->103754593],
Cell[42554, 779, 250, 9, 70, "ManipulateCaption",
 CellID->71101105],
Cell[42807, 790, 230, 8, 70, "ManipulateCaption",
 CellID->713610245],
Cell[43040, 800, 87, 1, 70, "ManipulateCaption",
 CellID->787855823],
Cell[43130, 803, 783, 27, 70, "ManipulateCaption",
 CellID->262492793],
Cell[43916, 832, 149, 4, 70, "ManipulateCaption",
 CellID->157243768],
Cell[44068, 838, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44329, 847, 3221, 69, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47553, 918, 44, 0, 70, "RelatedLinksSection"],
Cell[47600, 920, 461, 14, 70, "RelatedLinks",
 CellID->621349547],
Cell[48064, 936, 491, 15, 70, "RelatedLinks",
 CellID->813315926],
Cell[48558, 953, 491, 15, 70, "RelatedLinks",
 CellID->361808737],
Cell[49052, 970, 4805, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53860, 1061, 45, 0, 70, "CitationSection"],
Cell[53908, 1063, 799, 20, 70, "Citations"],
Cell[54710, 1085, 359, 11, 70, "Author",
 CellID->191363511],
Cell[55072, 1098, 389, 12, 70, "Author",
 CellID->168197926],
Cell[55464, 1112, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature RRaaCt6NvgNG#vQhlALGcXJQ *)
