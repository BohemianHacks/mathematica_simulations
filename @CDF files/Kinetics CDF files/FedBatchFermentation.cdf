...
NotebookDataLength[     84528,       1736]
NotebookOptionsPosition[     57043,       1143]
NotebookOutlinePosition[     83293,       1704]
CellTagsIndexPosition[     83182,       1698]
WindowTitle->Fed-Batch Fermentation
WindowFrame->Normal*)
...
Cell["Fed-Batch Fermentation", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`ctrl$$ = 1, $CellContext`F0$$ = 
    5, $CellContext`S0$$ = 10, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`S0$$], 10, "feed substrate concentration"}, 0.1, 20, 
      0.1}, {{
       Hold[$CellContext`F0$$], 5, "inlet flow rate at t=20 hr"}, 0.1, 10, 
      0.1}, {{
       Hold[$CellContext`ctrl$$], 1, ""}, {
      1 -> "biomass", 2 -> "nutrient", 3 -> "product", 4 -> "volume"}}}, 
    Typeset`size$$ = {500., {148., 152.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`S0$1491937$$ = 0, $CellContext`F0$1491938$$ = 
    0, $CellContext`ctrl$1491939$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`ctrl$$ = 1, $CellContext`F0$$ = 
        5, $CellContext`S0$$ = 10}, "ControllerVariables" :> {
        Hold[$CellContext`S0$$, $CellContext`S0$1491937$$, 0], 
        Hold[$CellContext`F0$$, $CellContext`F0$1491938$$, 0], 
        Hold[$CellContext`ctrl$$, $CellContext`ctrl$1491939$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`sol$, $CellContext`Ks$, $CellContext`k1$, \
$CellContext`k2$, $CellContext`YieldCoef$, $CellContext`UM$}, $CellContext`F[
           Pattern[$CellContext`t$, 
            Blank[]]] := 
         If[$CellContext`t$ < 20, 0, $CellContext`F0$$]; $CellContext`k1$ = 
         0.03; $CellContext`k2$ = 0.08; $CellContext`YieldCoef$ = 
         0.8; $CellContext`UM$ = 0.3; $CellContext`Ks$ = 
         0.1; $CellContext`sol$ = NDSolve[{D[
              $CellContext`V[$CellContext`t], {$CellContext`t, 
               1}] == $CellContext`F[$CellContext`t], 
            D[$CellContext`V[$CellContext`t] $CellContext`X[$CellContext`t], \
{$CellContext`t, 
               1}] == (($CellContext`UM$ $CellContext`S[$CellContext`t]) \
($CellContext`X[$CellContext`t]/($CellContext`Ks$ + \
$CellContext`S[$CellContext`t]))) $CellContext`V[$CellContext`t], 
            D[$CellContext`V[$CellContext`t] $CellContext`S[$CellContext`t], \
{$CellContext`t, 
               1}] == $CellContext`F[$CellContext`t] $CellContext`S0$$ - \
(($CellContext`UM$ $CellContext`S[$CellContext`t]) \
($CellContext`X[$CellContext`t]/($CellContext`Ks$ + \
$CellContext`S[$CellContext`t]))) \
($CellContext`V[$CellContext`t]/$CellContext`YieldCoef$), 
            D[$CellContext`V[$CellContext`t] $CellContext`P[$CellContext`t], \
{$CellContext`t, 
               1}] == (($CellContext`k1$ + ($CellContext`k2$ \
$CellContext`UM$) ($CellContext`S[$CellContext`t]/($CellContext`Ks$ + \
$CellContext`S[$CellContext`t]))) $CellContext`X[$CellContext`t]) \
$CellContext`V[$CellContext`t], $CellContext`X[0] == 0.01, $CellContext`S[0] == 
            10, $CellContext`P[0] == 0, $CellContext`V[0] == 1}, {
            $CellContext`V[$CellContext`t], 
            $CellContext`S[$CellContext`t], 
            $CellContext`P[$CellContext`t], 
            $CellContext`X[$CellContext`t]}, {$CellContext`t, 0, 100}]; 
        Switch[$CellContext`ctrl$$, 1, 
          Plot[
           ReplaceAll[
            $CellContext`X[$CellContext`t], $CellContext`sol$], \
{$CellContext`t, 0, 100}, Frame -> True, FrameLabel -> {"time", "biomass"}, 
           PlotRange -> All, PlotStyle -> {
             RGBColor[0.4, 0.53, 0.66], Thick}, ImageSize -> {500, 300}, 
           ImagePadding -> {{35, 10}, {35, 10}}], 2, 
          Plot[
           ReplaceAll[
            $CellContext`S[$CellContext`t], $CellContext`sol$], \
{$CellContext`t, 0, 100}, PlotRange -> All, Frame -> True, 
           FrameLabel -> {"time", "substrate"}, PlotStyle -> {
             RGBColor[0.48, 0, 0], Thick}, ImageSize -> {500, 300}, 
           ImagePadding -> {{35, 10}, {35, 10}}], 3, 
          Plot[
           ReplaceAll[
            $CellContext`P[$CellContext`t], $CellContext`sol$], \
{$CellContext`t, 0, 100}, PlotRange -> All, Frame -> True, 
           FrameLabel -> {"time", "product"}, PlotStyle -> Thick, 
           ImageSize -> {500, 300}, ImagePadding -> {{35, 10}, {35, 10}}], 4, 
          Plot[
           ReplaceAll[
            $CellContext`V[$CellContext`t], $CellContext`sol$], \
{$CellContext`t, 0, 100}, PlotRange -> All, Frame -> True, 
           FrameLabel -> {"time", "volume"}, PlotStyle -> {
             RGBColor[0.48, 0.11, 0.56], Thick}, ImageSize -> {500, 300}, 
           ImagePadding -> {{35, 10}, {35, 10}}]]], 
      "Specifications" :> {{{$CellContext`S0$$, 10, 
          "feed substrate concentration"}, 0.1, 20, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`F0$$, 5, "inlet flow rate at t=20 hr"}, 
         0.1, 10, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`ctrl$$, 1, ""}, {
         1 -> "biomass", 2 -> "nutrient", 3 -> "product", 4 -> "volume"}}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`S0$$, $CellContext`F0$$, \
$CellContext`ctrl$$}, SynchronousUpdating -> False, ControlPlacement -> Top}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {218., 223.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"t", "=", "20"}], TraditionalForm]], "InlineMath"],
 " hr with a sterile substrate. In the absence of outlet flow, the volume in \
the batch-fed fermentor will increase linearly. This Demonstration shows the \
time-dependent behavior of four functions: the biomass concentration, the \
substrate concentration, the product concentration, and the volume in the \
reactor. "
}], "ManipulateCaption"],

Cell["This batch operation obeys the following equations:", \
"ManipulateCaption",
 CellID->415281133],
...
Cell[TextData[{
  ...
  FormBox[
   RowBox[{
    FractionBox[
     ...
     RowBox[{"d", "\[InvisibleSpace]", "t"}]], "=", "F"}], TraditionalForm]], 
  "InlineMath"],
 " with ",
 Cell[BoxData[
  FormBox[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"t", "<", " ", 
    RowBox[{"20", " ", "hr"}]}], TraditionalForm]], "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->49403525],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    RowBox[{
     SubscriptBox["r", "X"], " ", "V"}]}], TraditionalForm]], "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->3830629],
   ...
   RowBox[{
    ...
    RowBox[{
     RowBox[{"F", " ", 
      SubscriptBox["S", "in"]}], "+", 
     RowBox[{
      SubscriptBox["r", "S"], " ", "V"}]}]}], TraditionalForm]], "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->100314725],
  ...
  FormBox[
   RowBox[{
    FractionBox[
     ...
     RowBox[{"d", "\[InvisibleSpace]", "t"}]], "=", 
    RowBox[{
     SubscriptBox["r", "P"], " ", "V"}]}], TraditionalForm]], "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->6136631],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    FractionBox[
     RowBox[{
      SubscriptBox["\[Mu]", "max"], "S", " ", "X", " "}], 
     RowBox[{
      SubscriptBox["K", "s"], "+", "S"}]]}], TraditionalForm]], "InlineMath"],
 ", ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    ...
    FractionBox[
     RowBox[{"-", 
      SubscriptBox["r", "X"]}], "Y"]}], TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["S", "in"], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["K", "s"], TraditionalForm]], "InlineMath"],
   ...
   RowBox[{"Y", "=", 
    RowBox[{"-", 
     FractionBox[
      ...
      RowBox[{"d", "\[InvisibleSpace]", "S"}]]}]}], TraditionalForm]], 
  "InlineMath"],
...
Cell["\<\
The biomass concentration becomes constant and the product concentration and \
volume increase linearly because they depend linearly on the biomass and the \
inlet flow rate, respectively. The total biomass increases linearly versus \
time. This behavior corresponds to a situation where the growth rate of \
biomass is limited by the feeding rate.\
\>", "ManipulateCaption",
 CellID->684838519],
...
Cell[TextData[{
 ...
 StyleBox["Biological Reaction Engineering: Dynamic Modelling Fundamentals \
with Simulation Examples",
  FontSlant->"Italic"],
 ", 2nd ed., Weinheim: Wiley-VCH, 2003."
}], "DetailNotes",
 CellID->135513390],
...
FedBatchFermentation&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/FedBatchFermentation/\
FedBatchFermentation-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Fed-Batch Fermentation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/FedBatchFermentation/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/FedBatchFermentation/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/FedBatchFermentation/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/FedBatchFermentation/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/FedBatchFermentation/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45893, 887, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[46154, 896, 3774, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56221, 1118, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82895, 1687},
 {"Copyright", 83090, 1692}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[586, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34917, 590, 43, 0, 70, "DemoTitle"],
Cell[34963, 592, 5835, 111, 70, "Output",
 CellID->81585298],
Cell[40801, 705, 477, 10, 70, "ManipulateCaption"],
Cell[41281, 717, 102, 2, 70, "ManipulateCaption",
 CellID->415281133],
Cell[41386, 721, 490, 19, 70, "ManipulateCaption",
 CellID->49403525],
Cell[41879, 742, 345, 12, 70, "ManipulateCaption",
 CellID->3830629],
Cell[42227, 756, 427, 15, 70, "ManipulateCaption",
 CellID->100314725],
Cell[42657, 773, 345, 12, 70, "ManipulateCaption",
 CellID->6136631],
Cell[43005, 787, 998, 40, 70, "ManipulateCaption",
 CellID->138491057],
Cell[44006, 829, 1476, 47, 70, "ManipulateCaption",
 CellID->152149455],
Cell[45485, 878, 405, 7, 70, "ManipulateCaption",
 CellID->684838519],
Cell[45893, 887, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46154, 896, 3774, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49931, 980, 33, 0, 70, "DetailsSection"],
Cell[49967, 982, 283, 7, 70, "DetailNotes",
 CellID->135513390],
Cell[50253, 991, 4799, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55055, 1082, 45, 0, 70, "CitationSection"],
Cell[55103, 1084, 785, 20, 70, "Citations"],
Cell[55891, 1106, 327, 10, 70, "Author"],
Cell[56221, 1118, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature nTaUegST1ek8wu7pDeNHwYFp *)
