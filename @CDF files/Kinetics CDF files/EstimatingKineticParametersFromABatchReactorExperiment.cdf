...
NotebookDataLength[     82817,       1657]
NotebookOptionsPosition[     56613,       1088]
NotebookOutlinePosition[     82904,       1649]
CellTagsIndexPosition[     82793,       1643]
WindowTitle->Estimating Kinetic Parameters from a Batch Reactor Experiment
WindowFrame->Normal*)
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 1, $CellContext`n$$ = 
    1.5, $CellContext`noise$$ = 0.05, $CellContext`seed$$ = 1, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[
       Style["theoretical", Bold, 10]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`n$$], 1.5, "reaction order n"}, 1., 2.5, 0.01}, {{
       Hold[$CellContext`k$$], 1, "rate constant k"}, 1., 5., 0.01}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {
      Hold[""], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`seed$$], 1, "seed"}, 1, 1000, 1}, {{
       Hold[$CellContext`noise$$], 0.05, "noise amplitude"}, 0.01, 0.2, 
      0.01}}, Typeset`size$$ = {402., {199., 203.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`n$51276$$ = 0, $CellContext`k$51277$$ = 
    0, $CellContext`seed$51278$$ = 0, $CellContext`noise$51279$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 1, $CellContext`n$$ = 
        1.5, $CellContext`noise$$ = 0.05, $CellContext`seed$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$51276$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$51277$$, 0], 
        Hold[$CellContext`seed$$, $CellContext`seed$51278$$, 0], 
        Hold[$CellContext`noise$$, $CellContext`noise$51279$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`sol$, $CellContext`noisydata$, $CellContext`p2$, \
$CellContext`pfun$, $CellContext`fit$, $CellContext`p3$, $CellContext`y$, \
$CellContext`k1$, $CellContext`n1$}, $CellContext`sol$ = 
         NDSolve[{
           Derivative[
             1][$CellContext`c][$CellContext`t] == (-$CellContext`k$$) \
$CellContext`c[$CellContext`t]^$CellContext`n$$, $CellContext`c[0] == 
            1}, $CellContext`c, {$CellContext`t, 0, 10}]; 
        SeedRandom[$CellContext`seed$$]; $CellContext`noisydata$ = 
         Table[{$CellContext`i, 
            Max[0, 
             First[
              ReplaceAll[
               
               ReplaceAll[$CellContext`noise$$ ((2 Random[] - 1)/
                  2) + $CellContext`c[$CellContext`t], $CellContext`sol$], \
$CellContext`t -> $CellContext`i]]]}, {$CellContext`i, 0, 4, 
            0.05}]; $CellContext`p2$ = 
         ListPlot[$CellContext`noisydata$, Joined -> False, PlotMarkers -> 
           Style["\[FilledCircle]", Blue, 12], PlotRange -> All, Frame -> 
           True, GridLines -> Automatic, AspectRatio -> 
           1]; $CellContext`pfun$ = ReplaceAll[$CellContext`y$, 
           
           ParametricNDSolve[{
            Derivative[
              1][$CellContext`y$][$CellContext`t] == (-$CellContext`k1$) \
$CellContext`y$[$CellContext`t]^$CellContext`n1$, $CellContext`y$[0] == 
             1}, $CellContext`y$, {$CellContext`t, 0, 
             10}, {$CellContext`k1$, $CellContext`n1$}, MaxSteps -> Infinity, 
            Method -> "StiffnessSwitching"]]; $CellContext`fit$ = 
         FindFit[$CellContext`noisydata$, 
           $CellContext`pfun$[$CellContext`k1$, \
$CellContext`n1$][$CellContext`t], {{$CellContext`k1$, 1., 
             2.}, {$CellContext`n1$, 1.5, 
             2.}}, $CellContext`t]; $CellContext`p3$ = Plot[
           ReplaceAll[
            $CellContext`pfun$[$CellContext`k1$, \
$CellContext`n1$][$CellContext`t], $CellContext`fit$], {$CellContext`t, 0, 4},
            PlotRange -> All, Frame -> True, GridLines -> Automatic, 
           AspectRatio -> 1, PlotStyle -> {Thick, Red}]; 
        Show[$CellContext`p2$, $CellContext`p3$, 
          PlotRange -> {{0, 4}, {0, 1}}, ImageSize -> (1.15 350) {1, 1}, 
          FrameLabel -> {
            Style["time", 12], 
            Style["concentration", 12]}, PlotLabel -> Row[{
             Style[
              Column[{"experimental reaction order", 
                NumberForm[
                 ReplaceAll[
                  Chop[
                   N[$CellContext`n1$]], $CellContext`fit$], {4, 2}]}], Red], 
             "          ", 
             Style[
              Column[{"experimental rate constant", 
                NumberForm[
                 ReplaceAll[
                  Chop[
                   N[$CellContext`k1$]], $CellContext`fit$], {4, 2}]}], 
              Blue]}]]], "Specifications" :> {
        Style[
        "theoretical", Bold, 
         10], {{$CellContext`n$$, 1.5, "reaction order n"}, 1., 2.5, 0.01, 
         Appearance -> "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`k$$, 1, "rate constant k"}, 1., 5., 0.01, 
         Appearance -> "Labeled", ImageSize -> Tiny}, "", 
        "", {{$CellContext`seed$$, 1, "seed"}, 1, 1000, 1, Appearance -> 
         "Labeled", ImageSize -> 
         Tiny}, {{$CellContext`noise$$, 0.05, "noise amplitude"}, 0.01, 0.2, 
         0.01, Appearance -> "Labeled", ImageSize -> Tiny}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`k$$, $CellContext`n$$, \
$CellContext`seed$$, $CellContext`noise$$}, ControlPlacement -> Left}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{650., {228., 233.}},
...
Cell[TextData[{
 "Consider an irreversible homogeneous liquid-phase reaction ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"n", " ", 
 ...
 " taking place in a batch reactor. Assume that the experimental data (i.e. \
the concentration of species ",
 Cell[BoxData[
  FormBox[
   StyleBox["A",
    FontSlant->"Plain"], TraditionalForm]], "InlineMath"],
 " versus time data indicated by the blue dots in the figure) comes from, for \
example, the on-line measurement of electrical conductivity of the mixture in \
the reactor. The governing equation of the batch reactor is given by ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    FractionBox[
     RowBox[{"d", "\[InvisibleSpace]", "c"}], 
     RowBox[{"d", "\[InvisibleSpace]", "t"}]], "=", 
    RowBox[{
     RowBox[{"-", "k"}], " ", 
     SuperscriptBox["c", "n"]}]}], TraditionalForm]], "InlineMath"],
 " with ",
 Cell[BoxData[
  FormBox[
   RowBox[{
...
Cell[TextData[{
 "This Demonstration uses the experimentally obtained data in order to \
estimate the theoretical reaction order ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 " and rate constant ",
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath"],
 " (shown in the figure in red and blue, respectively). You can vary the \
theoretical values of ",
 ...
 Cell[BoxData[
  FormBox["k", TraditionalForm]], "InlineMath"],
 " using the sliders. You can also vary the experimental data in order to \
mimic different experimental results obtained by various set-ups using the \
\"seed\" and \"noise amplitude\" ",
 "sliders",
 "."
}], "ManipulateCaption",
 CellID->1840824762],
...
EstimatingKineticParametersFromABatchReactorExperiment&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EstimatingKineticParametersFromABatchReactorExperiment/\
EstimatingKineticParametersFromABatchReactorExperiment-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Estimating Kinetic Parameters from a Batch Reactor Experiment",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
EstimatingKineticParametersFromABatchReactorExperiment/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EstimatingKineticParametersFromABatchReactorExperiment/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43855, 788, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44116, 797, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55791, 1063, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82506, 1632},
 {"Copyright", 82701, 1637}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1538, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35869, 603, 90, 2, 70, "DemoTitle"],
Cell[35962, 607, 5911, 117, 70, "Output",
 CellID->1186807739],
Cell[41876, 726, 1200, 37, 70, "ManipulateCaption",
 CellID->117277523],
Cell[43079, 765, 773, 21, 70, "ManipulateCaption",
 CellID->1840824762],
Cell[43855, 788, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44116, 797, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48559, 895, 33, 0, 70, "DetailsSection"],
Cell[48595, 897, 52, 1, 70, "DetailNotes",
 CellID->389150612],
Cell[48650, 900, 198, 6, 70, "DetailNotes",
 CellID->43932477],
Cell[48851, 908, 4905, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53759, 1001, 45, 0, 70, "CitationSection"],
Cell[53807, 1003, 854, 26, 70, "Author"],
Cell[54664, 1031, 1124, 30, 70, "Citations"],
Cell[55791, 1063, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature QTEuuK1lmueR2vAA6YaOD10x *)
