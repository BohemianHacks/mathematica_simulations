...
NotebookDataLength[     76991,       1543]
NotebookOptionsPosition[     49658,        954]
NotebookOutlinePosition[     75954,       1516]
CellTagsIndexPosition[     75843,       1510]
WindowTitle->Equally Sized Mixed Flow Reactors in Series versus Plug Flow \
Reactor
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`No$$ = 10, $CellContext`\[Tau]$$ = 2, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Tau]$$], 2, "residence time of plug flow reactor"},
       1, 5, 0.1}, {{
       Hold[$CellContext`No$$], 10, "number of mixed flow reactors"}, 1, 30, 
      1}}, Typeset`size$$ = {500., {173., 177.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Tau]$452609$$ = 0, $CellContext`No$452610$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`No$$ = 10, $CellContext`\[Tau]$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Tau]$$, $CellContext`\[Tau]$452609$$, 0], 
        Hold[$CellContext`No$$, $CellContext`No$452610$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt1$, $CellContext`tbl1$, $CellContext`plt2$}, 
        Subscript[C, 0] = 1; $CellContext`k = 1; 
        Subscript[$CellContext`\[Tau]$$, $CellContext`el] = $CellContext`\
\[Tau]$$/$CellContext`No$$; $CellContext`tbl1$ = 
         Table[Subscript[C, 0]/(
            1 + $CellContext`k 
             Subscript[$CellContext`\[Tau]$$, \
$CellContext`el])^$CellContext`i, {$CellContext`i, 
            0, $CellContext`No$$}]; $CellContext`plt1$ = 
         Plot[Exp[(-$CellContext`k) $CellContext`t] 
           Subscript[C, 0], {$CellContext`t, 0, $CellContext`\[Tau]$$}, 
           PlotRange -> {{0, 5}, {0, 1}}, 
           FrameLabel -> {"volume", "concentration of species A"}, Frame -> 
           True]; $CellContext`plt2$ = Graphics[{
            RGBColor[1, 0, 0], 
            Join[
             Table[
              
              Line[{{$CellContext`i 
                 Subscript[$CellContext`\[Tau]$$, $CellContext`el], 
                 
                 Part[$CellContext`tbl1$, $CellContext`i + 
                  2]}, {($CellContext`i + 1) 
                 Subscript[$CellContext`\[Tau]$$, $CellContext`el], 
                 
                 Part[$CellContext`tbl1$, $CellContext`i + 
                  2]}}], {$CellContext`i, 0, $CellContext`No$$ - 1}], 
             Table[
              
              Line[{{($CellContext`i - 1) 
                 Subscript[$CellContext`\[Tau]$$, $CellContext`el], 
                 
                 Part[$CellContext`tbl1$, $CellContext`i]}, {($CellContext`i - 
                  1) Subscript[$CellContext`\[Tau]$$, $CellContext`el], 
                 
                 Part[$CellContext`tbl1$, $CellContext`i + 
                  1]}}], {$CellContext`i, 1, $CellContext`No$$}]]}]; 
        Show[$CellContext`plt1$, $CellContext`plt2$, 
          ImageSize -> {500, 350}]], 
      "Specifications" :> {{{$CellContext`\[Tau]$$, 2, 
          "residence time of plug flow reactor"}, 1, 5, 0.1, Appearance -> 
         "Labeled"}, {{$CellContext`No$$, 10, 
          "number of mixed flow reactors"}, 1, 30, 1, Appearance -> 
         "Labeled"}}, "Options" :> {TrackedSymbols -> Manipulate}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {231., 236.}},
...
Cell["\<\
This Demonstration shows the concentration profile of species A subject to a \
first-order irreversible reaction for a plug flow reactor and a series of \
equally sized mixed flow reactors. Both configurations considered have the \
same residence time. Observe that when the number of mixed flow reactors in \
series increases, the behavior of a plug flow reactor is approached. In \
addition, for reactions whose rates increase with the reactant concentration, \
the performance of the plug flow reactor is superior. Indeed the exit \
concentration of the reactant is lower for the plug flow reactor \
configuration.  \
\>", "ManipulateCaption"],
...
Cell[TextData[{
 "Exit concentration after ",
 Cell[BoxData[
  FormBox["N", TraditionalForm]], "InlineMath"],
 " equal-size mixed flow reactors is given by:"
}], "DetailNotes",
 CellID->66379521],
    ...
    FractionBox[
     ...
     SuperscriptBox[
      RowBox[{"(", 
       RowBox[{"1", "+", 
        RowBox[{"k", " ", 
         SubscriptBox["\[Tau]", "i"]}]}], ")"}], "N"]]}], TraditionalForm]], 
  "InlineMath"],
 ", where ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["\[Tau]", "i"], TraditionalForm]], "InlineMath"],
 " ",
 Cell[BoxData[
  FormBox[Cell["", "InlineMath"], TraditionalForm]]],
 "is the residence time of a single mixed flow reactor."
}], "DetailNotes",
 CellID->235033652],

Cell["Exit concentration of a plug flow reactor is given by:", "DetailNotes",
 CellID->51131588],
...
Cell[TextData[{
 "Reference: O. Levenspiel, ",
 StyleBox["Chemical Reaction Engineering",
  FontSlant->"Italic"],
...
Cell[TextData[{
 ButtonBox["Selection of Optimum Chemical Reactor Design",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://library.wolfram.com/infocenter/MathSource/5474/"], None}],
 " (",
 StyleBox[ButtonBox["Wolfram Library Archive",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://library.wolfram.com/"], None},
  ButtonNote->"http://library.wolfram.com/"],
  FontSlant->"Italic"],
 ")"
}], "RelatedLinks",
 CellID->36087653],
...
EquallySizedMixedFlowReactorsInSeriesVersusPlugFlowReactor&version=0006"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EquallySizedMixedFlowReactorsInSeriesVersusPlugFlowReactor/\
EquallySizedMixedFlowReactorsInSeriesVersusPlugFlowReactor-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Equally Sized Mixed Flow Reactors in Series versus Plug Flow \
Reactor",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
EquallySizedMixedFlowReactorsInSeriesVersusPlugFlowReactor/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
EquallySizedMixedFlowReactorsInSeriesVersusPlugFlowReactor/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39620, 688, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39881, 697, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48836, 929, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75558, 1499},
 {"Copyright", 75752, 1504}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[634, 22, 34328, 567, 70, "DemonstrationHeader"],
Cell[34965, 591, 97, 2, 70, "DemoTitle"],
Cell[35065, 595, 3893, 79, 70, "Output",
 CellID->457134195],
Cell[38961, 676, 656, 10, 70, "ManipulateCaption"],
Cell[39620, 688, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39881, 697, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40575, 714, 33, 0, 70, "DetailsSection"],
Cell[40611, 716, 195, 6, 70, "DetailNotes",
 CellID->66379521],
Cell[40809, 724, 599, 22, 70, "DetailNotes",
 CellID->235033652],
Cell[41411, 748, 96, 1, 70, "DetailNotes",
 CellID->51131588],
Cell[41510, 751, 288, 12, 70, "DetailNotes",
 CellID->509657167],
Cell[41801, 765, 188, 6, 70, "DetailNotes",
 CellID->21269742],
Cell[41992, 773, 44, 0, 70, "RelatedLinksSection"],
Cell[42039, 775, 447, 14, 70, "RelatedLinks",
 CellID->36087653],
Cell[42489, 791, 4922, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47414, 885, 45, 0, 70, "CitationSection"],
Cell[47462, 887, 1041, 28, 70, "Citations"],
Cell[48506, 917, 327, 10, 70, "Author"],
Cell[48836, 929, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature eSUlYFkb6ucoix7iP64urHa6 *)
