...
NotebookDataLength[     81215,       1671]
NotebookOptionsPosition[     53759,       1079]
NotebookOutlinePosition[     80034,       1640]
CellTagsIndexPosition[     79923,       1634]
WindowTitle->Performance of a Plug Flow Reactor with Recycle
WindowFrame->Normal*)
...
Cell["Performance of a Plug Flow Reactor with Recycle", "DemoTitle"],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`\[Alpha]$$ = 1, Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`\[Alpha]$$], 1, "recycle ratio \[Alpha]"}, 0, 85, 
      0.01}}, Typeset`size$$ = {500., {173., 177.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`\[Alpha]$32590$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`\[Alpha]$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`\[Alpha]$$, $CellContext`\[Alpha]$32590$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt$, $CellContext`V$}, $CellContext`n = 
         2; $CellContext`CA0 = 1; $CellContext`plt$ = 
         Plot[1/($CellContext`CA0 (
             1 - $CellContext`X))^$CellContext`n, {$CellContext`X, 0, 0.8}, 
           Frame -> True, PlotStyle -> Thick, PlotRange -> {0, 17}, 
           FrameLabel -> {
            "conversion", "-1/\!\(\*SubscriptBox[\(r\), \(A\)]\)"}, 
           ImageSize -> {500, 350}, Epilog -> {
             Style[
              Text[
               Row[{
                 Style["F", Italic], 
                 " = 10 \!\(\*SuperscriptBox[\(m\), \(3\)]\)/s"}], {0.05, 
               14.2}], Blue, 12], 
             Style[
              Text[
               Row[{
                 Style["F", Italic], 
                 " = 10 \!\(\*SuperscriptBox[\(m\), \(3\)]\)/s"}], {0.33, 
               14.2}], Blue, 12], 
             Style[
              Text[
               Row[{"\[Alpha]\[Times]", 
                 Style["F", Italic], " = ", 
                 SetPrecision[$CellContext`\[Alpha]$$ 10, 4], 
                 " \!\(\*SuperscriptBox[\(m\), \(3\)]\)/s"}], {0.18, 9.8}], 
              Blue, 14], 
             Inset[
              Graphics[{{
                 GrayLevel[0.], 
                 ...
                 Style[
                  ...
                  Arrow[{{0.0916666666666667, 0.5416666666666666}, {
                   0.34166666666666673`, 0.5361111111111111}}], FontColor -> 
                  GrayLevel[0.]]}, {
                 RGBColor[0.5333333333333333, 1., 0.5662775616083009], 
                 Opacity[1.], 
                 
                 Rectangle[{0.34444444444444444`, 0.6222222222222222}, {
                  0.6361111111111112, 0.4277777777777778}]}, {
                 RGBColor[
                 0.1568627450980392, 0.1568627450980392, 0.1568627450980392], 
                 AbsolutePointSize[3.], 
                 Opacity[1.], 
                 
                 Arrow[{{0.6361111111111112, 0.5361111111111111}, {
                  0.8583333333333334, 0.5388888888888889}}]}, {
                 RGBColor[
                 0.1568627450980392, 0.1568627450980392, 0.1568627450980392], 
                 AbsoluteThickness[0.5], 
                 Opacity[1.], 
                 ...
                 Line[{{0.7472222222222222, 0.5277777777777778}, {
                  0.7416666666666667, 0.36111111111111105`}}]}, {
                 RGBColor[
                 0.1568627450980392, 0.1568627450980392, 0.1568627450980392], 
                 AbsolutePointSize[3.], 
                 AbsoluteThickness[0.5], 
                 ...
                 Arrow[{{0.7388888888888889, 0.35}, {0.21111111111111114`, 
                  0.3583333333333333}}]}, {
                 RGBColor[
                 0.1568627450980392, 0.1568627450980392, 0.1568627450980392], 
                 AbsoluteThickness[0.5], 
                 ...
                 Line[{{0.2166666666666667, 0.5361111111111111}, {
                  0.2111111111111112, 0.36111111111111105`}}]}}, 
               PlotRange -> {{0, 1}, {0, 1}}], {0.2, 13}, Automatic, {15, 
              15}]}]; $CellContext`FA0 = 
         10; $CellContext`V$ = $CellContext`FA0 ($CellContext`\[Alpha]$$ + 1) 
          NIntegrate[
           1/($CellContext`CA0 (
              1 - $CellContext`X))^$CellContext`n, {$CellContext`X, \
($CellContext`\[Alpha]$$/($CellContext`\[Alpha]$$ + 1)) 0.7, 0.7}]; 
        Show[$CellContext`plt$, 
          Graphics[{Orange, 
            Opacity[0.7], 
            
            Rectangle[{0, 1}, {
             0.7, ($CellContext`\[Alpha]$$ + 1) (
               NIntegrate[
                1/($CellContext`CA0 (
                   1 - $CellContext`X))^$CellContext`n, {$CellContext`X, \
($CellContext`\[Alpha]$$/($CellContext`\[Alpha]$$ + 1)) 0.7, 0.7}]/0.7)}], 
            Opacity[1], 
            Style[
             Text[
              StringJoin["reactor's volume = ", 
               ToString[
                SetPrecision[$CellContext`V$, 4]]], {0.18, 6.5}], Black, 14, 
             Bold]}]]], 
      "Specifications" :> {{{$CellContext`\[Alpha]$$, 1, 
          "recycle ratio \[Alpha]"}, 0, 85, 0.01, Appearance -> "Labeled"}}, 
      "Options" :> {
       ControlPlacement -> Top, TrackedSymbols :> {$CellContext`\[Alpha]$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {217., 222.}},
...
Cell[TextData[{
 "Consider a second-order reaction (2A \[RightArrow] B) with a reaction rate, \
",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"-", 
     SubscriptBox["r", "A"]}], "=", 
    RowBox[{"k", " ", 
     SubsuperscriptBox["C", "A", "2"]}]}], TraditionalForm]], "InlineMath"],
  ...
  FormBox[
   RowBox[{"\[Alpha]", "=", 
    FractionBox[
     StyleBox[
      RowBox[{
      "volume", " ", "of", " ", "fluid", " ", "returned", " ", "to", " ", 
       "the", " ", "reactor", " ", "entrance"}],
      FontSize->12], 
     StyleBox[
      RowBox[{"volume", " ", "leaving", " ", "the", " ", "system"}],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["X", "f"], "=", 
    RowBox[{"70", "%"}]}], TraditionalForm]], "InlineMath"],
 " is given by"
}], "ManipulateCaption",
 CellID->729359098],
     ...
     RowBox[{
      ...
      FractionBox[
       RowBox[{"d", " ", 
        SubscriptBox["X", "A"]}], 
       RowBox[{"-", " ", 
        SubscriptBox["r", "A"]}]]}]}]}], TraditionalForm]], "InlineMath"],
 ","
}], "ManipulateCaption",
 CellID->30530496],
...
Cell["There are two limiting cases:", "ManipulateCaption",
 CellID->364809964],

Cell[TextData[{
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Alpha]", "\[RightArrow]", "0"}], TraditionalForm]], 
  "InlineMath"],
...
Cell[TextData[{
 Cell[BoxData[
  FormBox[
   RowBox[{"\[Alpha]", "\[RightArrow]", "\[Infinity]"}], TraditionalForm]], 
  "InlineMath"],
...
PerformanceOfAPlugFlowReactorWithRecycle&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
PerformanceOfAPlugFlowReactorWithRecycle/\
PerformanceOfAPlugFlowReactorWithRecycle-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Performance of a Plug Flow Reactor with Recycle",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
PerformanceOfAPlugFlowReactorWithRecycle/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
PerformanceOfAPlugFlowReactorWithRecycle/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44354, 853, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44615, 862, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[52937, 1054, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 79636, 1623},
 {"Copyright", 79831, 1628}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[611, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34942, 590, 68, 0, 70, "DemoTitle"],
Cell[35013, 592, 6188, 139, 70, "Output",
 CellID->49695738],
Cell[41204, 733, 415, 12, 70, "ManipulateCaption",
 CellID->52846221],
Cell[41622, 747, 454, 15, 70, "ManipulateCaption",
 CellID->94276153],
Cell[42079, 764, 277, 9, 70, "ManipulateCaption",
 CellID->729359098],
Cell[42359, 775, 588, 22, 70, "ManipulateCaption",
 CellID->30530496],
Cell[42950, 799, 687, 25, 70, "ManipulateCaption",
 CellID->533636101],
Cell[43640, 826, 78, 1, 70, "ManipulateCaption",
 CellID->364809964],
Cell[43721, 829, 314, 10, 70, "ManipulateCaption",
 CellID->18654635],
Cell[44038, 841, 313, 10, 70, "ManipulateCaption",
 CellID->149027898],
Cell[44354, 853, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44615, 862, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46543, 908, 33, 0, 70, "DetailsSection"],
Cell[46579, 910, 180, 6, 70, "DetailNotes",
 CellID->45251498],
Cell[46762, 918, 4863, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[51628, 1011, 45, 0, 70, "CitationSection"],
Cell[51676, 1013, 928, 27, 70, "Citations"],
Cell[52607, 1042, 327, 10, 70, "Author"],
Cell[52937, 1054, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature wTUrIC9dxGG1oxAMoO8kqzdf *)
