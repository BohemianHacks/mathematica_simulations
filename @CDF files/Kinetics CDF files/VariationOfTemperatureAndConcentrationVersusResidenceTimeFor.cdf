...
NotebookDataLength[     81753,       1622]
NotebookOptionsPosition[     54700,       1042]
NotebookOutlinePosition[     81017,       1604]
CellTagsIndexPosition[     80906,       1598]
WindowTitle->Variation of Temperature and Concentration versus Residence Time \
...
Cell["\<\
Variation of Temperature and Concentration versus Residence Time for \
Adiabatic Reactors\
\>", "DemoTitle"],
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`CA0$$ = 2, $CellContext`ctrl1$$ = 
    1, $CellContext`ctrl2$$ = 1, $CellContext`J$$ = 40, Typeset`show$$ = True,
     Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`ctrl2$$], 1, "adiabatic reactor type"}, {
      1 -> "CSTR", 2 -> "PFTR"}}, {{
       Hold[$CellContext`ctrl1$$], 1, "plot type"}, {
      1 -> "CA versus \[Tau]", 2 -> "T versus \[Tau]"}}, {{
       Hold[$CellContext`CA0$$], 2, "initial concentration"}, 0.5, 2.5, 
      0.01}, {{
       Hold[$CellContext`J$$], 40, "J-factor"}, 35, 45, 1}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`ctrl2$591328$$ = False, $CellContext`ctrl1$591329$$ = 
    False, $CellContext`CA0$591330$$ = 0, $CellContext`J$591331$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`CA0$$ = 2, $CellContext`ctrl1$$ = 
        1, $CellContext`ctrl2$$ = 1, $CellContext`J$$ = 40}, 
      "ControllerVariables" :> {
        Hold[$CellContext`ctrl2$$, $CellContext`ctrl2$591328$$, False], 
        Hold[$CellContext`ctrl1$$, $CellContext`ctrl1$591329$$, False], 
        Hold[$CellContext`CA0$$, $CellContext`CA0$591330$$, 0], 
        Hold[$CellContext`J$$, $CellContext`J$591331$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt1$, $CellContext`plt2$, $CellContext`plt3$, \
$CellContext`plt4$, $CellContext`sol$, $CellContext`CA$}, $CellContext`sol$ = 
         NDSolve[{
           Derivative[1][$CellContext`CA$][$CellContext`t] == (-2.6) 
             10^20 $CellContext`CA$[$CellContext`t] 
             Exp[(-15000)/(
               300 + ($CellContext`J$$/$CellContext`CA0$$) \
($CellContext`CA0$$ - $CellContext`CA$[$CellContext`t]))], $CellContext`CA$[
             0] == $CellContext`CA0$$}, {
            $CellContext`CA$[$CellContext`t]}, {$CellContext`t, 0, 
            1000}]; $CellContext`plt1$ = 
         ContourPlot[$CellContext`\[Tau] == ($CellContext`CA0$$ - \
$CellContext`CA$)/($CellContext`CA$ 2.6 10^20 
            Exp[(-15000)/(
              300 + ($CellContext`J$$/$CellContext`CA0$$) ($CellContext`CA0$$ - \
$CellContext`CA$))]), {$CellContext`\[Tau], 0, 2}, {$CellContext`CA$, 
            0, $CellContext`CA0$$}, ImageSize -> 400 {1, 1}, ContourStyle -> {
             RGBColor[0.48, 0, 0], Thick}, 
           FrameLabel -> {"residence time \[Tau]", 
             Row[{"concentration ", 
               Subscript["C", "A"]}]}, ImagePadding -> 
           35]; $CellContext`plt2$ = 
         ContourPlot[$CellContext`\[Tau] == (($CellContext`T - 
              300)/($CellContext`J$$/$CellContext`CA0$$))/(($CellContext`CA0$$\
 - ($CellContext`T - 300)/($CellContext`J$$/$CellContext`CA0$$)) 2.6 10^20 
            Exp[(-15000)/$CellContext`T]), {$CellContext`\[Tau], 0, 
            2}, {$CellContext`T, 300, 300 + $CellContext`J$$ - 0.1}, 
           ImageSize -> 400 {1, 1}, ContourStyle -> {
             RGBColor[0, 0, 0.48], Thick}, 
           FrameLabel -> {"residence time \[Tau]", "temperature T"}, 
           ImagePadding -> 35]; $CellContext`plt3$ = Plot[
           ReplaceAll[
            $CellContext`CA$[$CellContext`t], $CellContext`sol$], \
{$CellContext`t, 0, 6}, Frame -> True, ImageSize -> 400 {1, 1}, 
           FrameLabel -> {"residence time \[Tau]", 
             Row[{"concentration ", 
               Subscript["C", "A"]}]}, PlotStyle -> {
             RGBColor[0.48, 0, 0], Thick}, ImagePadding -> 
           35]; $CellContext`plt4$ = Plot[
           ReplaceAll[
           300 + ($CellContext`J$$/$CellContext`CA0$$) ($CellContext`CA0$$ - \
$CellContext`CA$[$CellContext`t]), $CellContext`sol$], {$CellContext`t, 0, 6},
            Frame -> True, ImageSize -> 400 {1, 1}, 
           FrameLabel -> {"residence time \[Tau]", "temperature T"}, 
           PlotStyle -> {
             RGBColor[0, 0, 0.48], Thick}, ImagePadding -> 35]; 
        Switch[$CellContext`ctrl2$$, 1, 
          
          Switch[$CellContext`ctrl1$$, 1, $CellContext`plt1$, 
           2, $CellContext`plt2$], 2, 
          
          Switch[$CellContext`ctrl1$$, 1, $CellContext`plt3$, 
           2, $CellContext`plt4$]]], 
      "Specifications" :> {{{$CellContext`ctrl2$$, 1, 
          "adiabatic reactor type"}, {
         1 -> "CSTR", 2 -> "PFTR"}}, {{$CellContext`ctrl1$$, 1, 
          "plot type"}, {
         1 -> "CA versus \[Tau]", 2 -> 
          "T versus \[Tau]"}}, {{$CellContext`CA0$$, 2, 
          "initial concentration"}, 0.5, 2.5, 0.01, Appearance -> 
         "Labeled"}, {{$CellContext`J$$, 40, "J-factor"}, 35, 45, 1, 
         Appearance -> "Labeled"}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`ctrl1$$, $CellContext`J$$, \
$CellContext`CA0$$, $CellContext`ctrl2$$}, SynchronousUpdating -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{445., {280., 285.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"A", " ", "\[RightArrow]", " ", "B"}], TraditionalForm]], 
  "InlineMath"],
 " taking place either in an adiabatic CSTR (continuous stirred tank reactor) \
or an adiabatic PFTR (plug-flow tubular reactor)."
}], "ManipulateCaption"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["C", "A"], TraditionalForm]], "InlineMath"],
 " and temperature ",
 Cell[BoxData[
 ...
 " for both types of adiabatic reactors. You can set the value of the initial \
concentration, ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["C", 
    SubscriptBox["A", "0"]], TraditionalForm]], "InlineMath"],
 ", as well as the value of parameter\.08",
 Cell[BoxData[
  FormBox[
   RowBox[{"J", "=", 
    FractionBox[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"-", "\[CapitalDelta]"}], "\[InvisibleSpace]", 
    SubscriptBox["H", "R"]}], TraditionalForm]], "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["c", "p"], TraditionalForm]], "InlineMath"],
 " is the fluid heat capacity. Values of the other relevant parameters such \
as activation energy, pre-exponential factor, and initial temperature are \
taken from [1]. An interesting feature of the adiabatic CSTR is that, for a \
range of the residence time values, one can find up to three solutions. A \
stability analysis can show that only two of the solutions are stable. \
Steady-state multiplicity can be shown to be physically real."
}], "ManipulateCaption",
 CellID->68308805],
...
Cell[TextData[{
 "[1] L. D. Schmidt, ",
 StyleBox["The Engineering of Chemical Reactions",
  FontSlant->"Italic"],
...
VariationOfTemperatureAndConcentrationVersusResidenceTimeFor&version=0007"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
VariationOfTemperatureAndConcentrationVersusResidenceTimeFor/\
VariationOfTemperatureAndConcentrationVersusResidenceTimeFor-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Variation of Temperature and Concentration versus Residence Time \
for Adiabatic Reactors",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
VariationOfTemperatureAndConcentrationVersusResidenceTimeFor/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
VariationOfTemperatureAndConcentrationVersusResidenceTimeFor/"],
 "\"",
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Variation of Temperature and Concentration versus Residence \
Time for Adiabatic Reactors",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[42960, 768, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43221, 777, 3774, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[53878, 1017, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80619, 1587},
 {"Copyright", 80814, 1592}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[653, 22, 34328, 567, 70, "DemonstrationHeader"],
Cell[34984, 591, 118, 3, 70, "DemoTitle"],
Cell[35105, 596, 5707, 109, 70, "Output",
 CellID->398956428],
Cell[40815, 707, 332, 8, 70, "ManipulateCaption"],
Cell[41150, 717, 1807, 49, 70, "ManipulateCaption",
 CellID->68308805],
Cell[42960, 768, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43221, 777, 3774, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46998, 861, 33, 0, 70, "DetailsSection"],
Cell[47034, 863, 199, 6, 70, "DetailNotes",
 CellID->123463147],
Cell[47236, 871, 4928, 92, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[52167, 965, 45, 0, 70, "CitationSection"],
Cell[52215, 967, 1070, 28, 70, "Citations"],
Cell[53288, 997, 587, 18, 70, "Author"],
Cell[53878, 1017, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature kQErL3zHV8z@owAJt2VRrL5L *)
