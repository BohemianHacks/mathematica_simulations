...
NotebookDataLength[    178815,       3839]
NotebookOptionsPosition[    175654,       3728]
NotebookOutlinePosition[    177364,       3782]
CellTagsIndexPosition[    177028,       3770]
WindowFrame->Normal*)
...
Cell[CellGroupData[{
Cell["Psychrometric Chart", "DemoTitle"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`arrows$$ = True, $CellContext`DBT$$ = 
    ...
    47, $CellContext`temperatures$$ = True, $CellContext`volume$$ = True, 
    ...
    False, $CellContext`relativehumidity$172506$$ = 
    False, $CellContext`enthalpy$172507$$ = 
    False, $CellContext`volume$172508$$ = 
    False, $CellContext`temperatures$172509$$ = 
    False, $CellContext`gridLines$172510$$ = 
    False, $CellContext`arrows$172511$$ = False, $CellContext`rh$172512$$ = 
    0, $CellContext`DBT$172513$$ = 0}, 
...
$CellContext`relativehumidity$172506$$, False], 
        Hold[$CellContext`enthalpy$$, $CellContext`enthalpy$172507$$, False], 
        Hold[$CellContext`volume$$, $CellContext`volume$172508$$, False], 
        Hold[$CellContext`temperatures$$, $CellContext`temperatures$172509$$, 
         False], 
        Hold[$CellContext`gridLines$$, $CellContext`gridLines$172510$$, 
         False], 
        Hold[$CellContext`arrows$$, $CellContext`arrows$172511$$, False], 
        Hold[$CellContext`rh$$, $CellContext`rh$172512$$, 0], 
        Hold[$CellContext`DBT$$, $CellContext`DBT$172513$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`t], {$CellContext`t, 0}]]], {3, 0}], " kJ/kg"}]}], 16], {-9, 
      ...
      "Specifications" :> {{{$CellContext`relativehumidity$$, True, 
        ...
        Row[{
          Manipulate`Place[7], 
          Manipulate`Place[8]}]}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{649., {268., 275.}},
...
$CellContext`T1), -10 <= $CellContext`T <= 55}, {None, $CellContext`T > 55}}, 
         ...
         Pattern[$CellContext`T1, 
          Blank[]]] = -0.007 - 
        0.002114 ($CellContext`T - $CellContext`T1), $CellContext`start = -10,
        Attributes[PlotRange] = {ReadProtected}, $CellContext`grid = 
       Graphics[{{
           Thickness[Tiny], 
           GrayLevel[0.5], {
...
Cell["\<\
The objective of this demonstration is to help users understand a \
psychrometic chart, also known as a humidity chart. One slider changes the \
dry bulb temperature (the x-axis) and the other slider changes the relative \
humity, which is not the y-axis. Unchecking boxes hides some of the lines so \
that the chart is not too complicated. Unchecking the relative humidity boxe \
does not removed the constant relative-humidity lines, but only removes the \
labels on the lines. When the temperature box is checked, arrows appear \
indicating the dry bulb temperaturel, the web bulb temperature, and the dew \
point temperature.\
\>", "ManipulateCaption"]
}, Open  ]],
...
Cell["relative humidity", "SearchTerms",
 CellID->96444942],

Cell["chemical engineering", "SearchTerms",
 CellID->362520079],

Cell["mechanical engineerig", "SearchTerms",
 CellID->492816625],

Cell["refrigeration", "SearchTerms",
 CellID->428930448],

Cell["heating/cooling", "SearchTerms",
 CellID->46956536],

Cell["chemical engineering", "SearchTerms",
 CellID->14945169],

Cell["humidity chart", "SearchTerms",
 CellID->148547151]
}, Open  ]],
...
CellTagsIndex->{
 "ResizeImages"->{
  Cell[169430, 3541, 312, 8, 22, "ControlSuggestions",
   CellTags->"ResizeImages"]},
 "RotateAndZoomIn3D"->{
  Cell[169745, 3551, 678, 16, 22, "ControlSuggestions",
   CellTags->"RotateAndZoomIn3D"]},
 "DragLocators"->{
  Cell[170426, 3569, 340, 11, 22, "ControlSuggestions",
   CellTags->"DragLocators"]},
 "CreateAndDeleteLocators"->{
  Cell[170769, 3582, 637, 15, 22, "ControlSuggestions",
   CellTags->"CreateAndDeleteLocators"]},
 "SliderZoom"->{
  Cell[171409, 3599, 844, 21, 22, "ControlSuggestions",
   CellTags->"SliderZoom"]},
 "GamepadControls"->{
  Cell[172256, 3622, 304, 8, 22, "ControlSuggestions",
   CellTags->"GamepadControls"]},
 "AutomaticAnimation"->{
  Cell[172563, 3632, 1464, 31, 22, "ControlSuggestions",
   CellTags->"AutomaticAnimation"]},
 "BookmarkAnimation"->{
  Cell[174030, 3665, 908, 21, 22, "ControlSuggestions",
   CellTags->"BookmarkAnimation"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ResizeImages", 176121, 3743},
 {"RotateAndZoomIn3D", 176231, 3746},
 {"DragLocators", 176342, 3749},
 {"CreateAndDeleteLocators", 176459, 3752},
 {"SliderZoom", 176574, 3755},
 {"GamepadControls", 176681, 3758},
 {"AutomaticAnimation", 176795, 3761},
 {"BookmarkAnimation", 176913, 3764}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 40, 0, 74, "DemoTitle"],
Cell[CellGroupData[{
Cell[1551, 39, 33, 0, 287, "InitializationSection"],
Cell[1587, 41, 13776, 373, 667, "Input",
 InitializationCell->True,
 CellID->26488192]
}, Open  ]],
Cell[CellGroupData[{
Cell[15400, 419, 29, 0, 234, "ManipulateSection"],
Cell[CellGroupData[{
Cell[15454, 423, 22003, 520, 1048, "Input"],
Cell[37460, 945, 128491, 2487, 555, "Output",
 CellID->79115069]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[166000, 3438, 36, 0, 169, "ManipulateCaptionSection"],
Cell[166039, 3440, 666, 10, 67, "ManipulateCaption"]
}, Open  ]],
Cell[CellGroupData[{
Cell[166742, 3455, 28, 0, 173, "ThumbnailSection"],
Cell[166773, 3457, 1242, 34, 230, "Output"]
}, Open  ]],
Cell[CellGroupData[{
Cell[168052, 3496, 28, 0, 143, "SnapshotsSection"],
Cell[168083, 3498, 1241, 34, 230, "Output"]
}, Open  ]],
Cell[169339, 3535, 26, 0, 336, "DetailsSection"],
Cell[CellGroupData[{
Cell[169390, 3539, 37, 0, 114, "ControlSuggestionsSection"],
Cell[169430, 3541, 312, 8, 22, "ControlSuggestions",
 CellTags->"ResizeImages"],
Cell[169745, 3551, 678, 16, 22, "ControlSuggestions",
 CellTags->"RotateAndZoomIn3D"],
...
Cell[CellGroupData[{
Cell[174975, 3691, 30, 0, 155, "SearchTermsSection"],
Cell[175008, 3693, 42, 1, 22, "SearchTerms",
 CellID->72407660],
Cell[175053, 3696, 59, 1, 22, "SearchTerms",
 CellID->96444942],
Cell[175115, 3699, 63, 1, 22, "SearchTerms",
 CellID->362520079],
Cell[175181, 3702, 64, 1, 22, "SearchTerms",
 CellID->492816625],
Cell[175248, 3705, 56, 1, 22, "SearchTerms",
 CellID->428930448],
Cell[175307, 3708, 57, 1, 22, "SearchTerms",
 CellID->46956536],
Cell[175367, 3711, 62, 1, 22, "SearchTerms",
 CellID->14945169],
Cell[175432, 3714, 57, 1, 22, "SearchTerms",
 CellID->148547151]
}, Open  ]],
Cell[175504, 3718, 31, 0, 141, "RelatedLinksSection"],
Cell[CellGroupData[{
Cell[175560, 3722, 25, 0, 129, "AuthorSection"],
Cell[175588, 3724, 38, 0, 22, "Author"]
}, Open  ]]
}, Open  ]]
}
]
...
(* NotebookSignature VvpDZcFt2PKWEAwUro8UuVeU *)
