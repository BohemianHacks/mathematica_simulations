...
NotebookDataLength[     84257,       1655]
NotebookOptionsPosition[     57309,       1090]
NotebookOutlinePosition[     83735,       1650]
CellTagsIndexPosition[     83624,       1644]
WindowTitle->Lever Rule Applied to the Benzene-Toluene Vapor Pressure Diagram
WindowFrame->Normal*)
...
\>", "DemoTitle",
 CellChangeTimes->{
  3.7446508010241675`*^9, {3.7446508805616255`*^9, 3.74465088103907*^9}, 
   3.7446529083295307`*^9},ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-\
2c07ad00f1a9"],
...
$CellContext`yA$], {2, 2}]}], 17, White], {
 ...
 CellChangeTimes->{{3.7439643785088263`*^9, 3.743964437879319*^9}, 
   ...
   3.7446524844495106`*^9, 3.744652484611658*^9}, 3.7446528775255113`*^9},
...
called \[OpenCurlyDoubleQuote]tie lines\[CloseCurlyDoubleQuote] or \
\[OpenCurlyDoubleQuote]levers\[CloseCurlyDoubleQuote]. The lever rule is used \
to calculate the relative amounts of the two phases, which are shown on the \
bar graph on the right. The compositions of the two phases are indicated by \
dotted lines on the phase diagram and numerically at the top of the bar \
graph. Clcik and drag the black point to change the pressure and benzene mole \
fraction.\
\>", "ManipulateCaption",
 CellChangeTimes->{{3.7439644645171447`*^9, 3.7439644936678715`*^9}, 
   3.744650805398138*^9, {3.744650938736251*^9, 3.7446509416639132`*^9}, 
   3.7446529175058823`*^9},
...
Cell[TextData[{
 StyleBox["Benzene and toluene form a nearly ideal solution obeying Raoult\
\[CloseCurlyQuote]s law ",
 ...
 Cell[BoxData[
  ...
  "InlineMath",ExpressionUUID->"b20b1a51-899b-4557-9c51-435301d72340"],
 StyleBox[" over the entire range of composition. Composition is usually \
expressed as a mole fraction but sometimes other units such as mole percent \
or mass percent are used. An \[OpenCurlyDoubleQuote]",
  FontSize->12],
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath",ExpressionUUID->
  "52536494-7e44-4110-b15d-06501a6b188f"],
 StyleBox["\[CloseCurlyDoubleQuote] usually indicates the mole fraction of \
the liquid phase, a \[OpenCurlyDoubleQuote]",
  FontSize->12],
 Cell[BoxData[
  FormBox["y", TraditionalForm]], "InlineMath",ExpressionUUID->
  "33a36271-fb54-4844-9d3c-f11e27b1dffb"],
 StyleBox["\[CloseCurlyDoubleQuote] is used for the vapor phase, and a \
\[OpenCurlyDoubleQuote]",
  FontSize->12],
 Cell[BoxData[
  FormBox["z", TraditionalForm]], "InlineMath",ExpressionUUID->
  "4212f969-f587-4ead-bdcb-d1b4e889ec04"],
 StyleBox["\[CloseCurlyDoubleQuote] for the total composition of all phases \
together. The amounts in the phases are calculated from the lever rule: ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
  ...
  ExpressionUUID->"0179d38f-b33e-4ae3-8cbf-e3e0f405feb1"],
 StyleBox[". Here ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["n", "liquid"], TraditionalForm]], "InlineMath",
  ExpressionUUID->"2cdd8573-06fe-485c-9558-e7ec256f4409"],
 StyleBox[" is the moles of liquid phase, ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["n", "vapor"], TraditionalForm]], "InlineMath",
  ExpressionUUID->"23a6363e-ed5c-423b-9394-d5844439393d"],
 StyleBox[" is the moles of vapor phase, and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["l", "vapor"], TraditionalForm]], "InlineMath",
  ExpressionUUID->"d4d39f2b-4eb2-4b67-ad51-5463786789a4"],
 StyleBox[" and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["l", "liquid"], TraditionalForm]], "InlineMath",
  ExpressionUUID->"61a86a6b-3a3c-4641-bcd5-ba99fcdbb304"],
...
\[CloseCurlyDoubleQuote] on the bar chart is calculated from ",
  ...
  FormBox[
   FractionBox[
    ...
    RowBox[{
     SubscriptBox["n", "liquid"], "+", 
     SubscriptBox["n", "vapor"]}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"13208cb3-b25b-4343-b8b1-c8aa7e4d08be"],
 StyleBox[" and  ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   FractionBox[
    ...
    RowBox[{
     SubscriptBox["n", "liquid"], "+", 
     SubscriptBox["n", "vapor"]}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"ead756e8-346e-4459-8cc6-78e74b058e80"],
 StyleBox[".",
  FontSize->12]
}], "DetailNotes",
 CellChangeTimes->{{3.743964535761527*^9, 3.743964553882964*^9}, {
   ...
   3.7446509560169086`*^9, 3.7446509574912276`*^9}, 3.744652939631013*^9},
...
Cell[BoxData[
 StyleBox[
  RowBox[{
  "\"\<\!\(\*StyleBox[ButtonBox[StyleBox[RowBox[{RowBox[{\"Lever\", \" \", \
\"Rule\", \" \", \"Applied\", \" \", \"to\", \" \", \"the\", \" \", \"Benzene\
\"}], \"-\", RowBox[{\"Toluene\", \" \", \"Vapor\", \" \", \"Pressure\", \" \
\", \"Diagram\"}]}], \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]],BaseStyle->\"Hyperlink\",ButtonData->{
URL[\"https://www.colorado.edu/learncheme/thermodynamics/\
LeverRuleBenzeneToluene.html\"], \
None},ButtonNote->\"https://www.colorado.edu/learncheme/thermodynamics/\
LeverRuleBenzeneToluene.html\"], \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, 0.5019607843137255]]\)\>\"",
 ...
 CellChangeTimes->{{3.744651114265602*^9, 3.7446511251214933`*^9}, {
   ...
   3.744653005872227*^9, 
   3.744653043105961*^9},ExpressionUUID->"c5cfe82c-87b0-45d9-9857-\
2a8959dbb375"],
...
20Baumann"]}]], "Input",
 CellChangeTimes->{{3.744651110546217*^9, 3.7446511105672503`*^9}, {
  ...
  3.74465140749969*^9}, {3.7446529787295947`*^9, 
  3.744652991095835*^9}},ExpressionUUID->"aee65028-eaf6-420b-8013-\
0a05e32d83e0"],

Cell[TextData[StyleBox["",
 FontColor->RGBColor[0., 0., 0.]]], "Subsection",
 CellChangeTimes->{{3.744651822692051*^9, 3.744651833449796*^9}, 
   3.744653057005536*^9},ExpressionUUID->"c36d706e-c7ee-4ae2-8fe6-\
b2e6148c9f41"],
...
CellGrouping->Manual,
WindowSize->{1210, 983},
WindowMargins->{{367, Automatic}, {Automatic, 170}},
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Lever Rule Applied to the Benzene-Toluene Vapor Pressure \
Diagram",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44859, 777, 316, 8, 50, "ManipulateCaption",ExpressionUUID->"fb861cbd-50b7-4934-bbdd-a2ad4db0004d",
   CellTags->"ControlSuggestions"],
  Cell[45178, 787, 3829, 81, 16, "ManipulateCaption",ExpressionUUID->"57e8a647-4da0-4a88-b282-15d85093aa4c",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56432, 1065, 873, 23, 45, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 83172, 1633},
 {"Copyright", 83477, 1638}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1566, 34, 34385, 568, 70, "DemonstrationHeader",ExpressionUUID->"0f6c982c-728a-4e7c-b5bb-e38debd5c80d"],
Cell[35954, 604, 272, 6, 51, "DemoTitle",ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-2c07ad00f1a9"],
Cell[36229, 612, 6810, 135, 482, "Input",ExpressionUUID->"6f2916ec-4147-44b1-b0ce-81232036e730",
 CellID->377157575],
Cell[43042, 749, 1814, 26, 160, "ManipulateCaption",ExpressionUUID->"abd28a3c-1615-46f9-88d1-0712bde5d8d9",
 CellID->957328473],
Cell[44859, 777, 316, 8, 50, "ManipulateCaption",ExpressionUUID->"fb861cbd-50b7-4934-bbdd-a2ad4db0004d",
 CellTags->"ControlSuggestions"],
Cell[45178, 787, 3829, 81, 16, "ManipulateCaption",ExpressionUUID->"57e8a647-4da0-4a88-b282-15d85093aa4c",
 CellTags->"ControlSuggestions"],
Cell[49010, 870, 88, 0, 58, "DetailsSection",ExpressionUUID->"cd92d376-b5a9-4e2f-afa7-e392be73c809"],
Cell[49101, 872, 3884, 100, 129, "DetailNotes",ExpressionUUID->"bd335143-b24f-497b-9c57-915908f76af2",
 CellID->1902107128],
Cell[52988, 974, 100, 0, 44, "CitationSection",ExpressionUUID->"6c8e8459-14f4-47ec-a506-661e64c7e8eb"],
Cell[53091, 976, 205, 3, 22, "Author",ExpressionUUID->"e78c80fa-d5ee-4c48-8664-76092c8a4d22",
 CellID->872162387],
Cell[53299, 981, 1607, 33, 22, "Input",ExpressionUUID->"c5cfe82c-87b0-45d9-9857-2a8959dbb375"],
Cell[54909, 1016, 1292, 41, 25, "Input",ExpressionUUID->"aee65028-eaf6-420b-8013-0a05e32d83e0"],
Cell[56204, 1059, 225, 4, 53, "Subsection",ExpressionUUID->"c36d706e-c7ee-4ae2-8fe6-b2e6148c9f41"],
Cell[56432, 1065, 873, 23, 45, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature FxD6OG2UJS3J6Dwm1Atmc0Nl *)
