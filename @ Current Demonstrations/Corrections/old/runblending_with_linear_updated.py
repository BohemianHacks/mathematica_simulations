...
# installs numpy and scipy, two necessary python packages if they are not already installed
try:
    import numpy as np
...
# installs matplotlib if not already installed, necessary for plotting
try:
    import matplotlib.pyplot as plt
except ImportError:
    if packagesInstalled == False:
        print("\nYou are missing Python packages necessary to run this file. This installation will only occur once.\n")
    install("matplotlib")
    import matplotlib.pyplot as plt
