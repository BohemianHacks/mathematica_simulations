...
NotebookDataLength[    120681,       2526]
NotebookOptionsPosition[     94410,       1972]
NotebookOutlinePosition[    120437,       2525]
CellTagsIndexPosition[    120363,       2520]
...
Cell["Batch Distillation", "DemoTitle",
 CellChangeTimes->{
  3.7446508010241675`*^9, {3.7446508805616255`*^9, 3.74465088103907*^9}, {
   3.802452903335619*^9, 
   3.802452906019234*^9}},ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-\
2c07ad00f1a9"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`az$$ = 1, $CellContext`boilDry$$ = 
    ...
    1, $CellContext`xb$$ = 0.5, $CellContext`xt$$ = 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
      ...
      1 -> " flasks", 2 -> " x-y plot", 3 -> " T-x-y plot"}}, {{
       ...
       Hold[$CellContext`xb$$], 0.5}, 0}, {{
       Hold[$CellContext`xt$$], 0.7438817893939389}, 0}, {{
    ...
    Typeset`skipInitDone$$ = False, $CellContext`z$13885$$ = 
    0, $CellContext`molesToEvap$13886$$ = 0, $CellContext`graph$13887$$ = 
    False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`az$$ = 1, $CellContext`boilDry$$ = 
        ...
        False, $CellContext`molesToEvap$$ = 0.1, $CellContext`stage$$ = 
        1, $CellContext`xb$$ = 0.5, $CellContext`xt$$ = 
        0.7438817893939389, $CellContext`z$$ = 0.5}, "ControllerVariables" :> {
        Hold[$CellContext`z$$, $CellContext`z$13885$$, 0], 
        Hold[$CellContext`molesToEvap$$, $CellContext`molesToEvap$13886$$, 0], 
        Hold[$CellContext`graph$$, $CellContext`graph$13887$$, False]}, 
      "OtherVariables" :> {
...
$CellContext`vapColor, $CellContext`liqColor, $CellContext`columnPart1, \
$CellContext`columnPart3, $CellContext`coil, $CellContext`thermometer, \
$CellContext`flaskShape, $CellContext`modfuncy, $CellContext`modfuncx, \
$CellContext`dynamicFlaskCoords, $CellContext`flask, \
$CellContext`columnPart2, $CellContext`superScript}, $CellContext`columnPart1 = {
           FaceForm[LightBlue], 
           ...
           BSplineCurve[
            ...
            SplineDegree -> 2]}; $CellContext`thermometer[
           ...
           Tooltip[
            ...
            TooltipDelay -> 0]}; $CellContext`flaskShape = CompressedData["
...
9DOimc+EZj8mH+YuVHkWOB/mDoj4F3tY+EDs+WwPCz+YPCx80cMfAKaMmkk=
          ...
          MessageName[NIntegrate, "ncvb"]]; $CellContext`modfuncy[
           Pattern[$CellContext`n, 
            Blank[]]] := 
         If[$CellContext`n == 0, 0, -6.5 + 2 Mod[9 - $CellContext`n, 9] + 
           2 Mod[$CellContext`n + 1, 2]]; $CellContext`modfuncx[
           Pattern[$CellContext`n, 
            Blank[]]] := 
         If[$CellContext`n == 0, 0, 5 + 
           6.8 Mod[$CellContext`n + 1, 2]]; $CellContext`dynamicFlaskCoords[
           Pattern[$CellContext`n, 
            Blank[]], 
           Pattern[$CellContext`lvl, 
            ...
            N[Part[
             ...
             2]}, {$CellContext`i, 1, 
            Length[$CellContext`flaskShape]}]; $CellContext`flask[
           Pattern[$CellContext`n, 
            Blank[]], 
           Pattern[$CellContext`lvl, 
            Blank[]]] := {
...
{((-0.3) 3.75) $CellContext`lvl + (0.25 - $CellContext`lvl) 2.52 + 
             ...
             0.02 Sin[(Pi/0.2) 
                Clip[$CellContext`lvl 3.75, {
                  0, 0.1}]]^0.8}]}; $CellContext`columnPart2[
           Pattern[$CellContext`lvl, 
            Blank[]]] := {
           EdgeForm[None], 
           FaceForm[{
            ...
            1 + 0.5 Sin[(Pi/0.5) Clip[$CellContext`lvl, {0, 0.25}]]^0.8, 0.12 
             Sin[(Pi/0.5) 
                Clip[$CellContext`lvl, {
                  0, 0.25}]]^0.8}]}; $CellContext`superScript[
           Pattern[$CellContext`j, 
            Blank[]]] := 
         Which[$CellContext`j == 1, "st", $CellContext`j == 2, 
           "nd", $CellContext`j == 3, "rd", $CellContext`j >= 4, 
           "th"]; $CellContext`eqdata[
...
$CellContext`molesToEvap$$ < 
      ...
      "Specifications" :> {{{$CellContext`z$$, 0.5, 
         ...
         ControlPlacement -> 5}, {{$CellContext`xb$$, 0.5}, 0, ControlType -> 
         None, ControlPlacement -> 
         6}, {{$CellContext`xt$$, 0.7438817893939389}, 0, ControlType -> None,
    ...
    DynamicModuleValues:>{},
    Initialization:>({$CellContext`columnPart1 = {
         FaceForm[
...
the \[OpenCurlyDoubleQuote]press to collect\[CloseCurlyDoubleQuote] button is \
selected, liquid evaporates and the distillate is collected in a collection \
flask. The amount collected into each flask is set with a slider. After it is \
collected, the collection flask is set aside and a empty flask is \
substituted. The process repeats when the \[OpenCurlyDoubleQuote]press to \
collect button\[CloseCurlyDoubleQuote] is selected until 0.2 mol remains in \
the still. The equilibrium temperature is indicated next to the thermometer. \
Select the collection flasks, an x-y plot, or a T-x-y plot to be displayed on \
the right. Select \[OpenCurlyDoubleQuote]reset\[CloseCurlyDoubleQuote] to \
start over. Use the drop-down menu to choose an ideal solution (no \
azeotrope), a minimum-boiling azeotrope, or a maximum-temperature azeotrope. \
Hovering the mouse over objects reveals further information about that object.\
\>", "ManipulateCaption",
...
Cell[TextData[{
 StyleBox["In this batch distillation of a binary mixture, a fixed amount of \
the feed mixture ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  ExpressionUUID->"d3034b42-9377-4b97-8bf1-b462c9dd2c3f"],
 StyleBox[", with initial mole fraction ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", "F"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "ce076430-f351-41f1-a663-f68b30cffd51"],
 StyleBox[", evaporates into a distillate collection flask (where ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["D", "i"], " ", 
    RowBox[{"(", "mol", ")"}]}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"25849755-5851-4f7c-9260-5dadc289dfa6"],
 StyleBox[" is the mass of distillate collected into flask ",
  FontSize->12],
 Cell[BoxData[
  FormBox["i", TraditionalForm]], "InlineMath",ExpressionUUID->
  "aeb7b579-75c0-4325-905b-e4a3a69067bd"],
 StyleBox[", and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  ExpressionUUID->"3288643e-79a6-470a-b866-4328fc23d2bf"],
 StyleBox[" is the mole fraction within distillate flask ",
  FontSize->12],
 Cell[BoxData[
  FormBox["i", TraditionalForm]], "InlineMath",ExpressionUUID->
  "072e5ac4-ea3e-4bd7-a28a-155d52e48e29"],
 StyleBox["). This process is repeated to fill several distillate collection \
flasks. The overall mass balance and component balance for the more volatile \
liquid are:\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 ...
 Cell[BoxData[
  ...
  FontSize->14,ExpressionUUID->"f12629fd-f87a-4358-b3c2-d75b17a4c5a8"],
 StyleBox["\t",
  FontSize->14],
 StyleBox["\t\t\t\t\t[1]\n",
  FontSize->12],
 ...
 Cell[BoxData[
  ...
  FontSize->14,ExpressionUUID->"7c3b214b-1d9b-4eb5-a1de-85ed914060ab"],
 StyleBox["\t",
  FontSize->14],
 StyleBox["\t\t\t[2]\n",
  FontSize->12],
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", 
    RowBox[{"D", ",", " ", "avg"}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"969ae487-7b47-40e8-b2fe-5c6003a3a10e"],
 StyleBox[" is the average mole fraction within the distillate collection \
flask(s), and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["B", "final"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "54e9d5be-0bb3-4ae4-a634-d769f91987a0"],
 StyleBox[" and ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
  ...
  ExpressionUUID->"5c462936-30c0-4906-8de4-d91b2fd6516f"],
 StyleBox[" are the final mass and mole fraction within the bottom (boiler) \
vessel. The value of ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", 
    RowBox[{"D", ",", " ", "avg"}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"33b72cbe-7ea8-4fce-8e8d-e8a2a6481d15"],
 StyleBox[" can be calculated as:\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\n",
      ...
      RowBox[{"(", 
       RowBox[{
        ...
        SubscriptBox["x", 
         RowBox[{"D", ",", " ", "n"}]]}], ")"}], "/", 
      SubscriptBox["D", "total"]}]}]}], TraditionalForm]], "InlineMath",
  FontSize->14,ExpressionUUID->"6302812c-e869-4f98-a378-cfbd6ece3b6d"],
 StyleBox["\t",
  FontSize->14],
 StyleBox["[3]\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\nWhere the total number of collection stages (equivalent to the \
total number of distillate collection flasks) is ",
  FontSize->12],
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath",ExpressionUUID->
  "c68c3cb6-18d4-4d38-99e1-4ae3a09219e6"],
 StyleBox[". Total distillate is:\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\n",
 ...
 Cell[BoxData[
  ...
  FontSize->14,ExpressionUUID->"77116d09-4c17-4442-bb15-0dce6c067ba5"],
 StyleBox["\t",
  FontSize->14],
 StyleBox["\t\t\t\t[4]\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\nBecause the saturated vapor is in thermodynamic equilibrium with \
the saturated liquid in the vessel, the composition of the vapor ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["y", "B"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "83d59d9f-915c-45c4-90a8-c830234d4816"],
 StyleBox[" is a function of the composition in the bottom vessel ( ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{
  ...
  ExpressionUUID->"bef39100-152e-44fe-ba9f-5e67556ccf13"],
 StyleBox[" ). During evaporation, both compositions change with time, except \
when the composition of the liquid is an azeotrope. Numerical approximations \
like Antoine\[CloseCurlyQuote]s Equation are often used to model ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   RowBox[{"f", "(", 
    SubscriptBox["x", "B"], ")"}], TraditionalForm]], "InlineMath",
  ExpressionUUID->"358314f5-2f35-414d-b0bf-1898c50659c7"],
 StyleBox[" using experimental data. Other methods, such as assuming constant \
relative volatility, may also be used to approximate this relationship. \
Composition of the next collection flask ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", 
  ...
  ExpressionUUID->"430e6dbc-49a4-4dea-9797-9d5c54343e9b"],
 StyleBox[" can be calculated using integration:\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\n",
 ...
 Cell[BoxData[
  ...
  "InlineMath",
  FontSize->14,ExpressionUUID->"9359ec7a-f31c-4052-8e77-67fcf1a4373e"],
 StyleBox["\t\t",
  FontSize->14],
 StyleBox["\t\t\t[5]\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
 StyleBox["\nA mass balance can be used to solve for the distillate \
composition, ",
  FontSize->12],
 Cell[BoxData[
  FormBox[
   SubscriptBox["x", 
    RowBox[{"D", ",", " ", 
     RowBox[{"i", "+", "1"}]}]], TraditionalForm]], "InlineMath",
  ExpressionUUID->"7a8f96a2-89f4-4aac-aeb6-2e0d79e580e4"],
 StyleBox[".\n",
  FontSize->12],
 StyleBox[" ",
  FontSize->4],
   ...
   RowBox[{
    ...
    FractionBox[
     ...
     RowBox[{
      ...
      SubscriptBox["B", 
       RowBox[{"i", "+", "1"}]]}]]}], TraditionalForm]], "InlineMath",
  FontSize->16,ExpressionUUID->"8172a9ff-09b6-42ba-8cfb-ab8c3ed441a2"],
 StyleBox["\t",
  FontSize->16],
 StyleBox["\t\t\t\t[6]\n",
  FontSize->12],
 ...
 StyleBox["Separation Process Engineering: includes mass transfer analysis",
  FontSize->12,
  FontSlant->"Italic"],
 StyleBox[" (pp. 329\[Dash]347). New Jersey, USA: Pearson Education, Inc., \
2012.",
  FontSize->12]
}], "DetailNotes",
 CellChangeTimes->{{3.743964535761527*^9, 3.743964553882964*^9}, {
   ...
   3.7446509560169086`*^9, 3.7446509574912276`*^9}, 3.8024530930865746`*^9, {
   3.802453202036197*^9, 3.802453291587431*^9}},
...
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]]\)\!\(\*StyleBox[\(\*StyleBox[\"Di\", \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]]st\*StyleBox[\"i\", \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]]ll\*StyleBox[\"a\", \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]]ti\*StyleBox[\"o\", \
\"Text\",FontFamily->\"Verdana\",FontSize->10,FontWeight->\"Plain\",FontColor-\
>RGBColor[0.5019607843137255, 0.5019607843137255, \
0.5019607843137255]]\*StyleBox[StyleBox[\"n\", \"Text\",FontFamily->\"Verdana\
...
\"", "from", 
 ...
 CellChangeTimes->{{3.744651114265602*^9, 3.7446511251214933`*^9}, {
  ...
  3.8024533192546787`*^9, 
  3.802453321278137*^9}},ExpressionUUID->"c5cfe82c-87b0-45d9-9857-\
2a8959dbb375"],
...
Cell[BoxData[
   ...
   RowBox[{"by", ":", " ", 
    RowBox[{
     ButtonBox[
      ...
      ButtonData->{
        URL[
        "https://demonstrations.wolfram.com/search.html?query=Neil+Hendren"], 
        None},
      ButtonNote->
       "https://demonstrations.wolfram.com/search.html?query=Neil+Hendren"], 
     " ", "John", " ", 
 ...
 CellChangeTimes->{{3.744651110546217*^9, 3.7446511105672503`*^9}, {
   ...
   3.74465140749969*^9}, {3.8024533254950914`*^9, 3.802453339532265*^9}, 
   3.802453370367238*^9},ExpressionUUID->"aee65028-eaf6-420b-8013-\
0a05e32d83e0"],
...
CellGrouping->Manual,
WindowSize->{989, 1126},
WindowMargins->{{Automatic, 129}, {-10, Automatic}},
WindowElements->{
...
CellTagsIndex->{
 "Copyright"->{
  Cell[93349, 1942, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 120216, 2514}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1520, 34, 34385, 568, 70, "DemonstrationHeader",ExpressionUUID->"0f6c982c-728a-4e7c-b5bb-e38debd5c80d"],
Cell[35908, 604, 244, 5, 51, "DemoTitle",ExpressionUUID->"ce7c456e-1f7e-4573-9ed7-2c07ad00f1a9"],
Cell[36155, 611, 41269, 882, 508, "Input",ExpressionUUID->"6f2916ec-4147-44b1-b0ce-81232036e730",
 CellID->377157575],
Cell[77427, 1495, 1357, 19, 130, "ManipulateCaption",ExpressionUUID->"abd28a3c-1615-46f9-88d1-0712bde5d8d9",
 CellID->957328473],
Cell[78787, 1516, 88, 0, 58, "DetailsSection",ExpressionUUID->"cd92d376-b5a9-4e2f-afa7-e392be73c809"],
Cell[78878, 1518, 10708, 339, 517, "DetailNotes",ExpressionUUID->"bd335143-b24f-497b-9c57-915908f76af2",
 CellID->1902107128],
Cell[89589, 1859, 100, 0, 44, "CitationSection",ExpressionUUID->"6c8e8459-14f4-47ec-a506-661e64c7e8eb"],
Cell[89692, 1861, 205, 3, 22, "Author",ExpressionUUID->"e78c80fa-d5ee-4c48-8664-76092c8a4d22",
 CellID->872162387],
Cell[89900, 1866, 2569, 48, 22, "Input",ExpressionUUID->"c5cfe82c-87b0-45d9-9857-2a8959dbb375"],
Cell[92472, 1916, 874, 24, 22, "Input",ExpressionUUID->"aee65028-eaf6-420b-8013-0a05e32d83e0"],
Cell[93349, 1942, 873, 23, 91, "Text",ExpressionUUID->"9856c3ec-2d22-490e-955f-6e7b3197b5ed",
 CellTags->"Copyright"],
Cell[94225, 1967, 181, 3, 25, "Input",ExpressionUUID->"9fa92ac2-225b-4c13-b460-8e5bbed2aedc"]
}
]
*)
...
(* NotebookSignature WwTmxYoNJ8bbIC1sv8g8zqFF *)
